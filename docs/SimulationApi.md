...
> SettlementSimulationResponse PGFetchSettlementSimulation(xApiVersion, simulationId, xRequestId, xIdempotencyKey)
...
public class Example {
    public static void main(String[] args) {
        ...
        try {
            SettlementSimulationResponse result = cashfree.PGFetchSettlementSimulation(xApiVersion, simulationId, xRequestId, xIdempotencyKeyOkHttpClient httpClient);
            System.out.println(result);
        } catch (ApiException e) {
            System.err.println("Exception when calling SimulationApi#PGFetchSettlementSimulation");
...
public class Example {
    public static void main(String[] args) {
        ...
        String xApiVersion = "2026-01-01"; // String | API version to be used. Format is in YYYY-MM-DD.
        SimulateRequest simulateRequest = new SimulateRequest(); // SimulateRequest | Request body for simulation.
        String xRequestId = "4dfb9780-46fe-11ee-be56-0242ac120002"; // String | Request ID for the API call. Can be used to resolve tech issues. Communicate this in your tech related queries to Cashfree.
        UUID xIdempotencyKey = UUID.fromString("47bf8872-46fe-11ee-be56-0242ac120002"); // UUID | An idempotency key is a unique identifier you include with your API call. If the request fails or times out, you can safely retry it using the same key to avoid duplicate actions. 
        try {
...
> SettlementSimulationResponse PGSimulateSettlement(xApiVersion, simulateSettlementRequest, xRequestId, xIdempotencyKey)
...
public class Example {
    public static void main(String[] args) {
        ...
        String xApiVersion = "2026-01-01"; // String | API version to be used. Format is in YYYY-MM-DD.
        SimulateSettlementRequest simulateSettlementRequest = new SimulateSettlementRequest(); // SimulateSettlementRequest | The request body for simulating a settlement.
        String xRequestId = "4dfb9780-46fe-11ee-be56-0242ac120002"; // String | Request ID for the API call. Can be used to resolve tech issues. Communicate this in your tech related queries to Cashfree.
        UUID xIdempotencyKey = UUID.fromString("47bf8872-46fe-11ee-be56-0242ac120002"); // UUID | An idempotency key is a unique identifier you include with your API call. If the request fails or times out, you can safely retry it using the same key to avoid duplicate actions. 
        try {
            SettlementSimulationResponse result = cashfree.PGSimulateSettlement(xApiVersion, simulateSettlementRequest, xRequestId, xIdempotencyKeyOkHttpClient httpClient);
            System.out.println(result);
        } catch (ApiException e) {
            System.err.println("Exception when calling SimulationApi#PGSimulateSettlement");
            System.err.println("Status code: " + e.getCode());
            System.err.println("Reason: " + e.getResponseBody());
            System.err.println("Response headers: " + e.getResponseHeaders());
            e.printStackTrace();
