...
> SettlementEntity PGFetchSettlements(xApiVersion, fetchSettlementsRequest, contentType, xRequestId, xIdempotencyKey, accept)
...
> SettlementReconEntity PGSettlementFetchRecon(xApiVersion, settlementFetchReconRequest, contentType, xRequestId, xIdempotencyKey, accept)
