...
> PaymentEntity PGAuthorizeOrder(xApiVersion, orderId, authorizeOrderRequest, xRequestId, xIdempotencyKey)
...
> OrderAuthenticateEntity PGOrderAuthenticatePayment(xApiVersion, cfPaymentId, orderAuthenticatePaymentRequest, xRequestId, xIdempotencyKey)
...
> PaymentEntity PGOrderFetchPayment(xApiVersion, orderId, cfPaymentId, xRequestId, xIdempotencyKey)
...
> List&lt;PaymentEntity&gt; PGOrderFetchPayments(xApiVersion, orderId, xRequestId, xIdempotencyKey)
...
> PayOrderEntity PGPayOrder(xApiVersion, payOrderRequest, xRequestId, xIdempotencyKey)
