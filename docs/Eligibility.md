...
public class Example {
    public static void main(String[] args) {
        ...
        eligibilityFetchCardlessEMIRequest.setAmount(10000);
        CustomerDetails customerDetails = new CustomerDetails();
        customerDetails.setCustomerPhone("7330797796");
        eligibilityFetchCardlessEMIRequest.setCustomerDetails(customerDetails);
