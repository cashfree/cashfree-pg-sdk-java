...
> AdjustVendorBalanceResponse PGESCreateOnDemandTransfer(xApiVersion, vendorId, adjustVendorBalanceRequest)
...
public class Example {
    public static void main(String[] args) {
        ...
        try {
            AdjustVendorBalanceResponse result = cashfree.PGESCreateOnDemandTransfer(xApiVersion, vendorId, adjustVendorBalanceRequestOkHttpClient httpClient);
...
> CreateVendorResponse PGESCreateVendors(xApiVersion, createVendorRequest)
...
public class Example {
    public static void main(String[] args) {
        ...
        try {
            CreateVendorResponse result = cashfree.PGESCreateVendors(xApiVersion, createVendorRequestOkHttpClient httpClient);
            System.out.println(result);
        } catch (ApiException e) {
...
> VendorDocumentDownloadResponse PGESDownloadVendorsDocs(docType, vendorId)
...
public class Example {
    public static void main(String[] args) {
        ...
        String vendorId = "your-vendor-id"; // String | The id which uniquely identifies your vendor.
        try {
            VendorDocumentDownloadResponse result = cashfree.PGESDownloadVendorsDocs(docType, vendorIdOkHttpClient httpClient);
            System.out.println(result);
        } catch (ApiException e) {
...
> VendorEntity PGESFetchVendors(xApiVersion, vendorId)
...
public class Example {
    public static void main(String[] args) {
        ...
        String vendorId = "your-vendor-id"; // String | The id which uniquely identifies your vendor.
        try {
            VendorEntity result = cashfree.PGESFetchVendors(xApiVersion, vendorIdOkHttpClient httpClient);
            System.out.println(result);
        } catch (ApiException e) {
...
> VendorBalance PGESGetVendorBalance(xApiVersion, vendorId)
...
public class Example {
    public static void main(String[] args) {
        ...
        String vendorId = "your-vendor-id"; // String | The id which uniquely identifies your vendor.
        try {
            VendorBalance result = cashfree.PGESGetVendorBalance(xApiVersion, vendorIdOkHttpClient httpClient);
            System.out.println(result);
        } catch (ApiException e) {
...
> VendorBalanceTransferCharges PGESGetVendorBalanceTransferCharges(xApiVersion, amount, rateType)
...
public class Example {
    public static void main(String[] args) {
        ...
        try {
            VendorBalanceTransferCharges result = cashfree.PGESGetVendorBalanceTransferCharges(xApiVersion, amount, rateTypeOkHttpClient httpClient);
            System.out.println(result);
        } catch (ApiException e) {
...
> VendorDocumentsResponse PGESGetVendorsDocs(xApiVersion, vendorId)
...
public class Example {
    public static void main(String[] args) {
        ...
        String vendorId = "your-vendor-id"; // String | The id which uniquely identifies your vendor.
        try {
            VendorDocumentsResponse result = cashfree.PGESGetVendorsDocs(xApiVersion, vendorIdOkHttpClient httpClient);
            System.out.println(result);
        } catch (ApiException e) {
...
> ESOrderReconResponse PGESOrderRecon(xApiVersion, esOrderReconRequest)
...
public class Example {
    public static void main(String[] args) {
        ...
        try {
            ESOrderReconResponse result = cashfree.PGESOrderRecon(xApiVersion, esOrderReconRequestOkHttpClient httpClient);
            System.out.println(result);
        } catch (ApiException e) {
...
> UpdateVendorResponse PGESUpdateVendors(xApiVersion, vendorId, updateVendorRequest)
...
public class Example {
    public static void main(String[] args) {
        ...
        try {
            UpdateVendorResponse result = cashfree.PGESUpdateVendors(xApiVersion, vendorId, updateVendorRequestOkHttpClient httpClient);
            System.out.println(result);
        } catch (ApiException e) {
...
> UploadVendorDocumentsResponse PGESUploadVendorsDocs(xApiVersion, vendorId, uploadVendorDocsRequest)
...
public class Example {
    public static void main(String[] args) {
        ...
        String xApiVersion = "2023-08-01"; // String | API version to be used. Format is in YYYY-MM-DD
        String vendorId = "your-vendor-id"; // String | The id which uniquely identifies your vendor.
        UploadVendorDocsRequest uploadVendorDocsRequest = new UploadVendorDocsRequest(); // UploadVendorDocsRequest | Upload Vendor Docs Request Body.
        try {
            UploadVendorDocumentsResponse result = cashfree.PGESUploadVendorsDocs(xApiVersion, vendorId, uploadVendorDocsRequestOkHttpClient httpClient);
            System.out.println(result);
        } catch (ApiException e) {
...
| **xApiVersion** | **String**| API version to be used. Format is in YYYY-MM-DD | [default to 2023-08-01] |
| **vendorId** | **String**| The id which uniquely identifies your vendor. | |
| **uploadVendorDocsRequest** | [**UploadVendorDocsRequest**](UploadVendorDocsRequest.md)| Upload Vendor Docs Request Body. | [optional] |
...
> SplitAfterPaymentResponse PGOrderSplitAfterPayment(xApiVersion, orderId, splitAfterPaymentRequest)
...
public class Example {
    public static void main(String[] args) {
        ...
        try {
            SplitAfterPaymentResponse result = cashfree.PGOrderSplitAfterPayment(xApiVersion, orderId, splitAfterPaymentRequestOkHttpClient httpClient);
            System.out.println(result);
        } catch (ApiException e) {
...
> StaticSplitResponse PGOrderStaticSplit(xApiVersion, staticSplitRequest)
...
public class Example {
    public static void main(String[] args) {
        ...
        try {
            StaticSplitResponse result = cashfree.PGOrderStaticSplit(xApiVersion, staticSplitRequestOkHttpClient httpClient);
            System.out.println(result);
        } catch (ApiException e) {
