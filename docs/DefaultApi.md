...
> List&lt;StaticQrResponseEntity&gt; TerminalCreateQRCodes(xApiVersion, xRequestId, xIdempotencyKey, createPartnerVpaRequest)
...
public class Example {
    public static void main(String[] args) {
        ...
        CreatePartnerVpaRequest createPartnerVpaRequest = new CreatePartnerVpaRequest(); // CreatePartnerVpaRequest | 
        try {
            List<StaticQrResponseEntity> result = cashfree.TerminalCreateQRCodes(xApiVersion, xRequestId, xIdempotencyKey, createPartnerVpaRequestOkHttpClient httpClient);
            System.out.println(result);
        } catch (ApiException e) {
            System.err.println("Exception when calling DefaultApi#TerminalCreateQRCodes");
...
> List&lt;StaticQrResponseEntity&gt; TerminalGetQRCodes(xApiVersion, status, cfTerminalId, xRequestId, xIdempotencyKey)
...
public class Example {
    public static void main(String[] args) {
        ...
        String xApiVersion = "2023-08-01"; // String | API version to be used. Format is in YYYY-MM-DD
        String status = "MAPPED"; // String | Status of pre-created Qr.
        String cfTerminalId = "123344"; // String | Cashfree terminal id for which you want to get pre-generated staticQRs.
        String xRequestId = "4dfb9780-46fe-11ee-be56-0242ac120002"; // String | Request id for the API call. Can be used to resolve tech issues. Communicate this in your tech related queries to cashfree
        UUID xIdempotencyKey = UUID.fromString("47bf8872-46fe-11ee-be56-0242ac120002"); // UUID | An idempotency key is a unique identifier you include with your API call. If the request fails or times out, you can safely retry it using the same key to avoid duplicate actions.  
        try {
            List<StaticQrResponseEntity> result = cashfree.TerminalGetQRCodes(xApiVersion, status, cfTerminalId, xRequestId, xIdempotencyKeyOkHttpClient httpClient);
            System.out.println(result);
        } catch (ApiException e) {
            System.err.println("Exception when calling DefaultApi#TerminalGetQRCodes");
            System.err.println("Status code: " + e.getCode());
            System.err.println("Reason: " + e.getResponseBody());
            System.err.println("Response headers: " + e.getResponseHeaders());
            e.printStackTrace();
