...
public class Cashfree {
  ...
  public PGWebhookEvent PGVerifyWebhookSignature(String signature, String rawBody, String timestamp) throws Exception {
    ...
    public okhttp3.Call pGCreateCustomerCall(String xApiVersion, CreateCustomerRequest createCustomerRequest, String xRequestId, UUID xIdempotencyKey, final ApiCallback _callback) throws ApiException {
        ...
        localVarHeaderParams.put("x-sdk-platform", "javasdk-4.1.1");
     ...
     */
    public okhttp3.Call pGESUploadVendorsDocsCall(String xApiVersion, String vendorId, String docType, String docValue, File _file, final ApiCallback _callback) throws ApiException {
        String basePath = "https://sandbox.cashfree.com/pg";
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call pGESUploadVendorsDocsValidateBeforeCall(String xApiVersion, String vendorId, String docType, String docValue, File _file, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'xApiVersion' is set
        if (xApiVersion == null) {
        ...
        return pGESUploadVendorsDocsCall(xApiVersion, vendorId, docType, docValue, _file, _callback);

    }

    public ApiResponse<UploadVendorDocumentsResponse> PGESUploadVendorsDocs(String xApiVersion, String vendorId, String docType, String docValue, File _file, OkHttpClient httpClient) throws ApiException {
        if(httpClient != null) {
            localVarApiClient.httpClient = httpClient;
        }
        okhttp3.Call localVarCall = pGESUploadVendorsDocsValidateBeforeCall(xApiVersion, vendorId, docType, docValue, _file, null);
    ...
    public ApiResponse<List<PaymentLinkOrderEntity>> PGLinkFetchOrders(String xApiVersion, String linkId, String xRequestId, UUID xIdempotencyKey, OkHttpClient httpClient) throws ApiException {
        if(httpClient != null) {
            localVarApiClient.httpClient = httpClient;
        }
