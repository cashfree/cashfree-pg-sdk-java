...
public class Cashfree {
  ...
  public PGWebhookEvent PGVerifyWebhookSignature(String signature, String rawBody, String timestamp) throws Exception {
     ...
     */
    public okhttp3.Call pGESDownloadVendorsDocsCall(String docType, String vendorId, String xRequestId, UUID xIdempotencyKey, final ApiCallback _callback) throws ApiException {
        String basePath = "https://sandbox.cashfree.com/pg";
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call pGESDownloadVendorsDocsValidateBeforeCall(String docType, String vendorId, String xRequestId, UUID xIdempotencyKey, final ApiCallback _callback) throws ApiException {
        ...
        return pGESDownloadVendorsDocsCall(docType, vendorId, xRequestId, xIdempotencyKey, _callback);
    ...
    public ApiResponse<VendorDocumentDownloadResponse> PGESDownloadVendorsDocs(String docType, String vendorId, String xRequestId, UUID xIdempotencyKey, OkHttpClient httpClient) throws ApiException {
        ...
        okhttp3.Call localVarCall = pGESDownloadVendorsDocsValidateBeforeCall(docType, vendorId, xRequestId, xIdempotencyKey, null);
