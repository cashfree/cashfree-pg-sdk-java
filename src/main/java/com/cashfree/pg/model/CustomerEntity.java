...
public class CustomerEntity {
  ...
  public CustomerEntity customerUid(String customerUid) {
  ...
  **/
  ...
  @Schema(requiredMode = Schema.RequiredMode.NOT_REQUIRED, description = "unique id generated by cashfree for your customer.")
  ...
  public CustomerEntity customerPhone(String customerPhone) {
  ...
  **/
  ...
  public CustomerEntity customerEmail(String customerEmail) {
  ...
  **/
  ...
  public CustomerEntity customerName(String customerName) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.customerUid, customerEntity.customerUid) &&
        Objects.equals(this.customerPhone, customerEntity.customerPhone) &&
        Objects.equals(this.customerEmail, customerEntity.customerEmail) &&
        Objects.equals(this.customerName, customerEntity.customerName);
  }

  @Override
  public int hashCode() {
    return Objects.hash(customerUid, customerPhone, customerEmail, customerName);
  }
  ...
  */
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CustomerEntity.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CustomerEntity' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CustomerEntity> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CustomerEntity.class));

       return (TypeAdapter<T>) new TypeAdapter<CustomerEntity>() {
           @Override
           public void write(JsonWriter out, CustomerEntity value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CustomerEntity read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of CustomerEntity given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of CustomerEntity
  * @throws IOException if the JSON string is invalid with respect to CustomerEntity
  */
  public static CustomerEntity fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CustomerEntity.class);
  }

 /**
  * Convert an instance of CustomerEntity to an JSON string
  *
  * @return JSON string
  */
