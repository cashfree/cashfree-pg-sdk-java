...
public class ShipmentDetails {
  ...
  **/
  ...
  @Schema(requiredMode = Schema.RequiredMode.NOT_REQUIRED, description = "Tracking Numbers associated wih order.")
  ...
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("tracking_numbers") != null && !jsonObj.get("tracking_numbers").isJsonNull() && !jsonObj.get("tracking_numbers").isJsonArray()) {
