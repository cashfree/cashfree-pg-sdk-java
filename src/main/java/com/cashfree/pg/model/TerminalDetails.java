...
public class TerminalDetails {
  ...
  **/
  ...
  public TerminalDetails cfTerminalId(Long cfTerminalId) {
  ...
  **/
  @javax.annotation.Nullable
  @Schema(requiredMode = Schema.RequiredMode.NOT_REQUIRED, description = "mobile num of the terminal/agent/storefront,This is a required parameter when you do not provide the cf_terminal_id.")
