...
public class ReconEntityDataInner {
  ...
  **/
  ...
  public ReconEntityDataInner forexConversionHandlingCharge(BigDecimal forexConversionHandlingCharge) {
  ...
  **/
  @javax.annotation.Nullable
  @Schema(requiredMode = Schema.RequiredMode.NOT_REQUIRED, description = "Cashfree forex conversion charges for processing transaction")
  ...
  public ReconEntityDataInner forexConversionHandlingTax(BigDecimal forexConversionHandlingTax) {
  ...
  **/
  @javax.annotation.Nullable
  @Schema(requiredMode = Schema.RequiredMode.NOT_REQUIRED, description = "Cashfree forex conversion tax for processing transaction")
  ...
  public ReconEntityDataInner chargesCurrency(String chargesCurrency) {
  ...
  **/
  @javax.annotation.Nullable
  @Schema(requiredMode = Schema.RequiredMode.NOT_REQUIRED, description = "Cashfree charges currency for a event type")
