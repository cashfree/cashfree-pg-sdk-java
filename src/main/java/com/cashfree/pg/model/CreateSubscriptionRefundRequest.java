...
public class CreateSubscriptionRefundRequest {
  ...
  private BigDecimal cfPaymentId;
  ...
  public CreateSubscriptionRefundRequest cfPaymentId(BigDecimal cfPaymentId) {
  ...
  **/
  ...
  public BigDecimal getCfPaymentId() {
    return cfPaymentId;
  }


  public void setCfPaymentId(BigDecimal cfPaymentId) {
    this.cfPaymentId = cfPaymentId;
  }
  ...
  **/
  @javax.annotation.Nonnull
  @Schema(requiredMode = Schema.RequiredMode.REQUIRED, description = "A unique ID passed by merchant for identifying the transaction.")
  ...
  **/
  @javax.annotation.Nullable
  @Schema(requiredMode = Schema.RequiredMode.NOT_REQUIRED, description = "Refund note for merchant reference. To simulate refund status in Sandbox, pass SUCCESS, FAILED, PENDING, or ACTIVE in the refund_note field. This is a case-sensitive parameter.")
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.cfPaymentId, createSubscriptionRefundRequest.cfPaymentId) &&
        Objects.equals(this.subscriptionId, createSubscriptionRefundRequest.subscriptionId) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(cfPaymentId, subscriptionId, paymentId, refundId, refundAmount, refundNote, refundSpeed);
  }
