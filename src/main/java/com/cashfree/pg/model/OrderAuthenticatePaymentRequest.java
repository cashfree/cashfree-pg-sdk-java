 ...
 */
@Schema(description = "To use this API, Native OTP needs to be enabled for your account.")
...
public class OrderAuthenticatePaymentRequest {
  ...
  **/
  ...
  @Schema(requiredMode = Schema.RequiredMode.NOT_REQUIRED, description = "OTP collected from the customer. Mandatory only when action is SUBMIT_OTP.")
  ...
  **/
  ...
  @Schema(requiredMode = Schema.RequiredMode.REQUIRED, description = "Action intended for this request - can be SUBMIT_OTP or RESEND_OTP.")
