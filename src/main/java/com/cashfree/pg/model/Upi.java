...
import com.cashfree.pg.model.UPIAuthorizeDetails;
...
public class Upi {
  ...
  **/
  ...
  @Schema(requiredMode = Schema.RequiredMode.NOT_REQUIRED, description = "Specify the channel through which the payment must be processed. Can be one of [\"link\", \"collect\", \"qrcode\", \"podQrCode\"].")
