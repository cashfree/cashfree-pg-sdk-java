...
public class CreateSubscriptionRequestSubscriptionMeta {
  ...
  private List<String> notificationChannel = new ArrayList<>();

  public static final String SERIALIZED_NAME_SESSION_ID_EXPIRY = "session_id_expiry";
  @SerializedName(SERIALIZED_NAME_SESSION_ID_EXPIRY)
  private String sessionIdExpiry;
  ...
  **/
  ...
  public CreateSubscriptionRequestSubscriptionMeta sessionIdExpiry(String sessionIdExpiry) {
    
    this.sessionIdExpiry = sessionIdExpiry;
    return this;
  }

   /**
   * Expiry date for the subscription session.
   * @return sessionIdExpiry
  **/
  @javax.annotation.Nullable
  @Schema(requiredMode = Schema.RequiredMode.NOT_REQUIRED, description = "Expiry date for the subscription session.")
  public String getSessionIdExpiry() {
    return sessionIdExpiry;
  }


  public void setSessionIdExpiry(String sessionIdExpiry) {
    this.sessionIdExpiry = sessionIdExpiry;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.returnUrl, createSubscriptionRequestSubscriptionMeta.returnUrl) &&
        ...
        Objects.equals(this.sessionIdExpiry, createSubscriptionRequestSubscriptionMeta.sessionIdExpiry);
  }

  @Override
  public int hashCode() {
    return Objects.hash(returnUrl, notificationChannel, sessionIdExpiry);
  }
  ...
  public String toString() {
    ...
    sb.append("    sessionIdExpiry: ").append(toIndentedString(sessionIdExpiry)).append("\n");
    sb.append("}");
    return sb.toString();
  }
  ...
  static {
    ...
    openapiFields.add("session_id_expiry");
  ...
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if ((jsonObj.get("session_id_expiry") != null && !jsonObj.get("session_id_expiry").isJsonNull()) && !jsonObj.get("session_id_expiry").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `session_id_expiry` to be a primitive type in the JSON string but got `%s`", jsonObj.get("session_id_expiry").toString()));
      }
  }
