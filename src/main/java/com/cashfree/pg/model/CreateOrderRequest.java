...
public class CreateOrderRequest {
  ...
  **/
  @javax.annotation.Nonnull
  @Schema(example = "INR", requiredMode = Schema.RequiredMode.REQUIRED, description = "Currency for the order. INR if left empty. For support currency list, refer [here](https://www.cashfree.com/docs/payments/international-payments/ipg/currencies-supported#full-currency-list). Submit [Support Form](https://merchant.cashfree.com/auth/login) to enable new currencies.")
