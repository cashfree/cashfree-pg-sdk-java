...
import com.cashfree.pg.model.AuthorizationDetails;
import com.cashfree.pg.model.PlanEntity;
import com.cashfree.pg.model.SubscriptionCustomerDetails;
import com.cashfree.pg.model.SubscriptionEntitySubscriptionMeta;
...
public class SubscriptionEntity {
  ...
  private List<SubscriptionPaymentSplitItem> subscriptionPaymentSplits = new ArrayList<>();
  ...
  public static final String SERIALIZED_NAME_NEXT_SCHEDULE_DATE = "next_schedule_date";
  @SerializedName(SERIALIZED_NAME_NEXT_SCHEDULE_DATE)
  ...
  **/
  @javax.annotation.Nullable
  @Schema(example = "2025-06-01T10:20:12+05:30", requiredMode = Schema.RequiredMode.NOT_REQUIRED, description = "Time at which the subscription will expire. We store timestamps in IST.")
  ...
  **/
  @javax.annotation.Nullable
  @Schema(example = "2025-06-01T10:20:12+05:30", requiredMode = Schema.RequiredMode.NOT_REQUIRED, description = "Time at which the first charge will be made for the subscription. Applicable only for PERIODIC plans. Cashfree stores timestamps in IST.")
  ...
  **/
  @javax.annotation.Nullable
  @Schema(requiredMode = Schema.RequiredMode.NOT_REQUIRED, description = "Status of the subscription. For more details, see [Subscription Lifecycle](https://www.cashfree.com/docs/payments/subscription/create#subscription-lifecycle).")
  ...
  **/
  ...
  public SubscriptionEntity nextScheduleDate(String nextScheduleDate) {
  ...
  **/
  @javax.annotation.Nullable
  @Schema(example = "2025-06-01T10:20:12+05:30", requiredMode = Schema.RequiredMode.NOT_REQUIRED, description = "The date on which the next payment is scheduled to be processed. Cashfree stores timestamps in IST. For ON_DEMAND plans this will be null .")
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.authorisationDetails, subscriptionEntity.authorisationDetails) &&
        ...
        Objects.equals(this.nextScheduleDate, subscriptionEntity.nextScheduleDate);
  }

  @Override
  public int hashCode() {
    return Objects.hash(authorisationDetails, cfSubscriptionId, customerDetails, planDetails, subscriptionExpiryTime, subscriptionFirstChargeTime, subscriptionId, subscriptionMeta, subscriptionNote, subscriptionSessionId, subscriptionPaymentSplits, subscriptionStatus, subscriptionTags, nextScheduleDate);
  }
  ...
  public String toString() {
    ...
    sb.append("    nextScheduleDate: ").append(toIndentedString(nextScheduleDate)).append("\n");
    sb.append("}");
    return sb.toString();
  }
  ...
  static {
    ...
    openapiFields.add("next_schedule_date");
  ...
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if ((jsonObj.get("next_schedule_date") != null && !jsonObj.get("next_schedule_date").isJsonNull()) && !jsonObj.get("next_schedule_date").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `next_schedule_date` to be a primitive type in the JSON string but got `%s`", jsonObj.get("next_schedule_date").toString()));
      }
  }
