 ...
 */
@Schema(description = "Request parameters to create a new subscription.")
...
public class CreateSubscriptionRequest {
  ...
  **/
  @javax.annotation.Nullable
  @Schema(requiredMode = Schema.RequiredMode.NOT_REQUIRED, description = "Time at which the first charge will be made for the subscription after authorization. Applicable only for PERIODIC plans. Cashfree stores timestamps in IST, but you can provide them in a valid ISO 8601 time format.  For IST this `2025-06-01T10:20:12+05:30` translates to `2025-06-01 10:20:12`    For UTC this `2025-06-01T10:20:12Z` translates to `2025-06-01 15:50:12+05:30`.")
  ...
  **/
  @javax.annotation.Nullable
  @Schema(example = "{\"psp_note\":\"Monthly subscription payment\",\"custom_field\":\"value\"}", requiredMode = Schema.RequiredMode.NOT_REQUIRED, description = "Custom tags for this subscription. You can include up to 10 entries as string key-value pairs. Use any key names that suit your integration. A commonly used key is psp_note, which sets the note displayed to the customer in their payment service provider (PSP) app or on their statement. When using psp_note, the value must be between 1 and 255 characters.")
  ...
  **/
  ...
  public CreateSubscriptionRequest cfOrderId(String cfOrderId) {
  ...
  **/
  @javax.annotation.Nullable
  @Schema(requiredMode = Schema.RequiredMode.NOT_REQUIRED, description = "Cashfree order ID for the subscription.")
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.subscriptionId, createSubscriptionRequest.subscriptionId) &&
        ...
        Objects.equals(this.cfOrderId, createSubscriptionRequest.cfOrderId);
  }

  @Override
  public int hashCode() {
    return Objects.hash(subscriptionId, customerDetails, planDetails, authorizationDetails, subscriptionMeta, subscriptionExpiryTime, subscriptionFirstChargeTime, subscriptionTags, subscriptionPaymentSplits, cfOrderId);
  }
