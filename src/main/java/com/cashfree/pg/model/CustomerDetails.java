...
public class CustomerDetails {
  ...
  **/
  @javax.annotation.Nonnull
  @Schema(requiredMode = Schema.RequiredMode.REQUIRED, description = "Customer phone number. To accommodate international phone numbers, ensure the number is prefixed with a '+' to override the 10-digit limitation.")
  ...
  **/
  @javax.annotation.Nullable
  @Schema(requiredMode = Schema.RequiredMode.NOT_REQUIRED, description = "Customer's bank account number. This field is required only if you want to perform a bank account check (TPV).")
  ...
  **/
  @javax.annotation.Nullable
  @Schema(requiredMode = Schema.RequiredMode.NOT_REQUIRED, description = "Customer's bank IFSC. Required if you want to do a bank account check (TPV).")
  ...
  **/
  @javax.annotation.Nullable
  @Schema(requiredMode = Schema.RequiredMode.NOT_REQUIRED, description = "Customer's bank code. Required for net banking payments, if you want to do a bank account check (TPV).")
  ...
  **/
  @javax.annotation.Nullable
  @Schema(requiredMode = Schema.RequiredMode.NOT_REQUIRED, description = "Customer's identifier at Cashfree. You will get this when you create/get customer.")
