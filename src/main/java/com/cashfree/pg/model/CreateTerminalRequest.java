...
public class CreateTerminalRequest {
  ...
  public static final String SERIALIZED_NAME_TERMINAL_VPA_PREFIX = "terminal_vpa_prefix";
  @SerializedName(SERIALIZED_NAME_TERMINAL_VPA_PREFIX)
  private String terminalVpaPrefix;
  ...
  **/
  ...
  public CreateTerminalRequest terminalVpaPrefix(String terminalVpaPrefix) {
    
    this.terminalVpaPrefix = terminalVpaPrefix;
    return this;
  }

   /**
   * Merchant&#39;s vpa prefix for the terminal.
   * @return terminalVpaPrefix
  **/
  @javax.annotation.Nullable
  @Schema(requiredMode = Schema.RequiredMode.NOT_REQUIRED, description = "Merchant's vpa prefix for the terminal.")
  public String getTerminalVpaPrefix() {
    return terminalVpaPrefix;
  }


  public void setTerminalVpaPrefix(String terminalVpaPrefix) {
    this.terminalVpaPrefix = terminalVpaPrefix;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.terminalId, createTerminalRequest.terminalId) &&
        ...
        Objects.equals(this.terminalVpaPrefix, createTerminalRequest.terminalVpaPrefix);
  }

  @Override
  public int hashCode() {
    return Objects.hash(terminalId, terminalPhoneNo, terminalName, terminalAddress, terminalEmail, terminalNote, terminalType, terminalMeta, terminalVpaPrefix);
  }
  ...
  public String toString() {
    ...
    sb.append("    terminalVpaPrefix: ").append(toIndentedString(terminalVpaPrefix)).append("\n");
    sb.append("}");
    return sb.toString();
  }
  ...
  static {
    ...
    openapiFields.add("terminal_vpa_prefix");
  ...
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if ((jsonObj.get("terminal_vpa_prefix") != null && !jsonObj.get("terminal_vpa_prefix").isJsonNull()) && !jsonObj.get("terminal_vpa_prefix").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `terminal_vpa_prefix` to be a primitive type in the JSON string but got `%s`", jsonObj.get("terminal_vpa_prefix").toString()));
      }
  }
