...
import com.cashfree.pg.model.OrderCreateRefundRequestRefundSplitsInner;
...
public class OrderCreateRefundRequest {
  ...
  private List<OrderCreateRefundRequestRefundSplitsInner> refundSplits = new ArrayList<>();
  ...
  **/
  ...
  @Schema(requiredMode = Schema.RequiredMode.NOT_REQUIRED, description = "An unique ID to associate the refund with. Provie alphanumeric values.")
  ...
  **/
  @javax.annotation.Nullable
  @Schema(requiredMode = Schema.RequiredMode.NOT_REQUIRED, description = "A refund note for your reference. To simulate refund status in Sandbox, pass SUCCESS, FAILED, PENDING, or ACTIVE in the refund_note field. This is a case-sensitive parameter.")
  ...
  **/
  ...
  public OrderCreateRefundRequest refundSplits(List<OrderCreateRefundRequestRefundSplitsInner> refundSplits) {
    
    this.refundSplits = refundSplits;
    return this;
  }

  public OrderCreateRefundRequest addrefundSplitsItem(OrderCreateRefundRequestRefundSplitsInner refundSplitsItem) {
  ...
  **/
  ...
  public List<OrderCreateRefundRequestRefundSplitsInner> getRefundSplits() {
    return refundSplits;
  }


  public void setRefundSplits(List<OrderCreateRefundRequestRefundSplitsInner> refundSplits) {
    this.refundSplits = refundSplits;
  }
      ...
      if (jsonObj.get("refund_splits") != null && !jsonObj.get("refund_splits").isJsonNull()) {
        ...
        if (jsonArrayrefundSplits != null) {
          ...
          for (int i = 0; i < jsonArrayrefundSplits.size(); i++) {
            OrderCreateRefundRequestRefundSplitsInner.validateJsonElement(jsonArrayrefundSplits.get(i));
          };
        }
      }
  }
