 ...
 */
@Schema(description = "Subscription plan details for recurring payments.")
...
public class LinkPlanEntity {
  ...
  public LinkPlanEntity() {
  }

  public LinkPlanEntity planId(String planId) {
  ...
  **/
  ...
  @Schema(requiredMode = Schema.RequiredMode.NOT_REQUIRED, description = "Unique ID to identify the plan. Only alpha-numerics, dot, hyphen and underscore allowed.")
  ...
  public LinkPlanEntity planName(String planName) {
  ...
  **/
  ...
  public LinkPlanEntity planType(String planType) {
  ...
  **/
  @javax.annotation.Nullable
  @Schema(requiredMode = Schema.RequiredMode.NOT_REQUIRED, description = "Type of the plan. Possible values - PERIODIC, ON_DEMAND.")
  ...
  public LinkPlanEntity planCurrency(String planCurrency) {
  ...
  **/
  ...
  public LinkPlanEntity planAmount(BigDecimal planAmount) {
  ...
  **/
  ...
  public LinkPlanEntity planMaxAmount(BigDecimal planMaxAmount) {
  ...
  **/
  ...
  public LinkPlanEntity planMaxCycles(Integer planMaxCycles) {
  ...
  **/
  ...
  public LinkPlanEntity planIntervals(Integer planIntervals) {
  ...
  **/
  ...
  public LinkPlanEntity planIntervalType(String planIntervalType) {
  ...
  **/
  ...
  public LinkPlanEntity planNote(String planNote) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    LinkPlanEntity linkPlanEntity = (LinkPlanEntity) o;
    return Objects.equals(this.planId, linkPlanEntity.planId) &&
        Objects.equals(this.planName, linkPlanEntity.planName) &&
        Objects.equals(this.planType, linkPlanEntity.planType) &&
        Objects.equals(this.planCurrency, linkPlanEntity.planCurrency) &&
        Objects.equals(this.planAmount, linkPlanEntity.planAmount) &&
        Objects.equals(this.planMaxAmount, linkPlanEntity.planMaxAmount) &&
        Objects.equals(this.planMaxCycles, linkPlanEntity.planMaxCycles) &&
        Objects.equals(this.planIntervals, linkPlanEntity.planIntervals) &&
        Objects.equals(this.planIntervalType, linkPlanEntity.planIntervalType) &&
        Objects.equals(this.planNote, linkPlanEntity.planNote);
  }
  ...
  * @throws IOException if the JSON Element is invalid with respect to LinkPlanEntity
  */
  ...
  */
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LinkPlanEntity.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LinkPlanEntity' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LinkPlanEntity> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LinkPlanEntity.class));

       return (TypeAdapter<T>) new TypeAdapter<LinkPlanEntity>() {
           @Override
           public void write(JsonWriter out, LinkPlanEntity value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public LinkPlanEntity read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of LinkPlanEntity given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of LinkPlanEntity
  * @throws IOException if the JSON string is invalid with respect to LinkPlanEntity
  */
  public static LinkPlanEntity fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LinkPlanEntity.class);
  }

 /**
  * Convert an instance of LinkPlanEntity to an JSON string
  *
  * @return JSON string
  */
