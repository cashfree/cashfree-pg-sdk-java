...
public class ReconEntityDataInnerPaymentDetails {
  ...
  public ReconEntityDataInnerPaymentDetails() {
  }

  public ReconEntityDataInnerPaymentDetails paymentAmount(BigDecimal paymentAmount) {
  ...
  **/
  ...
  public ReconEntityDataInnerPaymentDetails paymentCurrency(String paymentCurrency) {
  ...
  **/
  ...
  public ReconEntityDataInnerPaymentDetails bankReference(String bankReference) {
  ...
  **/
  ...
  public ReconEntityDataInnerPaymentDetails paymentTime(String paymentTime) {
  ...
  **/
  ...
  public ReconEntityDataInnerPaymentDetails paymentGroup(String paymentGroup) {
  ...
  **/
  ...
  public ReconEntityDataInnerPaymentDetails paymentServiceCharge(BigDecimal paymentServiceCharge) {
  ...
  **/
  ...
  public ReconEntityDataInnerPaymentDetails paymentServiceTax(BigDecimal paymentServiceTax) {
  ...
  **/
  ...
  public ReconEntityDataInnerPaymentDetails cfPaymentId(String cfPaymentId) {
  ...
  **/
  ...
  public ReconEntityDataInnerPaymentDetails status(String status) {
  ...
  **/
  ...
  public ReconEntityDataInnerPaymentDetails forexConversionHandlingCharge(String forexConversionHandlingCharge) {
  ...
  **/
  ...
  public ReconEntityDataInnerPaymentDetails forexConversionHandlingTax(String forexConversionHandlingTax) {
  ...
  **/
  ...
  public ReconEntityDataInnerPaymentDetails chargesCurrency(String chargesCurrency) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    ReconEntityDataInnerPaymentDetails reconEntityDataInnerPaymentDetails = (ReconEntityDataInnerPaymentDetails) o;
    return Objects.equals(this.paymentAmount, reconEntityDataInnerPaymentDetails.paymentAmount) &&
        Objects.equals(this.paymentCurrency, reconEntityDataInnerPaymentDetails.paymentCurrency) &&
        Objects.equals(this.bankReference, reconEntityDataInnerPaymentDetails.bankReference) &&
        Objects.equals(this.paymentTime, reconEntityDataInnerPaymentDetails.paymentTime) &&
        Objects.equals(this.paymentGroup, reconEntityDataInnerPaymentDetails.paymentGroup) &&
        Objects.equals(this.paymentServiceCharge, reconEntityDataInnerPaymentDetails.paymentServiceCharge) &&
        Objects.equals(this.paymentServiceTax, reconEntityDataInnerPaymentDetails.paymentServiceTax) &&
        Objects.equals(this.cfPaymentId, reconEntityDataInnerPaymentDetails.cfPaymentId) &&
        Objects.equals(this.status, reconEntityDataInnerPaymentDetails.status) &&
        Objects.equals(this.forexConversionHandlingCharge, reconEntityDataInnerPaymentDetails.forexConversionHandlingCharge) &&
        Objects.equals(this.forexConversionHandlingTax, reconEntityDataInnerPaymentDetails.forexConversionHandlingTax) &&
        Objects.equals(this.chargesCurrency, reconEntityDataInnerPaymentDetails.chargesCurrency);
  }

  @Override
  public int hashCode() {
    return Objects.hash(paymentAmount, paymentCurrency, bankReference, paymentTime, paymentGroup, paymentServiceCharge, paymentServiceTax, cfPaymentId, status, forexConversionHandlingCharge, forexConversionHandlingTax, chargesCurrency);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ReconEntityDataInnerPaymentDetails {\n");
  ...
  * @throws IOException if the JSON Element is invalid with respect to ReconEntityDataInnerPaymentDetails
  */
  ...
  */
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ReconEntityDataInnerPaymentDetails.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ReconEntityDataInnerPaymentDetails' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ReconEntityDataInnerPaymentDetails> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ReconEntityDataInnerPaymentDetails.class));

       return (TypeAdapter<T>) new TypeAdapter<ReconEntityDataInnerPaymentDetails>() {
           @Override
           public void write(JsonWriter out, ReconEntityDataInnerPaymentDetails value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ReconEntityDataInnerPaymentDetails read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of ReconEntityDataInnerPaymentDetails given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ReconEntityDataInnerPaymentDetails
  * @throws IOException if the JSON string is invalid with respect to ReconEntityDataInnerPaymentDetails
  */
  public static ReconEntityDataInnerPaymentDetails fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ReconEntityDataInnerPaymentDetails.class);
  }

 /**
  * Convert an instance of ReconEntityDataInnerPaymentDetails to an JSON string
  *
  * @return JSON string
  */
