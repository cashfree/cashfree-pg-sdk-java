...
public class PayOrderRequest {
  ...
  **/
  ...
  @Schema(example = "session__CvcEmNKDkmERQrxnx39ibhJ3Ii034pjc8ZVxf3qcgEXCWlgDDlHRgz2XYZCqpajDQSXMMtCusPgOIxYP2LZx0-05p39gC2Vgmq1RAj--gcn", requiredMode = Schema.RequiredMode.REQUIRED, description = "Unique identifier for the payment session, returned in the response of the Create Order API.")
  ...
  **/
  ...
  @Schema(requiredMode = Schema.RequiredMode.NOT_REQUIRED, description = "Send as **true** if the customer has given consent to save or tokenise the card; otherwise, send as false.")
