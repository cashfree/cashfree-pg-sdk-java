...
public class EligibilityMethodItemEntityDetails {
  ...
  private List<SubscriptionBankDetails> frequentBankDetails = new ArrayList<>();
  ...
  private List<SubscriptionBankDetails> allBankDetails = new ArrayList<>();
  ...
  private List<EligibilityMethodItemEntityDetailsAvailableHandlesInner> availableHandles = new ArrayList<>();
