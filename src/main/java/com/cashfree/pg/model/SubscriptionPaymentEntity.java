...
public class SubscriptionPaymentEntity {
  ...
  **/
  @javax.annotation.Nullable
  @Schema(example = "2025-06-01T10:20:12+05:30", requiredMode = Schema.RequiredMode.NOT_REQUIRED, description = "The date on which the payment was initiated. Cashfree stores timestamps in IST.")
