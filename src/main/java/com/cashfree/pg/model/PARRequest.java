...
public class PARRequest {
  ...
  **/
  ...
  @Schema(example = "4111111111111111", requiredMode = Schema.RequiredMode.REQUIRED, description = "The card number, containing 15 to 19 numeric digits without spaces or special characters.")
  ...
  **/
  @javax.annotation.Nonnull
  @Schema(example = "123", requiredMode = Schema.RequiredMode.REQUIRED, description = "The Card Verification Value (CVV), a 3-digit code for most cards (Visa, Mastercard) and a 4-digit code for American Express, used for transaction authentication.")
  ...
  **/
  @javax.annotation.Nonnull
  @Schema(example = "12", requiredMode = Schema.RequiredMode.REQUIRED, description = "The two-digit expiry month (01-12), indicating when the card will expire.")
  ...
  **/
  @javax.annotation.Nonnull
  @Schema(example = "27", requiredMode = Schema.RequiredMode.REQUIRED, description = "The two-digit expiry year, representing the last two digits of the card’s expiration year.")
  ...
  **/
  ...
  @Schema(requiredMode = Schema.RequiredMode.NOT_REQUIRED, description = "Specifies the type of card, with the only accepted value being `PLAIN_CARD`.")
