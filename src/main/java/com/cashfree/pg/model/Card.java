...
public class Card {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(channel, cardNumber, cardHolderName, cardExpiryMm, cardExpiryYy, cardCvv, instrumentId, cryptogram, tokenRequestorId, tokenReferenceId, tokenType, cardDisplay, cardAlias, cardBankName, addressLineOne, addressLineTwo, city, zipCode, country, countryCode, state, stateCode, emiTenure);
  }
