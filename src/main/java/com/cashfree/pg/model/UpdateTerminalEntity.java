...
import com.cashfree.pg.model.TerminalEntityTerminalMeta;
 ...
 */
@Schema(description = "Update terminal response.")
...
public class UpdateTerminalEntity {
  ...
  private TerminalEntityTerminalMeta terminalMeta;

  public UpdateTerminalEntity() {
  }

  public UpdateTerminalEntity addedOn(String addedOn) {
  ...
  **/
  ...
  public UpdateTerminalEntity cfTerminalId(Integer cfTerminalId) {
  ...
  **/
  ...
  public UpdateTerminalEntity lastUpdatedOn(String lastUpdatedOn) {
  ...
  **/
  ...
  public UpdateTerminalEntity terminalAddress(String terminalAddress) {
  ...
  **/
  ...
  public UpdateTerminalEntity terminalEmail(String terminalEmail) {
  ...
  **/
  ...
  public UpdateTerminalEntity terminalType(String terminalType) {
  ...
  **/
  ...
  public UpdateTerminalEntity teminalId(String teminalId) {
  ...
  **/
  ...
  public UpdateTerminalEntity terminalName(String terminalName) {
  ...
  **/
  ...
  public UpdateTerminalEntity terminalNote(String terminalNote) {
  ...
  **/
  ...
  public UpdateTerminalEntity terminalPhoneNo(String terminalPhoneNo) {
  ...
  **/
  ...
  public UpdateTerminalEntity terminalStatus(String terminalStatus) {
  ...
  **/
  ...
  public UpdateTerminalEntity terminalMeta(TerminalEntityTerminalMeta terminalMeta) {
  ...
  **/
  @javax.annotation.Nullable
  @Schema(requiredMode = Schema.RequiredMode.NOT_REQUIRED, description = "")
  public TerminalEntityTerminalMeta getTerminalMeta() {
    return terminalMeta;
  }


  public void setTerminalMeta(TerminalEntityTerminalMeta terminalMeta) {
    this.terminalMeta = terminalMeta;
  }
  ...
  public boolean equals(Object o) {
    ...
    UpdateTerminalEntity updateTerminalEntity = (UpdateTerminalEntity) o;
    return Objects.equals(this.addedOn, updateTerminalEntity.addedOn) &&
        Objects.equals(this.cfTerminalId, updateTerminalEntity.cfTerminalId) &&
        Objects.equals(this.lastUpdatedOn, updateTerminalEntity.lastUpdatedOn) &&
        Objects.equals(this.terminalAddress, updateTerminalEntity.terminalAddress) &&
        Objects.equals(this.terminalEmail, updateTerminalEntity.terminalEmail) &&
        Objects.equals(this.terminalType, updateTerminalEntity.terminalType) &&
        Objects.equals(this.teminalId, updateTerminalEntity.teminalId) &&
        Objects.equals(this.terminalName, updateTerminalEntity.terminalName) &&
        Objects.equals(this.terminalNote, updateTerminalEntity.terminalNote) &&
        Objects.equals(this.terminalPhoneNo, updateTerminalEntity.terminalPhoneNo) &&
        Objects.equals(this.terminalStatus, updateTerminalEntity.terminalStatus) &&
        Objects.equals(this.terminalMeta, updateTerminalEntity.terminalMeta);
  }
  ...
  * @throws IOException if the JSON Element is invalid with respect to UpdateTerminalEntity
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("terminal_meta") != null && !jsonObj.get("terminal_meta").isJsonNull()) {
        TerminalEntityTerminalMeta.validateJsonElement(jsonObj.get("terminal_meta"));
      }
  }
  ...
  */
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateTerminalEntity.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateTerminalEntity' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateTerminalEntity> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateTerminalEntity.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateTerminalEntity>() {
           @Override
           public void write(JsonWriter out, UpdateTerminalEntity value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdateTerminalEntity read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of UpdateTerminalEntity given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of UpdateTerminalEntity
  * @throws IOException if the JSON string is invalid with respect to UpdateTerminalEntity
  */
  public static UpdateTerminalEntity fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateTerminalEntity.class);
  }

 /**
  * Convert an instance of UpdateTerminalEntity to an JSON string
  *
  * @return JSON string
  */
