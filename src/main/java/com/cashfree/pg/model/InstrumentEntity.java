 ...
 */
@Schema(description = "Use this API to fetch specific saved card stored for the customer in Cashfree’s [Token Vault](https://www.cashfree.com/docs/payments/features/token-vault).")
...
public class InstrumentEntity {
  ...
  **/
  @javax.annotation.Nullable
  @Schema(requiredMode = Schema.RequiredMode.NOT_REQUIRED, description = "Identifier for the card saved at Cashfree.")
  ...
  public InstrumentEntity instrumentType(String instrumentType) {
  ...
  **/
  ...
  public InstrumentEntity instrumentStatus(String instrumentStatus) {
