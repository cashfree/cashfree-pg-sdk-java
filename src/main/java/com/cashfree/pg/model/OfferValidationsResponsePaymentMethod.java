...
import com.cashfree.pg.model.OfferAll;
import com.cashfree.pg.model.OfferCard;
import com.cashfree.pg.model.OfferEMI;
import com.cashfree.pg.model.OfferNB;
import com.cashfree.pg.model.OfferNBNetbanking;
import com.cashfree.pg.model.OfferPaylater;
import com.cashfree.pg.model.OfferUPI;
import com.cashfree.pg.model.OfferWallet;
import com.cashfree.pg.model.PaylaterOffer;
import com.cashfree.pg.model.WalletOffer;
...
public class OfferValidationsResponsePaymentMethod extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(OfferValidationsResponsePaymentMethod.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!OfferValidationsResponsePaymentMethod.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'OfferValidationsResponsePaymentMethod' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<OfferValidationsResponsePaymentMethod>() {
                @Override
                public void write(JsonWriter out, OfferValidationsResponsePaymentMethod value) throws IOException {
                ...
                @Override
                public OfferValidationsResponsePaymentMethod read(JsonReader in) throws IOException {
                    ...
                    // if (match == 1) {
                        OfferValidationsResponsePaymentMethod ret = new OfferValidationsResponsePaymentMethod();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonElement));
                        return ret;
                    // }

                    // throw new IOException(String.format("Failed deserialization for OfferValidationsResponsePaymentMethod: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonElement.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public OfferValidationsResponsePaymentMethod() {
        super("oneOf", Boolean.FALSE);
    }

    public OfferValidationsResponsePaymentMethod(OfferAll o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public OfferValidationsResponsePaymentMethod(OfferCard o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public OfferValidationsResponsePaymentMethod(OfferEMI o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public OfferValidationsResponsePaymentMethod(OfferNB o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public OfferValidationsResponsePaymentMethod(OfferPaylater o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public OfferValidationsResponsePaymentMethod(OfferUPI o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public OfferValidationsResponsePaymentMethod(OfferWallet o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, Class<?>> getSchemas() {
        return OfferValidationsResponsePaymentMethod.schemas;
    }
  ...
  * @throws IOException if the JSON Element is invalid with respect to OfferValidationsResponsePaymentMethod
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    ...
    // if (validCount != 1) {
    //  throw new IOException(String.format("The JSON string is invalid for OfferValidationsResponsePaymentMethod with oneOf schemas: OfferAll, OfferCard, OfferEMI, OfferNB, OfferPaylater, OfferUPI, OfferWallet. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonElement.toString()));
    // }
  }

 /**
  * Create an instance of OfferValidationsResponsePaymentMethod given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of OfferValidationsResponsePaymentMethod
  * @throws IOException if the JSON string is invalid with respect to OfferValidationsResponsePaymentMethod
  */
  public static OfferValidationsResponsePaymentMethod fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, OfferValidationsResponsePaymentMethod.class);
  }

 /**
  * Convert an instance of OfferValidationsResponsePaymentMethod to an JSON string
  *
  * @return JSON string
  */
