...
public class ReconEntityDataInnerDisputeDetails {
  ...
  public ReconEntityDataInnerDisputeDetails() {
  }

  public ReconEntityDataInnerDisputeDetails closedInFavorOf(String closedInFavorOf) {
  ...
  **/
  ...
  public ReconEntityDataInnerDisputeDetails disputeResolvedOn(String disputeResolvedOn) {
  ...
  **/
  ...
  public ReconEntityDataInnerDisputeDetails disputeCategory(String disputeCategory) {
  ...
  **/
  ...
  public ReconEntityDataInnerDisputeDetails disputeNote(String disputeNote) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    ReconEntityDataInnerDisputeDetails reconEntityDataInnerDisputeDetails = (ReconEntityDataInnerDisputeDetails) o;
    return Objects.equals(this.closedInFavorOf, reconEntityDataInnerDisputeDetails.closedInFavorOf) &&
        Objects.equals(this.disputeResolvedOn, reconEntityDataInnerDisputeDetails.disputeResolvedOn) &&
        Objects.equals(this.disputeCategory, reconEntityDataInnerDisputeDetails.disputeCategory) &&
        Objects.equals(this.disputeNote, reconEntityDataInnerDisputeDetails.disputeNote);
  }
  ...
  * @throws IOException if the JSON Element is invalid with respect to ReconEntityDataInnerDisputeDetails
  */
  ...
  */
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ReconEntityDataInnerDisputeDetails.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ReconEntityDataInnerDisputeDetails' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ReconEntityDataInnerDisputeDetails> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ReconEntityDataInnerDisputeDetails.class));

       return (TypeAdapter<T>) new TypeAdapter<ReconEntityDataInnerDisputeDetails>() {
           @Override
           public void write(JsonWriter out, ReconEntityDataInnerDisputeDetails value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ReconEntityDataInnerDisputeDetails read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of ReconEntityDataInnerDisputeDetails given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ReconEntityDataInnerDisputeDetails
  * @throws IOException if the JSON string is invalid with respect to ReconEntityDataInnerDisputeDetails
  */
  public static ReconEntityDataInnerDisputeDetails fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ReconEntityDataInnerDisputeDetails.class);
  }

 /**
  * Convert an instance of ReconEntityDataInnerDisputeDetails to an JSON string
  *
  * @return JSON string
  */
