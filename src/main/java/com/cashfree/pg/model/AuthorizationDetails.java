...
import com.cashfree.pg.model.AuthorizationDetailsPaymentMethod;
 ...
 */
@Schema(description = "Details of the authorization done for the subscription. Returned in Get subscription and payments.")
...
public class AuthorizationDetails {
  ...
  private AuthorizationDetailsPaymentMethod paymentMethod;
  ...
  **/
  ...
  @Schema(requiredMode = Schema.RequiredMode.NOT_REQUIRED, description = "Authorization amount for the auth payment. Please note that authorization_amount will always be 0 for ENACH.")
  ...
  **/
  @javax.annotation.Nullable
  @Schema(example = "2025-06-01T10:20:12+05:30", requiredMode = Schema.RequiredMode.NOT_REQUIRED, description = "Authorization time. Cashfree stores timestamps in IST.")
  ...
  **/
  ...
  public AuthorizationDetails paymentGroup(String paymentGroup) {
  ...
  **/
  @javax.annotation.Nullable
  @Schema(requiredMode = Schema.RequiredMode.NOT_REQUIRED, description = "Payment group used for the authorization.")
  ...
  public AuthorizationDetails paymentMethod(AuthorizationDetailsPaymentMethod paymentMethod) {
  ...
  **/
  ...
  public AuthorizationDetailsPaymentMethod getPaymentMethod() {
    return paymentMethod;
  }


  public void setPaymentMethod(AuthorizationDetailsPaymentMethod paymentMethod) {
    this.paymentMethod = paymentMethod;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.authorizationAmount, authorizationDetails.authorizationAmount) &&
        ...
        Objects.equals(this.paymentGroup, authorizationDetails.paymentGroup) &&
        Objects.equals(this.paymentMethod, authorizationDetails.paymentMethod);
  }

  @Override
  public int hashCode() {
    return Objects.hash(authorizationAmount, authorizationAmountRefund, authorizationReference, authorizationTime, authorizationStatus, paymentId, paymentGroup, paymentMethod);
  }
  ...
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("payment_method") != null && !jsonObj.get("payment_method").isJsonNull()) {
        AuthorizationDetailsPaymentMethod.validateJsonElement(jsonObj.get("payment_method"));
      }
  }
