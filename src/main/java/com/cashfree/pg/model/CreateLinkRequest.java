...
import com.cashfree.pg.model.Subscription;
...
public class CreateLinkRequest {
  ...
  public static final String SERIALIZED_NAME_ENABLE_INVOICE = "enable_invoice";
  @SerializedName(SERIALIZED_NAME_ENABLE_INVOICE)
  ...
  **/
  ...
  @Schema(requiredMode = Schema.RequiredMode.NOT_REQUIRED, description = "Unique Identifier (provided by merchant) for the Link. Alphanumeric and only - and _ allowed (50 character limit). Use this for other link-related APIs.")
  ...
  **/
  @javax.annotation.Nonnull
  @Schema(requiredMode = Schema.RequiredMode.REQUIRED, description = "Currency for the payment link. Default is INR. Submit [Support Form](https://merchant.cashfree.com/auth/login) to enable new currencies.")
  ...
  **/
  @javax.annotation.Nullable
  @Schema(requiredMode = Schema.RequiredMode.NOT_REQUIRED, description = "A brief description for which payment must be collected. This is shown to the customer.")
  ...
  **/
  ...
  public CreateLinkRequest enableInvoice(Boolean enableInvoice) {
  ...
  **/
  @javax.annotation.Nullable
  @Schema(example = "true", requiredMode = Schema.RequiredMode.NOT_REQUIRED, description = "Enable or disable invoice generation for this payment link.")
  ...
  public CreateLinkRequest subscription(Subscription subscription) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.linkId, createLinkRequest.linkId) &&
        ...
        Objects.equals(this.enableInvoice, createLinkRequest.enableInvoice) &&
        Objects.equals(this.subscription, createLinkRequest.subscription);
  }

  @Override
  public int hashCode() {
    return Objects.hash(linkId, linkAmount, linkCurrency, linkPurpose, customerDetails, linkPartialPayments, linkMinimumPartialAmount, linkExpiryTime, linkNotify, linkAutoReminders, linkNotes, linkMeta, orderSplits, enableInvoice, subscription);
  }
  ...
  public String toString() {
    ...
    sb.append("    enableInvoice: ").append(toIndentedString(enableInvoice)).append("\n");
  ...
  static {
    ...
    openapiFields.add("enable_invoice");
