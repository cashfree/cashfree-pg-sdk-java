 ...
 */
@Schema(description = "The data object of Order Pay API.")
...
public class OrderPayData {
  ...
  public static final String SERIALIZED_NAME_REDIRECT_TO_BANK = "redirect_to_bank";
  @SerializedName(SERIALIZED_NAME_REDIRECT_TO_BANK)
  private String redirectToBank;
  ...
  **/
  ...
  @Schema(requiredMode = Schema.RequiredMode.NOT_REQUIRED, description = "For card payments, if the response includes ```action:link```, redirect the customer to the ```data.url``` page. If the response includes ```action:post```, display a native OTP UI to collect the OTP and submit it to ```data.url```.")
  ...
  **/
  @javax.annotation.Nullable
  @Schema(requiredMode = Schema.RequiredMode.NOT_REQUIRED, description = "Key value pairs sent as the request body if the payment link requires a form submission instead of a redirect.")
  ...
  **/
  @javax.annotation.Nullable
  @Schema(requiredMode = Schema.RequiredMode.NOT_REQUIRED, description = "Specifies the Content-Type header that should be used when submitting the payload, for example, ```application/x-www-form-urlencoded```.")
  ...
  **/
  @javax.annotation.Nullable
  @Schema(requiredMode = Schema.RequiredMode.NOT_REQUIRED, description = "The HTTP method to use when submitting the payload to the url. For example, POST.")
  ...
  public OrderPayData redirectToBank(String redirectToBank) {
    
    this.redirectToBank = redirectToBank;
    return this;
  }
   ...
   * @return redirectToBank
  **/
  @javax.annotation.Nullable
  @Schema(requiredMode = Schema.RequiredMode.NOT_REQUIRED, description = "This field is available only for card payments when ```action:post``` is returned. Display a native OTP UI and also provide an option for the customer to redirect to bank page. When the customer selects this option, redirect them to the ```data.redirect_to_bank``` URL.")
  public String getRedirectToBank() {
    return redirectToBank;
  }


  public void setRedirectToBank(String redirectToBank) {
    this.redirectToBank = redirectToBank;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.url, orderPayData.url) &&
        ...
        Objects.equals(this.redirectToBank, orderPayData.redirectToBank);
  }

  @Override
  public int hashCode() {
    return Objects.hash(url, payload, contentType, method, redirectToBank);
  }
  ...
  public String toString() {
    ...
    sb.append("    redirectToBank: ").append(toIndentedString(redirectToBank)).append("\n");
    sb.append("}");
    return sb.toString();
  }
  ...
  static {
    ...
    openapiFields.add("redirect_to_bank");
  ...
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if ((jsonObj.get("redirect_to_bank") != null && !jsonObj.get("redirect_to_bank").isJsonNull()) && !jsonObj.get("redirect_to_bank").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `redirect_to_bank` to be a primitive type in the JSON string but got `%s`", jsonObj.get("redirect_to_bank").toString()));
      }
  }
