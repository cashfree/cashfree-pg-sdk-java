...
public class CreateLinkPlanRequest {
  ...
  public CreateLinkPlanRequest() {
  }

  public CreateLinkPlanRequest planId(String planId) {
  ...
  **/
  ...
  public CreateLinkPlanRequest planName(String planName) {
  ...
  **/
  ...
  public CreateLinkPlanRequest planType(String planType) {
  ...
  **/
  ...
  public CreateLinkPlanRequest planCurrency(String planCurrency) {
  ...
  **/
  ...
  public CreateLinkPlanRequest planAmount(BigDecimal planAmount) {
  ...
  **/
  ...
  public CreateLinkPlanRequest planMaxAmount(BigDecimal planMaxAmount) {
  ...
  **/
  ...
  public CreateLinkPlanRequest planMaxCycles(Integer planMaxCycles) {
  ...
  **/
  ...
  public CreateLinkPlanRequest planIntervals(Integer planIntervals) {
  ...
  **/
  @javax.annotation.Nullable
  @Schema(requiredMode = Schema.RequiredMode.NOT_REQUIRED, description = "Number of billing cycles between charges.")
  ...
  public CreateLinkPlanRequest planIntervalType(String planIntervalType) {
  ...
  **/
  ...
  public CreateLinkPlanRequest planNote(String planNote) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    CreateLinkPlanRequest createLinkPlanRequest = (CreateLinkPlanRequest) o;
    return Objects.equals(this.planId, createLinkPlanRequest.planId) &&
        Objects.equals(this.planName, createLinkPlanRequest.planName) &&
        Objects.equals(this.planType, createLinkPlanRequest.planType) &&
        Objects.equals(this.planCurrency, createLinkPlanRequest.planCurrency) &&
        Objects.equals(this.planAmount, createLinkPlanRequest.planAmount) &&
        Objects.equals(this.planMaxAmount, createLinkPlanRequest.planMaxAmount) &&
        Objects.equals(this.planMaxCycles, createLinkPlanRequest.planMaxCycles) &&
        Objects.equals(this.planIntervals, createLinkPlanRequest.planIntervals) &&
        Objects.equals(this.planIntervalType, createLinkPlanRequest.planIntervalType) &&
        Objects.equals(this.planNote, createLinkPlanRequest.planNote);
  }
  ...
  * @throws IOException if the JSON Element is invalid with respect to CreateLinkPlanRequest
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {


      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CreateLinkPlanRequest.openapiRequiredFields) {
  ...
  */
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateLinkPlanRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateLinkPlanRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateLinkPlanRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateLinkPlanRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateLinkPlanRequest>() {
           @Override
           public void write(JsonWriter out, CreateLinkPlanRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateLinkPlanRequest read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of CreateLinkPlanRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of CreateLinkPlanRequest
  * @throws IOException if the JSON string is invalid with respect to CreateLinkPlanRequest
  */
  public static CreateLinkPlanRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateLinkPlanRequest.class);
  }

 /**
  * Convert an instance of CreateLinkPlanRequest to an JSON string
  *
  * @return JSON string
  */
