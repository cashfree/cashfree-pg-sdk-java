...
import com.cashfree.pg.model.CreateSubscriptionPaymentRequestCardCard;
...
import com.cashfree.pg.model.CreateSubscriptionPaymentRequestUpi;
...
public class CreateSubscriptionPaymentRequestPaymentMethod extends AbstractOpenApiSchema {
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            ...
            final TypeAdapter<CreateSubscriptionPaymentRequestUpi> adapterCreateSubscriptionPaymentRequestUpi = gson.getDelegateAdapter(this, TypeToken.get(CreateSubscriptionPaymentRequestUpi.class));
            ...
            return (TypeAdapter<T>) new TypeAdapter<CreateSubscriptionPaymentRequestPaymentMethod>() {
                ...
                public void write(JsonWriter out, CreateSubscriptionPaymentRequestPaymentMethod value) throws IOException {
                    ...
                    // check if the actual instance is of the type `CreateSubscriptionPaymentRequestUpi`
                    if (value.getActualInstance() instanceof CreateSubscriptionPaymentRequestUpi) {
                      JsonElement element = adapterCreateSubscriptionPaymentRequestUpi.toJsonTree((CreateSubscriptionPaymentRequestUpi)value.getActualInstance());
                    ...
                    throw new IOException("Failed to serialize as the type doesn't match oneOf schemas: CreateSubscriptionPaymentRequestCard, CreateSubscriptionPaymentRequestEnach, CreateSubscriptionPaymentRequestPnach, CreateSubscriptionPaymentRequestUpi");
                }
                ...
                public CreateSubscriptionPaymentRequestPaymentMethod read(JsonReader in) throws IOException {
                    ...
                    // deserialize CreateSubscriptionPaymentRequestUpi
                    try {
                      // validate the JSON object to see if any exception is thrown
                      if(CreateSubscriptionPaymentRequestUpi.validateJsonElementForOneOf(jsonElement)) {
                          actualAdapter = adapterCreateSubscriptionPaymentRequestUpi;
                      }
                      match++;
                      log.log(Level.FINER, "Input data matches schema 'CreateSubscriptionPaymentRequestUpi'");
                    } catch (Exception e) {
                      // deserialization failed, continue
                      errorMessages.add(String.format("Deserialization for CreateSubscriptionPaymentRequestUpi failed with `%s`.", e.getMessage()));
                      log.log(Level.FINER, "Input data does not match schema 'CreateSubscriptionPaymentRequestUpi'", e);
                    }
    ...
    public CreateSubscriptionPaymentRequestPaymentMethod(CreateSubscriptionPaymentRequestUpi o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    static {
        schemas.put("CreateSubscriptionPaymentRequestUpi", CreateSubscriptionPaymentRequestUpi.class);
     ...
     * CreateSubscriptionPaymentRequestCard, CreateSubscriptionPaymentRequestEnach, CreateSubscriptionPaymentRequestPnach, CreateSubscriptionPaymentRequestUpi
     *
     * It could be an instance of the 'oneOf' schemas.
     */
    @Override
    public void setActualInstance(Object instance) {
        if (instance instanceof CreateSubscriptionPaymentRequestUpi) {
        ...
        throw new RuntimeException("Invalid instance type. Must be CreateSubscriptionPaymentRequestCard, CreateSubscriptionPaymentRequestEnach, CreateSubscriptionPaymentRequestPnach, CreateSubscriptionPaymentRequestUpi");
    }
     ...
     * CreateSubscriptionPaymentRequestCard, CreateSubscriptionPaymentRequestEnach, CreateSubscriptionPaymentRequestPnach, CreateSubscriptionPaymentRequestUpi
     *
     * @return The actual instance (CreateSubscriptionPaymentRequestCard, CreateSubscriptionPaymentRequestEnach, CreateSubscriptionPaymentRequestPnach, CreateSubscriptionPaymentRequestUpi)
     */
    @Override
    ...
    /**
     * Get the actual instance of `CreateSubscriptionPaymentRequestUpi`. If the actual instance is not `CreateSubscriptionPaymentRequestUpi`,
     * the ClassCastException will be thrown.
     *
     * @return The actual instance of `CreateSubscriptionPaymentRequestUpi`
     * @throws ClassCastException if the instance is not `CreateSubscriptionPaymentRequestUpi`
     */
    public CreateSubscriptionPaymentRequestUpi getCreateSubscriptionPaymentRequestUpi() throws ClassCastException {
        return (CreateSubscriptionPaymentRequestUpi)super.getActualInstance();
    }
    /**
  ...
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    ...
    int validCount = 0;
    ArrayList<String> errorMessages = new ArrayList<>();
    // validate the json string with CreateSubscriptionPaymentRequestUpi
    try {
      CreateSubscriptionPaymentRequestUpi.validateJsonElement(jsonElement);
      validCount++;
    } catch (Exception e) {
      errorMessages.add(String.format("Deserialization for CreateSubscriptionPaymentRequestUpi failed with `%s`.", e.getMessage()));
    ...
    // if (validCount != 1) {
    //  throw new IOException(String.format("The JSON string is invalid for CreateSubscriptionPaymentRequestPaymentMethod with oneOf schemas: CreateSubscriptionPaymentRequestCard, CreateSubscriptionPaymentRequestEnach, CreateSubscriptionPaymentRequestPnach, CreateSubscriptionPaymentRequestUpi. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonElement.toString()));
    // }
  }
