...
import com.cashfree.pg.auth.HttpBearerAuth;
...
public class Cashfree {
  ...
  public String XApiVersion = "2026-01-01";
  ...
  public Cashfree(CFEnvironment environment, String clientId, String clientSecret, String partnerApiKey, String partnerMerchantId, String clientSignature) {
    if(clientId != null && clientId != "") {
        this.XClientId = clientId;
    }
    if(clientSecret != null && clientSecret != "") {
        this.XClientSecret = clientSecret;
    }
    if(partnerApiKey != null && partnerApiKey != "") {
        this.XPartnerAPIKey = partnerApiKey;
    }
    if(partnerMerchantId != null && partnerMerchantId != "") {
        this.XPartnerMerchantID = partnerMerchantId;
    }
    if(clientSignature != null && clientSignature != "") {
        this.XClientSignature = clientSignature;
    }
    this.XEnvironment = environment;
  }
  ...
  public PGWebhookEvent PGVerifyWebhookSignature(String signature, String rawBody, String timestamp) throws Exception {
    ...
    public okhttp3.Call pGCreateCustomerCall(String xApiVersion, CreateCustomerRequest createCustomerRequest, String xRequestId, UUID xIdempotencyKey, final ApiCallback _callback) throws ApiException {
        ...
        if(this.XClientSecret != null && !this.XClientSecret.isEmpty()) {
            ApiKeyAuth xcs = (ApiKeyAuth) localVarApiClient.getAuthentication("XClientSecret");
            xcs.setApiKey(this.XClientSecret);
        }

        if(this.XClientId != null && !this.XClientId.isEmpty()) {
            ApiKeyAuth xcid = (ApiKeyAuth) localVarApiClient.getAuthentication("XClientID");
            xcid.setApiKey(this.XClientId);
        }

        if(this.XClientSignature != null && !this.XClientSignature.isEmpty()) {
            ApiKeyAuth xcs = (ApiKeyAuth) localVarApiClient.getAuthentication("XClientSignatureHeader");
            xcs.setApiKey(this.XClientSignature);
        }

        if(this.XPartnerAPIKey != null && !this.XPartnerAPIKey.isEmpty()) {
            ApiKeyAuth xpa = (ApiKeyAuth) localVarApiClient.getAuthentication("XPartnerAPIKey");
            xpa.setApiKey(this.XPartnerAPIKey);
        }

        if(this.XPartnerMerchantID != null && !this.XPartnerMerchantID.isEmpty()) {
            ApiKeyAuth xmid = (ApiKeyAuth) localVarApiClient.getAuthentication("XPartnerMerchantID");
            xmid.setApiKey(this.XPartnerMerchantID);
        }
        ...
        localVarHeaderParams.put("x-sdk-platform", "javasdk-6.0.2");
    ...
    public ApiResponse<CustomerEntity> PGCreateCustomer(CreateCustomerRequest createCustomerRequest, String xRequestId, UUID xIdempotencyKey, OkHttpClient httpClient) throws ApiException {
    ...
    public ApiResponse<DisputesEntityMerchantAccepted> PGAcceptDisputeByID(Integer disputeId, String xRequestId, UUID xIdempotencyKey, OkHttpClient httpClient) throws ApiException {
        String xApiVersion = this.XApiVersion;
        if(httpClient != null) {
            localVarApiClient.httpClient = httpClient;
        }
    ...
    public ApiResponse<DisputesEntity> PGFetchDisputeByID(Integer disputeId, String xRequestId, UUID xIdempotencyKey, OkHttpClient httpClient) throws ApiException {
        String xApiVersion = this.XApiVersion;
        if(httpClient != null) {
            localVarApiClient.httpClient = httpClient;
        }
    ...
    public ApiResponse<List<DisputesEntity>> PGFetchOrderDisputes(String orderId, String xRequestId, UUID xIdempotencyKey, OkHttpClient httpClient) throws ApiException {
        String xApiVersion = this.XApiVersion;
        if(httpClient != null) {
            localVarApiClient.httpClient = httpClient;
        }
    ...
    public ApiResponse<List<DisputesEntity>> PGFetchPaymentDisputes(Integer cfPaymentId, String xRequestId, UUID xIdempotencyKey, OkHttpClient httpClient) throws ApiException {
        String xApiVersion = this.XApiVersion;
        if(httpClient != null) {
            localVarApiClient.httpClient = httpClient;
        }
    ...
    public ApiResponse<List<DisputesEntity>> PGUploadDisputesDocuments(Integer disputeId, String _file, String docType, String xRequestId, UUID xIdempotencyKey, String note, OkHttpClient httpClient) throws ApiException {
        String xApiVersion = this.XApiVersion;
        if(httpClient != null) {
            localVarApiClient.httpClient = httpClient;
        }
    ...
    /**
     * Build call for fetchActiveEcosystemDowntimes
     * @param xApiVersion API version to be used. Format is in YYYY-MM-DD. (required)
     * @param xRequestId Request ID for the API call. Can be used to resolve tech issues. Communicate this in your tech related queries to Cashfree. (optional)
     * @param xIdempotencyKey An idempotency key is a unique identifier you include with your API call. If the request fails or times out, you can safely retry it using the same key to avoid duplicate actions.  (optional)
     * @param incidentId Valid incident id for fetching incident details. (optional)
     * @param incidentStatus Filter incidents by status. Possible values: ACTIVE, UPCOMING, RESOLVED. (optional)
     * @param incidentImpact Filter incidents by impact level. Possible values: HIGH, MEDIUM, LOW. (optional)
     * @param incidentType Filter incidents by type. Possible values: SCHEDULED, UNSCHEDULED. (optional)
     * @param incidentStartTime Filter incidents by start time. Format: YYYY-MM-DD HH:MM:SS. (optional)
     * @param incidentEndTime Filter incidents by end time. Format: YYYY-MM-DD HH:MM:SS. (optional)
     * @param paymentMethod Filter incidents by payment method. Possible values: UPI, CARD, NET_BANKING, WALLET. (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 200 </td><td> Success response for Fetch All Downtimes. </td><td>  * X-Api-Version -  <br>  </td></tr>
        <tr><td> 401 </td><td> Authentication Error. </td><td>  * x-api-version -  <br>  * x-ratelimit-limit -  <br>  * x-ratelimit-remaining -  <br>  * x-ratelimit-retry -  <br>  * x-ratelimit-type -  <br>  * x-request-id -  <br>  * x-idempotency-key -  <br>  * x-idempotency-replayed -  <br>  </td></tr>
        <tr><td> 500 </td><td> API related Error. </td><td>  * x-api-version -  <br>  * x-ratelimit-limit -  <br>  * x-ratelimit-remaining -  <br>  * x-ratelimit-retry -  <br>  * x-ratelimit-type -  <br>  * x-request-id -  <br>  * x-idempotency-key -  <br>  * x-idempotency-replayed -  <br>  </td></tr>
     </table>
     */
    public okhttp3.Call fetchActiveEcosystemDowntimesCall(String xApiVersion, String xRequestId, UUID xIdempotencyKey, String incidentId, List<String> incidentStatus, List<String> incidentImpact, List<String> incidentType, OffsetDateTime incidentStartTime, OffsetDateTime incidentEndTime, List<String> paymentMethod, final ApiCallback _callback) throws ApiException {
        String basePath = "https://sandbox.cashfree.com/pg";
        ...
        if (incidentStatus != null) {
            localVarCollectionQueryParams.addAll(localVarApiClient.parameterToPairs("multi", "incident_status", incidentStatus));
        }

        if (incidentImpact != null) {
            localVarCollectionQueryParams.addAll(localVarApiClient.parameterToPairs("multi", "incident_impact", incidentImpact));
        }

        if (incidentType != null) {
            localVarCollectionQueryParams.addAll(localVarApiClient.parameterToPairs("multi", "incident_type", incidentType));
        }

        if (incidentStartTime != null) {
            localVarQueryParams.addAll(localVarApiClient.parameterToPair("incident_start_time", incidentStartTime));
        }

        if (incidentEndTime != null) {
            localVarQueryParams.addAll(localVarApiClient.parameterToPair("incident_end_time", incidentEndTime));
        }

        if (paymentMethod != null) {
            localVarCollectionQueryParams.addAll(localVarApiClient.parameterToPairs("multi", "payment_method", paymentMethod));
        }
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call fetchActiveEcosystemDowntimesValidateBeforeCall(String xApiVersion, String xRequestId, UUID xIdempotencyKey, String incidentId, List<String> incidentStatus, List<String> incidentImpact, List<String> incidentType, OffsetDateTime incidentStartTime, OffsetDateTime incidentEndTime, List<String> paymentMethod, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'xApiVersion' is set
        if (xApiVersion == null) {
            throw new ApiException("Missing the required parameter 'xApiVersion' when calling FetchActiveEcosystemDowntimes(Async)");
        }

        return fetchActiveEcosystemDowntimesCall(xApiVersion, xRequestId, xIdempotencyKey, incidentId, incidentStatus, incidentImpact, incidentType, incidentStartTime, incidentEndTime, paymentMethod, _callback);

    }

    public ApiResponse<FetchActiveEcosystemDowntimes200Response> FetchActiveEcosystemDowntimes(String xRequestId, UUID xIdempotencyKey, String incidentId, List<String> incidentStatus, List<String> incidentImpact, List<String> incidentType, OffsetDateTime incidentStartTime, OffsetDateTime incidentEndTime, List<String> paymentMethod, OkHttpClient httpClient) throws ApiException {
        String xApiVersion = this.XApiVersion;
        if(httpClient != null) {
            localVarApiClient.httpClient = httpClient;
        }
        okhttp3.Call localVarCall = fetchActiveEcosystemDowntimesValidateBeforeCall(xApiVersion, xRequestId, xIdempotencyKey, incidentId, incidentStatus, incidentImpact, incidentType, incidentStartTime, incidentEndTime, paymentMethod, null);
        Type localVarReturnType = new TypeToken<FetchActiveEcosystemDowntimes200Response>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
    ...
    public ApiResponse<VendorAdjustmentSuccessResponse> PGESCreateAdjustment(String vendorId, String xRequestId, UUID xIdempotencyKey, VendorAdjustmentRequest vendorAdjustmentRequest, OkHttpClient httpClient) throws ApiException {
        String xApiVersion = this.XApiVersion;
        if(httpClient != null) {
            localVarApiClient.httpClient = httpClient;
        }
    ...
    public ApiResponse<AdjustVendorBalanceResponse> PGESCreateOnDemandTransfer(String vendorId, String xRequestId, UUID xIdempotencyKey, AdjustVendorBalanceRequest adjustVendorBalanceRequest, OkHttpClient httpClient) throws ApiException {
        String xApiVersion = this.XApiVersion;
        if(httpClient != null) {
            localVarApiClient.httpClient = httpClient;
        }
    ...
    public ApiResponse<CreateVendorResponse> PGESCreateVendors(String xRequestId, UUID xIdempotencyKey, CreateVendorRequest createVendorRequest, OkHttpClient httpClient) throws ApiException {
        String xApiVersion = this.XApiVersion;
        if(httpClient != null) {
            localVarApiClient.httpClient = httpClient;
        }
    ...
    public ApiResponse<VendorDocumentDownloadResponse> PGESDownloadVendorsDocs(String docType, String vendorId, String xRequestId, UUID xIdempotencyKey, OkHttpClient httpClient) throws ApiException {
        String xApiVersion = this.XApiVersion;
        if(httpClient != null) {
            localVarApiClient.httpClient = httpClient;
        }
    ...
    public ApiResponse<VendorEntity> PGESFetchVendors(String vendorId, String xRequestId, UUID xIdempotencyKey, OkHttpClient httpClient) throws ApiException {
        String xApiVersion = this.XApiVersion;
        if(httpClient != null) {
            localVarApiClient.httpClient = httpClient;
        }
    ...
    public ApiResponse<VendorBalance> PGESGetVendorBalance(String vendorId, String xRequestId, UUID xIdempotencyKey, OkHttpClient httpClient) throws ApiException {
        String xApiVersion = this.XApiVersion;
        if(httpClient != null) {
            localVarApiClient.httpClient = httpClient;
        }
    ...
    public ApiResponse<VendorBalanceTransferCharges> PGESGetVendorBalanceTransferCharges(BigDecimal amount, String rateType, String xRequestId, UUID xIdempotencyKey, OkHttpClient httpClient) throws ApiException {
        String xApiVersion = this.XApiVersion;
        if(httpClient != null) {
            localVarApiClient.httpClient = httpClient;
        }
    ...
    public ApiResponse<VendorDocumentsResponse> PGESGetVendorsDocs(String vendorId, String xRequestId, UUID xIdempotencyKey, OkHttpClient httpClient) throws ApiException {
        String xApiVersion = this.XApiVersion;
        if(httpClient != null) {
            localVarApiClient.httpClient = httpClient;
        }
    ...
    public ApiResponse<ESOrderReconResponse> PGESOrderRecon(String xRequestId, UUID xIdempotencyKey, ESOrderReconRequest esOrderReconRequest, OkHttpClient httpClient) throws ApiException {
        String xApiVersion = this.XApiVersion;
        if(httpClient != null) {
            localVarApiClient.httpClient = httpClient;
        }
    ...
    public ApiResponse<UpdateVendorResponse> PGESUpdateVendors(String vendorId, String xRequestId, UUID xIdempotencyKey, UpdateVendorRequest updateVendorRequest, OkHttpClient httpClient) throws ApiException {
        String xApiVersion = this.XApiVersion;
        if(httpClient != null) {
            localVarApiClient.httpClient = httpClient;
        }
    ...
    public ApiResponse<UploadVendorDocumentsResponse> PGESUploadVendorsDocs(String vendorId, String xRequestId, UUID xIdempotencyKey, String docType, String docValue, File _file, OkHttpClient httpClient) throws ApiException {
        String xApiVersion = this.XApiVersion;
        if(httpClient != null) {
            localVarApiClient.httpClient = httpClient;
        }
    ...
    public ApiResponse<SplitAfterPaymentResponse> PGOrderSplitAfterPayment(String orderId, String xRequestId, UUID xIdempotencyKey, SplitAfterPaymentRequest splitAfterPaymentRequest, OkHttpClient httpClient) throws ApiException {
        String xApiVersion = this.XApiVersion;
        if(httpClient != null) {
            localVarApiClient.httpClient = httpClient;
        }
    ...
    public ApiResponse<StaticSplitResponse> PGOrderStaticSplit(String xRequestId, UUID xIdempotencyKey, StaticSplitRequest staticSplitRequest, OkHttpClient httpClient) throws ApiException {
        String xApiVersion = this.XApiVersion;
        if(httpClient != null) {
            localVarApiClient.httpClient = httpClient;
        }
    ...
    public ApiResponse<SplitOrderReconSuccessResponse> PGSplitOrderRecon(String orderId, String xRequestId, UUID xIdempotencyKey, OkHttpClient httpClient) throws ApiException {
        String xApiVersion = this.XApiVersion;
        if(httpClient != null) {
            localVarApiClient.httpClient = httpClient;
        }
    ...
    public ApiResponse<List<EligibilityCardlessEMIEntity>> PGEligibilityFetchCardlessEMI(EligibilityFetchCardlessEMIRequest eligibilityFetchCardlessEMIRequest, String xRequestId, UUID xIdempotencyKey, OkHttpClient httpClient) throws ApiException {
        String xApiVersion = this.XApiVersion;
        if(httpClient != null) {
            localVarApiClient.httpClient = httpClient;
        }
    ...
    public ApiResponse<List<EligibilityOfferEntity>> PGEligibilityFetchOffers(EligibilityFetchOffersRequest eligibilityFetchOffersRequest, String xRequestId, UUID xIdempotencyKey, OkHttpClient httpClient) throws ApiException {
        String xApiVersion = this.XApiVersion;
        if(httpClient != null) {
            localVarApiClient.httpClient = httpClient;
        }
    ...
    public ApiResponse<List<EligibilityPaylaterEntity>> PGEligibilityFetchPaylater(EligibilityFetchPaylaterRequest eligibilityFetchPaylaterRequest, String xRequestId, UUID xIdempotencyKey, OkHttpClient httpClient) throws ApiException {
        String xApiVersion = this.XApiVersion;
        if(httpClient != null) {
            localVarApiClient.httpClient = httpClient;
        }
     ...
     * @param xRequestId Request ID for the API call. Can be used to resolve tech issues. Communicate this in your tech related queries to Cashfree. (optional)
     * @param xIdempotencyKey An idempotency key is a unique identifier you include with your API call. If the request fails or times out, you can safely retry it using the same key to avoid duplicate actions.  (optional)
     * @param xClientDevice The type of device on which the payment is initiated. (optional)
     * @param xClientOs The operating system of the client device used to make the payment. (optional)
     * @param xClientRenderingType Indicates how the payment experience is rendered to the user. - mweb – Payment rendered in a mobile browser (browser on a mobile device) - webview – Payment rendered inside an in-app browser (WebView within a merchant app) - native – Payment rendered natively within the merchant’s mobile app using SDKs. (optional)
     * @param xClientBrowser The browser used to initiate the payment. (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     ...
     */
    public okhttp3.Call pGEligibilityFetchPaymentMethodsCall(String xApiVersion, EligibilityFetchPaymentMethodsRequest eligibilityFetchPaymentMethodsRequest, String xRequestId, UUID xIdempotencyKey, String xClientDevice, String xClientOs, String xClientRenderingType, String xClientBrowser, final ApiCallback _callback) throws ApiException {
        String basePath = "https://sandbox.cashfree.com/pg";
        ...
        if (xClientDevice != null) {
            localVarHeaderParams.put("x-client-device", localVarApiClient.parameterToString(xClientDevice));
        }

        if (xClientOs != null) {
            localVarHeaderParams.put("x-client-os", localVarApiClient.parameterToString(xClientOs));
        }

        if (xClientRenderingType != null) {
            localVarHeaderParams.put("x-client-rendering-type", localVarApiClient.parameterToString(xClientRenderingType));
        }

        if (xClientBrowser != null) {
            localVarHeaderParams.put("x-client-browser", localVarApiClient.parameterToString(xClientBrowser));
        }
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call pGEligibilityFetchPaymentMethodsValidateBeforeCall(String xApiVersion, EligibilityFetchPaymentMethodsRequest eligibilityFetchPaymentMethodsRequest, String xRequestId, UUID xIdempotencyKey, String xClientDevice, String xClientOs, String xClientRenderingType, String xClientBrowser, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'xApiVersion' is set
        if (xApiVersion == null) {
        ...
        return pGEligibilityFetchPaymentMethodsCall(xApiVersion, eligibilityFetchPaymentMethodsRequest, xRequestId, xIdempotencyKey, xClientDevice, xClientOs, xClientRenderingType, xClientBrowser, _callback);

    }

    public ApiResponse<List<EligibilityPaymentMethodsEntity>> PGEligibilityFetchPaymentMethods(EligibilityFetchPaymentMethodsRequest eligibilityFetchPaymentMethodsRequest, String xRequestId, UUID xIdempotencyKey, String xClientDevice, String xClientOs, String xClientRenderingType, String xClientBrowser, OkHttpClient httpClient) throws ApiException {
        String xApiVersion = this.XApiVersion;
        if(httpClient != null) {
            localVarApiClient.httpClient = httpClient;
        }
        okhttp3.Call localVarCall = pGEligibilityFetchPaymentMethodsValidateBeforeCall(xApiVersion, eligibilityFetchPaymentMethodsRequest, xRequestId, xIdempotencyKey, xClientDevice, xClientOs, xClientRenderingType, xClientBrowser, null);
    ...
    /**
     * Build call for fetchDowntimeById
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 200 </td><td> Success response for Fetch Downtime by ID. </td><td>  * X-Api-Version -  <br>  </td></tr>
        <tr><td> 401 </td><td> Authentication Error. </td><td>  * x-api-version -  <br>  * x-ratelimit-limit -  <br>  * x-ratelimit-remaining -  <br>  * x-ratelimit-retry -  <br>  * x-ratelimit-type -  <br>  * x-request-id -  <br>  * x-idempotency-key -  <br>  * x-idempotency-replayed -  <br>  </td></tr>
        <tr><td> 404 </td><td> Resource Not found. </td><td>  * x-api-version -  <br>  * x-ratelimit-limit -  <br>  * x-ratelimit-remaining -  <br>  * x-ratelimit-retry -  <br>  * x-ratelimit-type -  <br>  * x-request-id -  <br>  * x-idempotency-key -  <br>  * x-idempotency-replayed -  <br>  </td></tr>
        <tr><td> 500 </td><td> API related Error. </td><td>  * x-api-version -  <br>  * x-ratelimit-limit -  <br>  * x-ratelimit-remaining -  <br>  * x-ratelimit-retry -  <br>  * x-ratelimit-type -  <br>  * x-request-id -  <br>  * x-idempotency-key -  <br>  * x-idempotency-replayed -  <br>  </td></tr>
     </table>
     */
    public okhttp3.Call fetchDowntimeByIdCall(String id, String xApiVersion, String xRequestId, UUID xIdempotencyKey, final ApiCallback _callback) throws ApiException {
        String basePath = "https://sandbox.cashfree.com/pg";
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call fetchDowntimeByIdValidateBeforeCall(String id, String xApiVersion, String xRequestId, UUID xIdempotencyKey, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'id' is set
        if (id == null) {
            throw new ApiException("Missing the required parameter 'id' when calling FetchDowntimeById(Async)");
        }

        // verify the required parameter 'xApiVersion' is set
        if (xApiVersion == null) {
            throw new ApiException("Missing the required parameter 'xApiVersion' when calling FetchDowntimeById(Async)");
        }

        return fetchDowntimeByIdCall(id, xApiVersion, xRequestId, xIdempotencyKey, _callback);

    }

    public ApiResponse<IncidentByIdResponse> FetchDowntimeById(String id, String xRequestId, UUID xIdempotencyKey, OkHttpClient httpClient) throws ApiException {
        String xApiVersion = this.XApiVersion;
        if(httpClient != null) {
            localVarApiClient.httpClient = httpClient;
        }
        okhttp3.Call localVarCall = fetchDowntimeByIdValidateBeforeCall(id, xApiVersion, xRequestId, xIdempotencyKey, null);
        Type localVarReturnType = new TypeToken<IncidentByIdResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
    ...
    public ApiResponse<OfferEntity> PGCreateOffer(CreateOfferRequest createOfferRequest, String xRequestId, UUID xIdempotencyKey, OkHttpClient httpClient) throws ApiException {
        String xApiVersion = this.XApiVersion;
        if(httpClient != null) {
            localVarApiClient.httpClient = httpClient;
        }
    ...
    public ApiResponse<OfferEntity> PGFetchOffer(String offerId, String xRequestId, UUID xIdempotencyKey, OkHttpClient httpClient) throws ApiException {
        String xApiVersion = this.XApiVersion;
        if(httpClient != null) {
            localVarApiClient.httpClient = httpClient;
        }
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 200 </td><td> Success response for creating an order. </td><td>  * x-api-version -  <br>  * x-ratelimit-limit -  <br>  * x-ratelimit-remaining -  <br>  * x-ratelimit-retry -  <br>  * x-ratelimit-type -  <br>  * x-request-id -  <br>  * x-idempotency-key -  <br>  * x-idempotency-replayed -  <br>  </td></tr>
        <tr><td> 400 </td><td> Bad request error. </td><td>  * x-api-version -  <br>  * x-ratelimit-limit -  <br>  * x-ratelimit-remaining -  <br>  * x-ratelimit-retry -  <br>  * x-ratelimit-type -  <br>  * x-request-id -  <br>  * x-idempotency-key -  <br>  * x-idempotency-replayed -  <br>  </td></tr>
        <tr><td> 401 </td><td> Authentication Error. </td><td>  * x-api-version -  <br>  * x-ratelimit-limit -  <br>  * x-ratelimit-remaining -  <br>  * x-ratelimit-retry -  <br>  * x-ratelimit-type -  <br>  * x-request-id -  <br>  * x-idempotency-key -  <br>  * x-idempotency-replayed -  <br>  </td></tr>
        <tr><td> 404 </td><td> Resource Not found. </td><td>  * x-api-version -  <br>  * x-ratelimit-limit -  <br>  * x-ratelimit-remaining -  <br>  * x-ratelimit-retry -  <br>  * x-ratelimit-type -  <br>  * x-request-id -  <br>  * x-idempotency-key -  <br>  * x-idempotency-replayed -  <br>  </td></tr>
        <tr><td> 409 </td><td> Resource already present. </td><td>  * x-api-version -  <br>  * x-ratelimit-limit -  <br>  * x-ratelimit-remaining -  <br>  * x-ratelimit-retry -  <br>  * x-ratelimit-type -  <br>  * x-request-id -  <br>  * x-idempotency-key -  <br>  * x-idempotency-replayed -  <br>  </td></tr>
    ...
    public ApiResponse<OrderEntity> PGCreateOrder(CreateOrderRequest createOrderRequest, String xRequestId, UUID xIdempotencyKey, OkHttpClient httpClient) throws ApiException {
        String xApiVersion = this.XApiVersion;
        if(httpClient != null) {
            localVarApiClient.httpClient = httpClient;
        }
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 200 </td><td> Success response for fetching an order. </td><td>  * x-api-version -  <br>  * x-ratelimit-limit -  <br>  * x-ratelimit-remaining -  <br>  * x-ratelimit-retry -  <br>  * x-ratelimit-type -  <br>  * x-request-id -  <br>  * x-idempotency-key -  <br>  * x-idempotency-replayed -  <br>  </td></tr>
        <tr><td> 400 </td><td> Bad request error. </td><td>  * x-api-version -  <br>  * x-ratelimit-limit -  <br>  * x-ratelimit-remaining -  <br>  * x-ratelimit-retry -  <br>  * x-ratelimit-type -  <br>  * x-request-id -  <br>  * x-idempotency-key -  <br>  * x-idempotency-replayed -  <br>  </td></tr>
        <tr><td> 401 </td><td> Authentication Error. </td><td>  * x-api-version -  <br>  * x-ratelimit-limit -  <br>  * x-ratelimit-remaining -  <br>  * x-ratelimit-retry -  <br>  * x-ratelimit-type -  <br>  * x-request-id -  <br>  * x-idempotency-key -  <br>  * x-idempotency-replayed -  <br>  </td></tr>
        <tr><td> 404 </td><td> Resource Not found. </td><td>  * x-api-version -  <br>  * x-ratelimit-limit -  <br>  * x-ratelimit-remaining -  <br>  * x-ratelimit-retry -  <br>  * x-ratelimit-type -  <br>  * x-request-id -  <br>  * x-idempotency-key -  <br>  * x-idempotency-replayed -  <br>  </td></tr>
        <tr><td> 409 </td><td> Resource already present. </td><td>  * x-api-version -  <br>  * x-ratelimit-limit -  <br>  * x-ratelimit-remaining -  <br>  * x-ratelimit-retry -  <br>  * x-ratelimit-type -  <br>  * x-request-id -  <br>  * x-idempotency-key -  <br>  * x-idempotency-replayed -  <br>  </td></tr>
    ...
    public ApiResponse<OrderEntity> PGFetchOrder(String orderId, String xRequestId, UUID xIdempotencyKey, OkHttpClient httpClient) throws ApiException {
        String xApiVersion = this.XApiVersion;
        if(httpClient != null) {
            localVarApiClient.httpClient = httpClient;
        }
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 200 </td><td> Success response for fetching order extended data. </td><td>  * x-api-version -  <br>  * x-ratelimit-limit -  <br>  * x-ratelimit-remaining -  <br>  * x-ratelimit-retry -  <br>  * x-ratelimit-type -  <br>  * x-request-id -  <br>  * x-idempotency-key -  <br>  * x-idempotency-replayed -  <br>  </td></tr>
        <tr><td> 400 </td><td> Bad request error. </td><td>  * x-api-version -  <br>  * x-ratelimit-limit -  <br>  * x-ratelimit-remaining -  <br>  * x-ratelimit-retry -  <br>  * x-ratelimit-type -  <br>  * x-request-id -  <br>  * x-idempotency-key -  <br>  * x-idempotency-replayed -  <br>  </td></tr>
        <tr><td> 401 </td><td> Authentication Error. </td><td>  * x-api-version -  <br>  * x-ratelimit-limit -  <br>  * x-ratelimit-remaining -  <br>  * x-ratelimit-retry -  <br>  * x-ratelimit-type -  <br>  * x-request-id -  <br>  * x-idempotency-key -  <br>  * x-idempotency-replayed -  <br>  </td></tr>
        <tr><td> 404 </td><td> Resource Not found. </td><td>  * x-api-version -  <br>  * x-ratelimit-limit -  <br>  * x-ratelimit-remaining -  <br>  * x-ratelimit-retry -  <br>  * x-ratelimit-type -  <br>  * x-request-id -  <br>  * x-idempotency-key -  <br>  * x-idempotency-replayed -  <br>  </td></tr>
        <tr><td> 409 </td><td> Resource already present. </td><td>  * x-api-version -  <br>  * x-ratelimit-limit -  <br>  * x-ratelimit-remaining -  <br>  * x-ratelimit-retry -  <br>  * x-ratelimit-type -  <br>  * x-request-id -  <br>  * x-idempotency-key -  <br>  * x-idempotency-replayed -  <br>  </td></tr>
    ...
    public ApiResponse<OrderExtendedDataEntity> PGFetchOrderExtendedData(String orderId, String xRequestId, UUID xIdempotencyKey, OkHttpClient httpClient) throws ApiException {
        String xApiVersion = this.XApiVersion;
        if(httpClient != null) {
            localVarApiClient.httpClient = httpClient;
        }
     ...
     * @param xApiVersion API version to be used. Format is in YYYY-MM-DD. (required)
     * @param orderId The ID which uniquely identifies your order. (required)
     * @param terminateOrderRequest Request to terminate an active order at Cashfree. (required)
     * @param xRequestId Request ID for the API call. Can be used to resolve tech issues. Communicate this in your tech related queries to Cashfree. (optional)
     * @param xIdempotencyKey An idempotency key is a unique identifier you include with your API call. If the request fails or times out, you can safely retry it using the same key to avoid duplicate actions.  (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 200 </td><td> Success response for terminating an order. </td><td>  * x-api-version -  <br>  * x-ratelimit-limit -  <br>  * x-ratelimit-remaining -  <br>  * x-ratelimit-retry -  <br>  * x-ratelimit-type -  <br>  * x-request-id -  <br>  * x-idempotency-key -  <br>  * x-idempotency-replayed -  <br>  </td></tr>
        <tr><td> 400 </td><td> Bad request error. </td><td>  * x-api-version -  <br>  * x-ratelimit-limit -  <br>  * x-ratelimit-remaining -  <br>  * x-ratelimit-retry -  <br>  * x-ratelimit-type -  <br>  * x-request-id -  <br>  * x-idempotency-key -  <br>  * x-idempotency-replayed -  <br>  </td></tr>
        <tr><td> 401 </td><td> Authentication Error. </td><td>  * x-api-version -  <br>  * x-ratelimit-limit -  <br>  * x-ratelimit-remaining -  <br>  * x-ratelimit-retry -  <br>  * x-ratelimit-type -  <br>  * x-request-id -  <br>  * x-idempotency-key -  <br>  * x-idempotency-replayed -  <br>  </td></tr>
        <tr><td> 404 </td><td> Resource Not found. </td><td>  * x-api-version -  <br>  * x-ratelimit-limit -  <br>  * x-ratelimit-remaining -  <br>  * x-ratelimit-retry -  <br>  * x-ratelimit-type -  <br>  * x-request-id -  <br>  * x-idempotency-key -  <br>  * x-idempotency-replayed -  <br>  </td></tr>
        <tr><td> 409 </td><td> Resource already present. </td><td>  * x-api-version -  <br>  * x-ratelimit-limit -  <br>  * x-ratelimit-remaining -  <br>  * x-ratelimit-retry -  <br>  * x-ratelimit-type -  <br>  * x-request-id -  <br>  * x-idempotency-key -  <br>  * x-idempotency-replayed -  <br>  </td></tr>
    ...
    public ApiResponse<OrderEntity> PGTerminateOrder(String orderId, TerminateOrderRequest terminateOrderRequest, String xRequestId, UUID xIdempotencyKey, OkHttpClient httpClient) throws ApiException {
        String xApiVersion = this.XApiVersion;
        if(httpClient != null) {
            localVarApiClient.httpClient = httpClient;
        }
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 200 </td><td> Success response for updating order extended data. </td><td>  * x-api-version -  <br>  * x-ratelimit-limit -  <br>  * x-ratelimit-remaining -  <br>  * x-ratelimit-retry -  <br>  * x-ratelimit-type -  <br>  * x-request-id -  <br>  * x-idempotency-key -  <br>  * x-idempotency-replayed -  <br>  </td></tr>
        <tr><td> 400 </td><td> Bad request error. </td><td>  * x-api-version -  <br>  * x-ratelimit-limit -  <br>  * x-ratelimit-remaining -  <br>  * x-ratelimit-retry -  <br>  * x-ratelimit-type -  <br>  * x-request-id -  <br>  * x-idempotency-key -  <br>  * x-idempotency-replayed -  <br>  </td></tr>
        <tr><td> 401 </td><td> Authentication Error. </td><td>  * x-api-version -  <br>  * x-ratelimit-limit -  <br>  * x-ratelimit-remaining -  <br>  * x-ratelimit-retry -  <br>  * x-ratelimit-type -  <br>  * x-request-id -  <br>  * x-idempotency-key -  <br>  * x-idempotency-replayed -  <br>  </td></tr>
        <tr><td> 404 </td><td> Resource Not found. </td><td>  * x-api-version -  <br>  * x-ratelimit-limit -  <br>  * x-ratelimit-remaining -  <br>  * x-ratelimit-retry -  <br>  * x-ratelimit-type -  <br>  * x-request-id -  <br>  * x-idempotency-key -  <br>  * x-idempotency-replayed -  <br>  </td></tr>
        <tr><td> 409 </td><td> Resource already present. </td><td>  * x-api-version -  <br>  * x-ratelimit-limit -  <br>  * x-ratelimit-remaining -  <br>  * x-ratelimit-retry -  <br>  * x-ratelimit-type -  <br>  * x-request-id -  <br>  * x-idempotency-key -  <br>  * x-idempotency-replayed -  <br>  </td></tr>
    ...
    public ApiResponse<UpdateOrderExtendedDataEntity> PGUpdateOrderExtendedData(String orderId, UpdateOrderExtendedRequest updateOrderExtendedRequest, String xRequestId, UUID xIdempotencyKey, OkHttpClient httpClient) throws ApiException {
        String xApiVersion = this.XApiVersion;
        if(httpClient != null) {
            localVarApiClient.httpClient = httpClient;
        }
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 200 </td><td> Success response for cancelling a payment link. </td><td>  * x-api-version -  <br>  * x-ratelimit-limit -  <br>  * x-ratelimit-remaining -  <br>  * x-ratelimit-retry -  <br>  * x-ratelimit-type -  <br>  * x-request-id -  <br>  * x-idempotency-key -  <br>  * x-idempotency-replayed -  <br>  </td></tr>
        <tr><td> 400 </td><td> Bad request error. </td><td>  * x-api-version -  <br>  * x-ratelimit-limit -  <br>  * x-ratelimit-remaining -  <br>  * x-ratelimit-retry -  <br>  * x-ratelimit-type -  <br>  * x-request-id -  <br>  * x-idempotency-key -  <br>  * x-idempotency-replayed -  <br>  </td></tr>
        <tr><td> 401 </td><td> Authentication Error. </td><td>  * x-api-version -  <br>  * x-ratelimit-limit -  <br>  * x-ratelimit-remaining -  <br>  * x-ratelimit-retry -  <br>  * x-ratelimit-type -  <br>  * x-request-id -  <br>  * x-idempotency-key -  <br>  * x-idempotency-replayed -  <br>  </td></tr>
        <tr><td> 404 </td><td> Resource Not found. </td><td>  * x-api-version -  <br>  * x-ratelimit-limit -  <br>  * x-ratelimit-remaining -  <br>  * x-ratelimit-retry -  <br>  * x-ratelimit-type -  <br>  * x-request-id -  <br>  * x-idempotency-key -  <br>  * x-idempotency-replayed -  <br>  </td></tr>
        <tr><td> 409 </td><td> Resource already present. </td><td>  * x-api-version -  <br>  * x-ratelimit-limit -  <br>  * x-ratelimit-remaining -  <br>  * x-ratelimit-retry -  <br>  * x-ratelimit-type -  <br>  * x-request-id -  <br>  * x-idempotency-key -  <br>  * x-idempotency-replayed -  <br>  </td></tr>
    ...
    public ApiResponse<LinkEntity> PGCancelLink(String linkId, String xRequestId, UUID xIdempotencyKey, OkHttpClient httpClient) throws ApiException {
        String xApiVersion = this.XApiVersion;
        if(httpClient != null) {
            localVarApiClient.httpClient = httpClient;
        }
     ...
     * @param xApiVersion API version to be used. Format is in YYYY-MM-DD. (required)
     * @param createLinkRequest Request body to create payment links at Cashfree. (required)
     * @param xRequestId Request ID for the API call. Can be used to resolve tech issues. Communicate this in your tech related queries to Cashfree. (optional)
     * @param xIdempotencyKey An idempotency key is a unique identifier you include with your API call. If the request fails or times out, you can safely retry it using the same key to avoid duplicate actions.  (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 200 </td><td> Success response for creating a payment link. </td><td>  * x-api-version -  <br>  * x-ratelimit-limit -  <br>  * x-ratelimit-remaining -  <br>  * x-ratelimit-retry -  <br>  * x-ratelimit-type -  <br>  * x-request-id -  <br>  * x-idempotency-key -  <br>  * x-idempotency-replayed -  <br>  </td></tr>
        <tr><td> 400 </td><td> Bad request error. </td><td>  * x-api-version -  <br>  * x-ratelimit-limit -  <br>  * x-ratelimit-remaining -  <br>  * x-ratelimit-retry -  <br>  * x-ratelimit-type -  <br>  * x-request-id -  <br>  * x-idempotency-key -  <br>  * x-idempotency-replayed -  <br>  </td></tr>
        <tr><td> 401 </td><td> Authentication Error. </td><td>  * x-api-version -  <br>  * x-ratelimit-limit -  <br>  * x-ratelimit-remaining -  <br>  * x-ratelimit-retry -  <br>  * x-ratelimit-type -  <br>  * x-request-id -  <br>  * x-idempotency-key -  <br>  * x-idempotency-replayed -  <br>  </td></tr>
        <tr><td> 404 </td><td> Resource Not found. </td><td>  * x-api-version -  <br>  * x-ratelimit-limit -  <br>  * x-ratelimit-remaining -  <br>  * x-ratelimit-retry -  <br>  * x-ratelimit-type -  <br>  * x-request-id -  <br>  * x-idempotency-key -  <br>  * x-idempotency-replayed -  <br>  </td></tr>
        <tr><td> 409 </td><td> Resource already present. </td><td>  * x-api-version -  <br>  * x-ratelimit-limit -  <br>  * x-ratelimit-remaining -  <br>  * x-ratelimit-retry -  <br>  * x-ratelimit-type -  <br>  * x-request-id -  <br>  * x-idempotency-key -  <br>  * x-idempotency-replayed -  <br>  </td></tr>
    ...
    public ApiResponse<LinkEntity> PGCreateLink(CreateLinkRequest createLinkRequest, String xRequestId, UUID xIdempotencyKey, OkHttpClient httpClient) throws ApiException {
        String xApiVersion = this.XApiVersion;
        if(httpClient != null) {
            localVarApiClient.httpClient = httpClient;
        }
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 200 </td><td> Success response for fetching payment link details. </td><td>  * x-api-version -  <br>  * x-ratelimit-limit -  <br>  * x-ratelimit-remaining -  <br>  * x-ratelimit-retry -  <br>  * x-ratelimit-type -  <br>  * x-request-id -  <br>  * x-idempotency-key -  <br>  * x-idempotency-replayed -  <br>  </td></tr>
        <tr><td> 400 </td><td> Bad request error. </td><td>  * x-api-version -  <br>  * x-ratelimit-limit -  <br>  * x-ratelimit-remaining -  <br>  * x-ratelimit-retry -  <br>  * x-ratelimit-type -  <br>  * x-request-id -  <br>  * x-idempotency-key -  <br>  * x-idempotency-replayed -  <br>  </td></tr>
        <tr><td> 401 </td><td> Authentication Error. </td><td>  * x-api-version -  <br>  * x-ratelimit-limit -  <br>  * x-ratelimit-remaining -  <br>  * x-ratelimit-retry -  <br>  * x-ratelimit-type -  <br>  * x-request-id -  <br>  * x-idempotency-key -  <br>  * x-idempotency-replayed -  <br>  </td></tr>
        <tr><td> 404 </td><td> Resource Not found. </td><td>  * x-api-version -  <br>  * x-ratelimit-limit -  <br>  * x-ratelimit-remaining -  <br>  * x-ratelimit-retry -  <br>  * x-ratelimit-type -  <br>  * x-request-id -  <br>  * x-idempotency-key -  <br>  * x-idempotency-replayed -  <br>  </td></tr>
        <tr><td> 409 </td><td> Resource already present. </td><td>  * x-api-version -  <br>  * x-ratelimit-limit -  <br>  * x-ratelimit-remaining -  <br>  * x-ratelimit-retry -  <br>  * x-ratelimit-type -  <br>  * x-request-id -  <br>  * x-idempotency-key -  <br>  * x-idempotency-replayed -  <br>  </td></tr>
    ...
    public ApiResponse<LinkEntity> PGFetchLink(String linkId, String xRequestId, UUID xIdempotencyKey, OkHttpClient httpClient) throws ApiException {
        String xApiVersion = this.XApiVersion;
        if(httpClient != null) {
            localVarApiClient.httpClient = httpClient;
        }
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 200 </td><td> Success response for fetching orders for a payment link. </td><td>  * x-api-version -  <br>  * x-ratelimit-limit -  <br>  * x-ratelimit-remaining -  <br>  * x-ratelimit-retry -  <br>  * x-ratelimit-type -  <br>  * x-request-id -  <br>  * x-idempotency-key -  <br>  * x-idempotency-replayed -  <br>  </td></tr>
        <tr><td> 400 </td><td> Bad request error. </td><td>  * x-api-version -  <br>  * x-ratelimit-limit -  <br>  * x-ratelimit-remaining -  <br>  * x-ratelimit-retry -  <br>  * x-ratelimit-type -  <br>  * x-request-id -  <br>  * x-idempotency-key -  <br>  * x-idempotency-replayed -  <br>  </td></tr>
        <tr><td> 401 </td><td> Authentication Error. </td><td>  * x-api-version -  <br>  * x-ratelimit-limit -  <br>  * x-ratelimit-remaining -  <br>  * x-ratelimit-retry -  <br>  * x-ratelimit-type -  <br>  * x-request-id -  <br>  * x-idempotency-key -  <br>  * x-idempotency-replayed -  <br>  </td></tr>
        <tr><td> 404 </td><td> Resource Not found. </td><td>  * x-api-version -  <br>  * x-ratelimit-limit -  <br>  * x-ratelimit-remaining -  <br>  * x-ratelimit-retry -  <br>  * x-ratelimit-type -  <br>  * x-request-id -  <br>  * x-idempotency-key -  <br>  * x-idempotency-replayed -  <br>  </td></tr>
        <tr><td> 409 </td><td> Resource already present. </td><td>  * x-api-version -  <br>  * x-ratelimit-limit -  <br>  * x-ratelimit-remaining -  <br>  * x-ratelimit-retry -  <br>  * x-ratelimit-type -  <br>  * x-request-id -  <br>  * x-idempotency-key -  <br>  * x-idempotency-replayed -  <br>  </td></tr>
    ...
    public ApiResponse<List<PaymentLinkOrderEntity>> PGLinkFetchOrders(String linkId, String xRequestId, UUID xIdempotencyKey, String status, OkHttpClient httpClient) throws ApiException {
        String xApiVersion = this.XApiVersion;
        if(httpClient != null) {
            localVarApiClient.httpClient = httpClient;
        }
     ...
     * @param xApiVersion API version to be used. Format is in YYYY-MM-DD. (required)
     * @param orderId The ID which uniquely identifies your order. (required)
     * @param authorizeOrderRequest  (required)
     * @param xRequestId Request ID for the API call. Can be used to resolve tech issues. Communicate this in your tech related queries to Cashfree. (optional)
     * @param xIdempotencyKey An idempotency key is a unique identifier you include with your API call. If the request fails or times out, you can safely retry it using the same key to avoid duplicate actions.  (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 200 </td><td> Success response for preauthorisation. </td><td>  * x-api-version -  <br>  * x-ratelimit-limit -  <br>  * x-ratelimit-remaining -  <br>  * x-ratelimit-retry -  <br>  * x-ratelimit-type -  <br>  * x-request-id -  <br>  * x-idempotency-key -  <br>  * x-idempotency-replayed -  <br>  </td></tr>
        <tr><td> 400 </td><td> Bad request error. </td><td>  * x-api-version -  <br>  * x-ratelimit-limit -  <br>  * x-ratelimit-remaining -  <br>  * x-ratelimit-retry -  <br>  * x-ratelimit-type -  <br>  * x-request-id -  <br>  * x-idempotency-key -  <br>  * x-idempotency-replayed -  <br>  </td></tr>
        <tr><td> 401 </td><td> Authentication Error. </td><td>  * x-api-version -  <br>  * x-ratelimit-limit -  <br>  * x-ratelimit-remaining -  <br>  * x-ratelimit-retry -  <br>  * x-ratelimit-type -  <br>  * x-request-id -  <br>  * x-idempotency-key -  <br>  * x-idempotency-replayed -  <br>  </td></tr>
        <tr><td> 404 </td><td> Resource Not found. </td><td>  * x-api-version -  <br>  * x-ratelimit-limit -  <br>  * x-ratelimit-remaining -  <br>  * x-ratelimit-retry -  <br>  * x-ratelimit-type -  <br>  * x-request-id -  <br>  * x-idempotency-key -  <br>  * x-idempotency-replayed -  <br>  </td></tr>
        <tr><td> 409 </td><td> Resource already present. </td><td>  * x-api-version -  <br>  * x-ratelimit-limit -  <br>  * x-ratelimit-remaining -  <br>  * x-ratelimit-retry -  <br>  * x-ratelimit-type -  <br>  * x-request-id -  <br>  * x-idempotency-key -  <br>  * x-idempotency-replayed -  <br>  </td></tr>
    ...
    public ApiResponse<PaymentEntity> PGAuthorizeOrder(String orderId, AuthorizeOrderRequest authorizeOrderRequest, String xRequestId, UUID xIdempotencyKey, OkHttpClient httpClient) throws ApiException {
        String xApiVersion = this.XApiVersion;
        if(httpClient != null) {
            localVarApiClient.httpClient = httpClient;
        }
     ...
     * @param orderAuthenticatePaymentRequest Request body to submit or resend OTP in Native OTP flow. (required)
     * @param xRequestId Request ID for the API call. Can be used to resolve tech issues. Communicate this in your tech related queries to Cashfree. (optional)
     * @param xIdempotencyKey An idempotency key is a unique identifier you include with your API call. If the request fails or times out, you can safely retry it using the same key to avoid duplicate actions.  (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 200 </td><td> Success response for submitting or resending OTP. </td><td>  * x-api-version -  <br>  * x-ratelimit-limit -  <br>  * x-ratelimit-remaining -  <br>  * x-ratelimit-retry -  <br>  * x-ratelimit-type -  <br>  * x-request-id -  <br>  * x-idempotency-key -  <br>  * x-idempotency-replayed -  <br>  </td></tr>
        <tr><td> 400 </td><td> Bad request error. </td><td>  * x-api-version -  <br>  * x-ratelimit-limit -  <br>  * x-ratelimit-remaining -  <br>  * x-ratelimit-retry -  <br>  * x-ratelimit-type -  <br>  * x-request-id -  <br>  * x-idempotency-key -  <br>  * x-idempotency-replayed -  <br>  </td></tr>
        <tr><td> 401 </td><td> Authentication Error. </td><td>  * x-api-version -  <br>  * x-ratelimit-limit -  <br>  * x-ratelimit-remaining -  <br>  * x-ratelimit-retry -  <br>  * x-ratelimit-type -  <br>  * x-request-id -  <br>  * x-idempotency-key -  <br>  * x-idempotency-replayed -  <br>  </td></tr>
        <tr><td> 404 </td><td> Resource Not found. </td><td>  * x-api-version -  <br>  * x-ratelimit-limit -  <br>  * x-ratelimit-remaining -  <br>  * x-ratelimit-retry -  <br>  * x-ratelimit-type -  <br>  * x-request-id -  <br>  * x-idempotency-key -  <br>  * x-idempotency-replayed -  <br>  </td></tr>
        <tr><td> 409 </td><td> Resource already present. </td><td>  * x-api-version -  <br>  * x-ratelimit-limit -  <br>  * x-ratelimit-remaining -  <br>  * x-ratelimit-retry -  <br>  * x-ratelimit-type -  <br>  * x-request-id -  <br>  * x-idempotency-key -  <br>  * x-idempotency-replayed -  <br>  </td></tr>
    ...
    public ApiResponse<OrderAuthenticateEntity> PGOrderAuthenticatePayment(String cfPaymentId, OrderAuthenticatePaymentRequest orderAuthenticatePaymentRequest, String xRequestId, UUID xIdempotencyKey, OkHttpClient httpClient) throws ApiException {
        String xApiVersion = this.XApiVersion;
        if(httpClient != null) {
            localVarApiClient.httpClient = httpClient;
        }
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 200 </td><td> Success response for fetching payment by ID. </td><td>  * x-api-version -  <br>  * x-ratelimit-limit -  <br>  * x-ratelimit-remaining -  <br>  * x-ratelimit-retry -  <br>  * x-ratelimit-type -  <br>  * x-request-id -  <br>  * x-idempotency-key -  <br>  * x-idempotency-replayed -  <br>  </td></tr>
        <tr><td> 400 </td><td> Bad request error. </td><td>  * x-api-version -  <br>  * x-ratelimit-limit -  <br>  * x-ratelimit-remaining -  <br>  * x-ratelimit-retry -  <br>  * x-ratelimit-type -  <br>  * x-request-id -  <br>  * x-idempotency-key -  <br>  * x-idempotency-replayed -  <br>  </td></tr>
        <tr><td> 401 </td><td> Authentication Error. </td><td>  * x-api-version -  <br>  * x-ratelimit-limit -  <br>  * x-ratelimit-remaining -  <br>  * x-ratelimit-retry -  <br>  * x-ratelimit-type -  <br>  * x-request-id -  <br>  * x-idempotency-key -  <br>  * x-idempotency-replayed -  <br>  </td></tr>
        <tr><td> 404 </td><td> Resource Not found. </td><td>  * x-api-version -  <br>  * x-ratelimit-limit -  <br>  * x-ratelimit-remaining -  <br>  * x-ratelimit-retry -  <br>  * x-ratelimit-type -  <br>  * x-request-id -  <br>  * x-idempotency-key -  <br>  * x-idempotency-replayed -  <br>  </td></tr>
        <tr><td> 409 </td><td> Resource already present. </td><td>  * x-api-version -  <br>  * x-ratelimit-limit -  <br>  * x-ratelimit-remaining -  <br>  * x-ratelimit-retry -  <br>  * x-ratelimit-type -  <br>  * x-request-id -  <br>  * x-idempotency-key -  <br>  * x-idempotency-replayed -  <br>  </td></tr>
    ...
    public ApiResponse<PaymentEntity> PGOrderFetchPayment(String orderId, String cfPaymentId, String xRequestId, UUID xIdempotencyKey, OkHttpClient httpClient) throws ApiException {
        String xApiVersion = this.XApiVersion;
        if(httpClient != null) {
            localVarApiClient.httpClient = httpClient;
        }
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 200 </td><td> Success response for fetching payments for an order. </td><td>  * x-api-version -  <br>  * x-ratelimit-limit -  <br>  * x-ratelimit-remaining -  <br>  * x-ratelimit-retry -  <br>  * x-ratelimit-type -  <br>  * x-request-id -  <br>  * x-idempotency-key -  <br>  * x-idempotency-replayed -  <br>  </td></tr>
        <tr><td> 400 </td><td> Bad request error. </td><td>  * x-api-version -  <br>  * x-ratelimit-limit -  <br>  * x-ratelimit-remaining -  <br>  * x-ratelimit-retry -  <br>  * x-ratelimit-type -  <br>  * x-request-id -  <br>  * x-idempotency-key -  <br>  * x-idempotency-replayed -  <br>  </td></tr>
        <tr><td> 401 </td><td> Authentication Error. </td><td>  * x-api-version -  <br>  * x-ratelimit-limit -  <br>  * x-ratelimit-remaining -  <br>  * x-ratelimit-retry -  <br>  * x-ratelimit-type -  <br>  * x-request-id -  <br>  * x-idempotency-key -  <br>  * x-idempotency-replayed -  <br>  </td></tr>
        <tr><td> 404 </td><td> Resource Not found. </td><td>  * x-api-version -  <br>  * x-ratelimit-limit -  <br>  * x-ratelimit-remaining -  <br>  * x-ratelimit-retry -  <br>  * x-ratelimit-type -  <br>  * x-request-id -  <br>  * x-idempotency-key -  <br>  * x-idempotency-replayed -  <br>  </td></tr>
        <tr><td> 409 </td><td> Resource already present. </td><td>  * x-api-version -  <br>  * x-ratelimit-limit -  <br>  * x-ratelimit-remaining -  <br>  * x-ratelimit-retry -  <br>  * x-ratelimit-type -  <br>  * x-request-id -  <br>  * x-idempotency-key -  <br>  * x-idempotency-replayed -  <br>  </td></tr>
    ...
    public ApiResponse<List<PaymentEntity>> PGOrderFetchPayments(String orderId, String xRequestId, UUID xIdempotencyKey, OkHttpClient httpClient) throws ApiException {
        String xApiVersion = this.XApiVersion;
        if(httpClient != null) {
            localVarApiClient.httpClient = httpClient;
        }
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 200 </td><td> Success response for order pay. </td><td>  * x-api-version -  <br>  * x-ratelimit-limit -  <br>  * x-ratelimit-remaining -  <br>  * x-ratelimit-retry -  <br>  * x-ratelimit-type -  <br>  * x-request-id -  <br>  * x-idempotency-key -  <br>  * x-idempotency-replayed -  <br>  </td></tr>
        <tr><td> 400 </td><td> Bad request error. </td><td>  * x-api-version -  <br>  * x-ratelimit-limit -  <br>  * x-ratelimit-remaining -  <br>  * x-ratelimit-retry -  <br>  * x-ratelimit-type -  <br>  * x-request-id -  <br>  * x-idempotency-key -  <br>  * x-idempotency-replayed -  <br>  </td></tr>
        <tr><td> 401 </td><td> Authentication Error. </td><td>  * x-api-version -  <br>  * x-ratelimit-limit -  <br>  * x-ratelimit-remaining -  <br>  * x-ratelimit-retry -  <br>  * x-ratelimit-type -  <br>  * x-request-id -  <br>  * x-idempotency-key -  <br>  * x-idempotency-replayed -  <br>  </td></tr>
        <tr><td> 404 </td><td> Resource Not found. </td><td>  * x-api-version -  <br>  * x-ratelimit-limit -  <br>  * x-ratelimit-remaining -  <br>  * x-ratelimit-retry -  <br>  * x-ratelimit-type -  <br>  * x-request-id -  <br>  * x-idempotency-key -  <br>  * x-idempotency-replayed -  <br>  </td></tr>
        <tr><td> 409 </td><td> Resource already present. </td><td>  * x-api-version -  <br>  * x-ratelimit-limit -  <br>  * x-ratelimit-remaining -  <br>  * x-ratelimit-retry -  <br>  * x-ratelimit-type -  <br>  * x-request-id -  <br>  * x-idempotency-key -  <br>  * x-idempotency-replayed -  <br>  </td></tr>
     ...
     */
    public okhttp3.Call pGPayOrderCall(String xApiVersion, PayOrderRequest payOrderRequest, String xRequestId, UUID xIdempotencyKey, String xClientDevice, String xClientOs, String xClientRenderingType, String xClientBrowser, final ApiCallback _callback) throws ApiException {
        String basePath = "https://sandbox.cashfree.com/pg";
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call pGPayOrderValidateBeforeCall(String xApiVersion, PayOrderRequest payOrderRequest, String xRequestId, UUID xIdempotencyKey, String xClientDevice, String xClientOs, String xClientRenderingType, String xClientBrowser, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'xApiVersion' is set
        if (xApiVersion == null) {
        ...
        return pGPayOrderCall(xApiVersion, payOrderRequest, xRequestId, xIdempotencyKey, xClientDevice, xClientOs, xClientRenderingType, xClientBrowser, _callback);

    }

    public ApiResponse<PayOrderEntity> PGPayOrder(PayOrderRequest payOrderRequest, String xRequestId, UUID xIdempotencyKey, String xClientDevice, String xClientOs, String xClientRenderingType, String xClientBrowser, OkHttpClient httpClient) throws ApiException {
        String xApiVersion = this.XApiVersion;
        if(httpClient != null) {
            localVarApiClient.httpClient = httpClient;
        }
        okhttp3.Call localVarCall = pGPayOrderValidateBeforeCall(xApiVersion, payOrderRequest, xRequestId, xIdempotencyKey, xClientDevice, xClientOs, xClientRenderingType, xClientBrowser, null);
    ...
    /**
     * Build call for pGPayOrderAuthorizeOnly
     * @param xApiVersion API version to be used. Format is in YYYY-MM-DD. (required)
     * @param payOrderAuthorizeOnlyRequest Request body to create an authorization only transaction at cashfree using &#x60;payment_session_id&#x60;. (required)
     * @param xRequestId Request ID for the API call. Can be used to resolve tech issues. Communicate this in your tech related queries to Cashfree. (optional)
     * @param xIdempotencyKey An idempotency key is a unique identifier you include with your API call. If the request fails or times out, you can safely retry it using the same key to avoid duplicate actions.  (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     ...
     */
    public okhttp3.Call pGPayOrderAuthorizeOnlyCall(String xApiVersion, PayOrderAuthorizeOnlyRequest payOrderAuthorizeOnlyRequest, String xRequestId, UUID xIdempotencyKey, final ApiCallback _callback) throws ApiException {
        String basePath = "https://sandbox.cashfree.com/pg";
        ...
        Object localVarPostBody = payOrderAuthorizeOnlyRequest;

        // create path and map variables
        String localVarPath = "/orders/sessions/authorize";
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call pGPayOrderAuthorizeOnlyValidateBeforeCall(String xApiVersion, PayOrderAuthorizeOnlyRequest payOrderAuthorizeOnlyRequest, String xRequestId, UUID xIdempotencyKey, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'xApiVersion' is set
        if (xApiVersion == null) {
            throw new ApiException("Missing the required parameter 'xApiVersion' when calling PGPayOrderAuthorizeOnly(Async)");
        }

        // verify the required parameter 'payOrderAuthorizeOnlyRequest' is set
        if (payOrderAuthorizeOnlyRequest == null) {
            throw new ApiException("Missing the required parameter 'payOrderAuthorizeOnlyRequest' when calling PGPayOrderAuthorizeOnly(Async)");
        }

        return pGPayOrderAuthorizeOnlyCall(xApiVersion, payOrderAuthorizeOnlyRequest, xRequestId, xIdempotencyKey, _callback);

    }

    public ApiResponse<PaymentEntity> PGPayOrderAuthorizeOnly(PayOrderAuthorizeOnlyRequest payOrderAuthorizeOnlyRequest, String xRequestId, UUID xIdempotencyKey, OkHttpClient httpClient) throws ApiException {
        String xApiVersion = this.XApiVersion;
        if(httpClient != null) {
            localVarApiClient.httpClient = httpClient;
        }
        okhttp3.Call localVarCall = pGPayOrderAuthorizeOnlyValidateBeforeCall(xApiVersion, payOrderAuthorizeOnlyRequest, xRequestId, xIdempotencyKey, null);
        Type localVarReturnType = new TypeToken<PaymentEntity>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
    ...
    public ApiResponse<ReconEntity> PGFetchRecon(FetchReconRequest fetchReconRequest, String contentType, String xRequestId, UUID xIdempotencyKey, String accept, OkHttpClient httpClient) throws ApiException {
        String xApiVersion = this.XApiVersion;
        if(httpClient != null) {
            localVarApiClient.httpClient = httpClient;
        }
    ...
    /**
     * Build call for pGESReconVendor
     * @param xApiVersion API version to be used. Format is in YYYY-MM-DD. (required)
     * @param vendorReconRequest Vendor Recon Request body. (required)
     * @param xRequestId Request ID for the API call. Can be used to resolve tech issues. Communicate this in your tech related queries to Cashfree. (optional)
     * @param xIdempotencyKey An idempotency key is a unique identifier you include with your API call. If the request fails or times out, you can safely retry it using the same key to avoid duplicate actions.  (optional)
     * @param contentType application/json. (optional)
     * @param _callback Callback for upload/download progress
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 200 </td><td> Terminal created. </td><td>  -  </td></tr>
        <tr><td> 400 </td><td> Vendor Recon Failure Response. </td><td>  -  </td></tr>
     </table>
     */
    public okhttp3.Call pGESReconVendorCall(String xApiVersion, VendorReconRequest vendorReconRequest, String xRequestId, UUID xIdempotencyKey, String contentType, final ApiCallback _callback) throws ApiException {
        String basePath = "https://sandbox.cashfree.com/pg";
        ...
        Object localVarPostBody = vendorReconRequest;

        // create path and map variables
        String localVarPath = "/recon/vendor";
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call pGESReconVendorValidateBeforeCall(String xApiVersion, VendorReconRequest vendorReconRequest, String xRequestId, UUID xIdempotencyKey, String contentType, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'xApiVersion' is set
        if (xApiVersion == null) {
            throw new ApiException("Missing the required parameter 'xApiVersion' when calling PGESReconVendor(Async)");
        }

        // verify the required parameter 'vendorReconRequest' is set
        if (vendorReconRequest == null) {
            throw new ApiException("Missing the required parameter 'vendorReconRequest' when calling PGESReconVendor(Async)");
        }

        return pGESReconVendorCall(xApiVersion, vendorReconRequest, xRequestId, xIdempotencyKey, contentType, _callback);

    }

    public ApiResponse<VendorRecon200Response> PGESReconVendor(VendorReconRequest vendorReconRequest, String xRequestId, UUID xIdempotencyKey, String contentType, OkHttpClient httpClient) throws ApiException {
        String xApiVersion = this.XApiVersion;
        if(httpClient != null) {
            localVarApiClient.httpClient = httpClient;
        }
        okhttp3.Call localVarCall = pGESReconVendorValidateBeforeCall(xApiVersion, vendorReconRequest, xRequestId, xIdempotencyKey, contentType, null);
        Type localVarReturnType = new TypeToken<VendorRecon200Response>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
    ...
    public ApiResponse<RefundEntity> PGOrderCreateRefund(String orderId, OrderCreateRefundRequest orderCreateRefundRequest, String xRequestId, UUID xIdempotencyKey, OkHttpClient httpClient) throws ApiException {
        String xApiVersion = this.XApiVersion;
        if(httpClient != null) {
            localVarApiClient.httpClient = httpClient;
        }
    ...
    public ApiResponse<RefundEntity> PGOrderFetchRefund(String orderId, String refundId, String xRequestId, UUID xIdempotencyKey, OkHttpClient httpClient) throws ApiException {
        String xApiVersion = this.XApiVersion;
        if(httpClient != null) {
            localVarApiClient.httpClient = httpClient;
        }
    ...
    public ApiResponse<List<RefundEntity>> PGOrderFetchRefunds(String orderId, String xRequestId, UUID xIdempotencyKey, OkHttpClient httpClient) throws ApiException {
        String xApiVersion = this.XApiVersion;
        if(httpClient != null) {
            localVarApiClient.httpClient = httpClient;
        }
    ...
    /**
     * Build call for pGOrderUpdateRefund
     * @param xApiVersion API version to be used. Format is in YYYY-MM-DD. (required)
     * @param orderId The ID which uniquely identifies your order. (required)
     * @param refundId Refund Id of the refund you want to update. (required)
     * @param orderUpdateRefundRequest Request Body to Update Refunds. (required)
     * @param xRequestId Request ID for the API call. Can be used to resolve tech issues. Communicate this in your tech related queries to Cashfree. (optional)
     * @param xIdempotencyKey An idempotency key is a unique identifier you include with your API call. If the request fails or times out, you can safely retry it using the same key to avoid duplicate actions.  (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 200 </td><td> Refund updated. </td><td>  * x-api-version -  <br>  * x-ratelimit-limit -  <br>  * x-ratelimit-remaining -  <br>  * x-ratelimit-retry -  <br>  * x-ratelimit-type -  <br>  * x-request-id -  <br>  * x-idempotency-key -  <br>  * x-idempotency-replayed -  <br>  </td></tr>
        <tr><td> 400 </td><td> Bad request error. </td><td>  * x-api-version -  <br>  * x-ratelimit-limit -  <br>  * x-ratelimit-remaining -  <br>  * x-ratelimit-retry -  <br>  * x-ratelimit-type -  <br>  * x-request-id -  <br>  * x-idempotency-key -  <br>  * x-idempotency-replayed -  <br>  </td></tr>
        <tr><td> 401 </td><td> Authentication Error. </td><td>  * x-api-version -  <br>  * x-ratelimit-limit -  <br>  * x-ratelimit-remaining -  <br>  * x-ratelimit-retry -  <br>  * x-ratelimit-type -  <br>  * x-request-id -  <br>  * x-idempotency-key -  <br>  * x-idempotency-replayed -  <br>  </td></tr>
        <tr><td> 404 </td><td> Resource Not found. </td><td>  * x-api-version -  <br>  * x-ratelimit-limit -  <br>  * x-ratelimit-remaining -  <br>  * x-ratelimit-retry -  <br>  * x-ratelimit-type -  <br>  * x-request-id -  <br>  * x-idempotency-key -  <br>  * x-idempotency-replayed -  <br>  </td></tr>
        <tr><td> 409 </td><td> Resource already present. </td><td>  * x-api-version -  <br>  * x-ratelimit-limit -  <br>  * x-ratelimit-remaining -  <br>  * x-ratelimit-retry -  <br>  * x-ratelimit-type -  <br>  * x-request-id -  <br>  * x-idempotency-key -  <br>  * x-idempotency-replayed -  <br>  </td></tr>
     ...
     */
    public okhttp3.Call pGOrderUpdateRefundCall(String xApiVersion, String orderId, String refundId, OrderUpdateRefundRequest orderUpdateRefundRequest, String xRequestId, UUID xIdempotencyKey, final ApiCallback _callback) throws ApiException {
        String basePath = "https://sandbox.cashfree.com/pg";
        ...
        Object localVarPostBody = orderUpdateRefundRequest;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call pGOrderUpdateRefundValidateBeforeCall(String xApiVersion, String orderId, String refundId, OrderUpdateRefundRequest orderUpdateRefundRequest, String xRequestId, UUID xIdempotencyKey, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'xApiVersion' is set
        if (xApiVersion == null) {
            throw new ApiException("Missing the required parameter 'xApiVersion' when calling PGOrderUpdateRefund(Async)");
        }

        // verify the required parameter 'orderId' is set
        if (orderId == null) {
            throw new ApiException("Missing the required parameter 'orderId' when calling PGOrderUpdateRefund(Async)");
        }

        // verify the required parameter 'refundId' is set
        if (refundId == null) {
            throw new ApiException("Missing the required parameter 'refundId' when calling PGOrderUpdateRefund(Async)");
        }

        // verify the required parameter 'orderUpdateRefundRequest' is set
        if (orderUpdateRefundRequest == null) {
            throw new ApiException("Missing the required parameter 'orderUpdateRefundRequest' when calling PGOrderUpdateRefund(Async)");
        }

        return pGOrderUpdateRefundCall(xApiVersion, orderId, refundId, orderUpdateRefundRequest, xRequestId, xIdempotencyKey, _callback);

    }

    public ApiResponse<RefundEntity> PGOrderUpdateRefund(String orderId, String refundId, OrderUpdateRefundRequest orderUpdateRefundRequest, String xRequestId, UUID xIdempotencyKey, OkHttpClient httpClient) throws ApiException {
        String xApiVersion = this.XApiVersion;
        if(httpClient != null) {
            localVarApiClient.httpClient = httpClient;
        }
        okhttp3.Call localVarCall = pGOrderUpdateRefundValidateBeforeCall(xApiVersion, orderId, refundId, orderUpdateRefundRequest, xRequestId, xIdempotencyKey, null);
        Type localVarReturnType = new TypeToken<RefundEntity>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
    ...
    public ApiResponse<SettlementEntity> PGFetchSettlements(FetchSettlementsRequest fetchSettlementsRequest, String contentType, String xRequestId, UUID xIdempotencyKey, String accept, OkHttpClient httpClient) throws ApiException {
        String xApiVersion = this.XApiVersion;
        if(httpClient != null) {
            localVarApiClient.httpClient = httpClient;
        }
    ...
    public ApiResponse<SettlementReconEntity> PGSettlementFetchRecon(SettlementFetchReconRequest settlementFetchReconRequest, String contentType, String xRequestId, UUID xIdempotencyKey, String accept, OkHttpClient httpClient) throws ApiException {
        String xApiVersion = this.XApiVersion;
        if(httpClient != null) {
            localVarApiClient.httpClient = httpClient;
        }
    ...
    public ApiResponse<Object> MarkForSettlement(String xRequestId, UUID xIdempotencyKey, CreateOrderSettlementRequestBody createOrderSettlementRequestBody, OkHttpClient httpClient) throws ApiException {
        String xApiVersion = this.XApiVersion;
        if(httpClient != null) {
            localVarApiClient.httpClient = httpClient;
        }
    ...
    public ApiResponse<SettlementEntity> PGOrderFetchSettlement(String orderId, String xRequestId, UUID xIdempotencyKey, OkHttpClient httpClient) throws ApiException {
        String xApiVersion = this.XApiVersion;
        if(httpClient != null) {
            localVarApiClient.httpClient = httpClient;
        }
    ...
    /**
     * Build call for pGFetchSettlementSimulation
     * @param xApiVersion API version to be used. Format is in YYYY-MM-DD. (required)
     ...
     */
    public okhttp3.Call pGFetchSettlementSimulationCall(String xApiVersion, String simulationId, String xRequestId, UUID xIdempotencyKey, final ApiCallback _callback) throws ApiException {
        String basePath = "https://sandbox.cashfree.com/pg";
        ...
        // create path and map variables
        String localVarPath = "/simulate/settlement/{simulation_id}"
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call pGFetchSettlementSimulationValidateBeforeCall(String xApiVersion, String simulationId, String xRequestId, UUID xIdempotencyKey, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'xApiVersion' is set
        if (xApiVersion == null) {
            throw new ApiException("Missing the required parameter 'xApiVersion' when calling PGFetchSettlementSimulation(Async)");
        }

        // verify the required parameter 'simulationId' is set
        if (simulationId == null) {
            throw new ApiException("Missing the required parameter 'simulationId' when calling PGFetchSettlementSimulation(Async)");
        }

        return pGFetchSettlementSimulationCall(xApiVersion, simulationId, xRequestId, xIdempotencyKey, _callback);

    }

    public ApiResponse<SettlementSimulationResponse> PGFetchSettlementSimulation(String simulationId, String xRequestId, UUID xIdempotencyKey, OkHttpClient httpClient) throws ApiException {
        String xApiVersion = this.XApiVersion;
        if(httpClient != null) {
            localVarApiClient.httpClient = httpClient;
        }
        okhttp3.Call localVarCall = pGFetchSettlementSimulationValidateBeforeCall(xApiVersion, simulationId, xRequestId, xIdempotencyKey, null);
        Type localVarReturnType = new TypeToken<SettlementSimulationResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
    ...
    public ApiResponse<SimulationResponse> PGFetchSimulation(String simulationId, String xRequestId, UUID xIdempotencyKey, OkHttpClient httpClient) throws ApiException {
        String xApiVersion = this.XApiVersion;
        if(httpClient != null) {
            localVarApiClient.httpClient = httpClient;
        }
     ...
     * @param xApiVersion API version to be used. Format is in YYYY-MM-DD. (required)
     * @param simulateRequest Request body for simulation. (required)
     * @param xRequestId Request ID for the API call. Can be used to resolve tech issues. Communicate this in your tech related queries to Cashfree. (optional)
     * @param xIdempotencyKey An idempotency key is a unique identifier you include with your API call. If the request fails or times out, you can safely retry it using the same key to avoid duplicate actions.  (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 200 </td><td> Payment simulation response. </td><td>  * x-api-version -  <br>  * x-ratelimit-limit -  <br>  * x-ratelimit-remaining -  <br>  * x-ratelimit-retry -  <br>  * x-ratelimit-type -  <br>  * x-request-id -  <br>  </td></tr>
        <tr><td> 400 </td><td> Bad request error. </td><td>  * x-api-version -  <br>  * x-ratelimit-limit -  <br>  * x-ratelimit-remaining -  <br>  * x-ratelimit-retry -  <br>  * x-ratelimit-type -  <br>  * x-request-id -  <br>  * x-idempotency-key -  <br>  * x-idempotency-replayed -  <br>  </td></tr>
        <tr><td> 401 </td><td> Authentication Error. </td><td>  * x-api-version -  <br>  * x-ratelimit-limit -  <br>  * x-ratelimit-remaining -  <br>  * x-ratelimit-retry -  <br>  * x-ratelimit-type -  <br>  * x-request-id -  <br>  * x-idempotency-key -  <br>  * x-idempotency-replayed -  <br>  </td></tr>
        <tr><td> 404 </td><td> Resource Not found. </td><td>  * x-api-version -  <br>  * x-ratelimit-limit -  <br>  * x-ratelimit-remaining -  <br>  * x-ratelimit-retry -  <br>  * x-ratelimit-type -  <br>  * x-request-id -  <br>  * x-idempotency-key -  <br>  * x-idempotency-replayed -  <br>  </td></tr>
        <tr><td> 429 </td><td> Rate Limit Error. </td><td>  * x-api-version -  <br>  * x-ratelimit-limit -  <br>  * x-ratelimit-remaining -  <br>  * x-ratelimit-retry -  <br>  * x-ratelimit-type -  <br>  * x-request-id -  <br>  * x-idempotency-key -  <br>  * x-idempotency-replayed -  <br>  </td></tr>
    ...
    public ApiResponse<SimulationResponse> PGSimulatePayment(SimulateRequest simulateRequest, String xRequestId, UUID xIdempotencyKey, OkHttpClient httpClient) throws ApiException {
        String xApiVersion = this.XApiVersion;
        if(httpClient != null) {
            localVarApiClient.httpClient = httpClient;
        }
    ...
    /**
     * Build call for pGSimulateSettlement
     * @param xApiVersion API version to be used. Format is in YYYY-MM-DD. (required)
     * @param simulateSettlementRequest The request body for simulating a settlement. (required)
     * @param xRequestId Request ID for the API call. Can be used to resolve tech issues. Communicate this in your tech related queries to Cashfree. (optional)
     * @param xIdempotencyKey An idempotency key is a unique identifier you include with your API call. If the request fails or times out, you can safely retry it using the same key to avoid duplicate actions.  (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 200 </td><td> Settlement simulation response. </td><td>  * x-api-version -  <br>  * x-ratelimit-limit -  <br>  * x-ratelimit-remaining -  <br>  * x-ratelimit-retry -  <br>  * x-ratelimit-type -  <br>  * x-request-id -  <br>  </td></tr>
        <tr><td> 400 </td><td> Bad request error. </td><td>  * x-api-version -  <br>  * x-ratelimit-limit -  <br>  * x-ratelimit-remaining -  <br>  * x-ratelimit-retry -  <br>  * x-ratelimit-type -  <br>  * x-request-id -  <br>  * x-idempotency-key -  <br>  * x-idempotency-replayed -  <br>  </td></tr>
        <tr><td> 401 </td><td> Authentication Error. </td><td>  * x-api-version -  <br>  * x-ratelimit-limit -  <br>  * x-ratelimit-remaining -  <br>  * x-ratelimit-retry -  <br>  * x-ratelimit-type -  <br>  * x-request-id -  <br>  * x-idempotency-key -  <br>  * x-idempotency-replayed -  <br>  </td></tr>
        <tr><td> 404 </td><td> Resource Not found. </td><td>  * x-api-version -  <br>  * x-ratelimit-limit -  <br>  * x-ratelimit-remaining -  <br>  * x-ratelimit-retry -  <br>  * x-ratelimit-type -  <br>  * x-request-id -  <br>  * x-idempotency-key -  <br>  * x-idempotency-replayed -  <br>  </td></tr>
        <tr><td> 429 </td><td> Rate Limit Error. </td><td>  * x-api-version -  <br>  * x-ratelimit-limit -  <br>  * x-ratelimit-remaining -  <br>  * x-ratelimit-retry -  <br>  * x-ratelimit-type -  <br>  * x-request-id -  <br>  * x-idempotency-key -  <br>  * x-idempotency-replayed -  <br>  </td></tr>
     ...
     */
    public okhttp3.Call pGSimulateSettlementCall(String xApiVersion, SimulateSettlementRequest simulateSettlementRequest, String xRequestId, UUID xIdempotencyKey, final ApiCallback _callback) throws ApiException {
        String basePath = "https://sandbox.cashfree.com/pg";
        ...
        Object localVarPostBody = simulateSettlementRequest;

        // create path and map variables
        String localVarPath = "/simulate/settlement";
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call pGSimulateSettlementValidateBeforeCall(String xApiVersion, SimulateSettlementRequest simulateSettlementRequest, String xRequestId, UUID xIdempotencyKey, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'xApiVersion' is set
        if (xApiVersion == null) {
            throw new ApiException("Missing the required parameter 'xApiVersion' when calling PGSimulateSettlement(Async)");
        }

        // verify the required parameter 'simulateSettlementRequest' is set
        if (simulateSettlementRequest == null) {
            throw new ApiException("Missing the required parameter 'simulateSettlementRequest' when calling PGSimulateSettlement(Async)");
        }

        return pGSimulateSettlementCall(xApiVersion, simulateSettlementRequest, xRequestId, xIdempotencyKey, _callback);

    }

    public ApiResponse<SettlementSimulationResponse> PGSimulateSettlement(SimulateSettlementRequest simulateSettlementRequest, String xRequestId, UUID xIdempotencyKey, OkHttpClient httpClient) throws ApiException {
        String xApiVersion = this.XApiVersion;
        if(httpClient != null) {
            localVarApiClient.httpClient = httpClient;
        }
        okhttp3.Call localVarCall = pGSimulateSettlementValidateBeforeCall(xApiVersion, simulateSettlementRequest, xRequestId, xIdempotencyKey, null);
        Type localVarReturnType = new TypeToken<SettlementSimulationResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
    ...
    public ApiResponse<TerminalEntity> SposCreateTerminal(CreateTerminalRequest createTerminalRequest, String xRequestId, UUID xIdempotencyKey, OkHttpClient httpClient) throws ApiException {
        String xApiVersion = this.XApiVersion;
        if(httpClient != null) {
            localVarApiClient.httpClient = httpClient;
        }
    ...
    public ApiResponse<TerminalTransactionEntity> SposCreateTerminalTransaction(CreateTerminalTransactionRequest createTerminalTransactionRequest, String xRequestId, UUID xIdempotencyKey, OkHttpClient httpClient) throws ApiException {
        String xApiVersion = this.XApiVersion;
        if(httpClient != null) {
            localVarApiClient.httpClient = httpClient;
        }
    ...
    public ApiResponse<List<SoundboxVpaEntity>> SposDemapSoundboxVpa(DemapSoundboxVpaRequest demapSoundboxVpaRequest, String xRequestId, UUID xIdempotencyKey, OkHttpClient httpClient) throws ApiException {
        String xApiVersion = this.XApiVersion;
        if(httpClient != null) {
            localVarApiClient.httpClient = httpClient;
        }
    ...
    public ApiResponse<TerminalEntity> SposFetchTerminal(String terminalPhoneNo, String xRequestId, UUID xIdempotencyKey, OkHttpClient httpClient) throws ApiException {
        String xApiVersion = this.XApiVersion;
        if(httpClient != null) {
            localVarApiClient.httpClient = httpClient;
        }
     ...
     * @param cfTerminalId Cashfree terminal id for which you want to get static QRs. Required if you are not providing the terminal_phone_number in the request. (required)
     * @param xRequestId Request ID for the API call. Can be used to resolve tech issues. Communicate this in your tech related queries to Cashfree. (optional)
     * @param xIdempotencyKey An idempotency key is a unique identifier you include with your API call. If the request fails or times out, you can safely retry it using the same key to avoid duplicate actions.  (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     ...
     */
    public okhttp3.Call sposFetchTerminalQRCodesCall(String xApiVersion, String terminalPhoneNo, Integer cfTerminalId, String xRequestId, UUID xIdempotencyKey, final ApiCallback _callback) throws ApiException {
        String basePath = "https://sandbox.cashfree.com/pg";
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call sposFetchTerminalQRCodesValidateBeforeCall(String xApiVersion, String terminalPhoneNo, Integer cfTerminalId, String xRequestId, UUID xIdempotencyKey, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'xApiVersion' is set
        if (xApiVersion == null) {
    ...
    public ApiResponse<List<FetchTerminalQRCodesEntity>> SposFetchTerminalQRCodes(String terminalPhoneNo, Integer cfTerminalId, String xRequestId, UUID xIdempotencyKey, OkHttpClient httpClient) throws ApiException {
        String xApiVersion = this.XApiVersion;
        if(httpClient != null) {
            localVarApiClient.httpClient = httpClient;
        }
     ...
     */
    public okhttp3.Call sposFetchTerminalSoundboxVpaCall(String xApiVersion, String deviceSerialNo, Integer cfTerminalId, String xRequestId, UUID xIdempotencyKey, final ApiCallback _callback) throws ApiException {
        String basePath = "https://sandbox.cashfree.com/pg";
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call sposFetchTerminalSoundboxVpaValidateBeforeCall(String xApiVersion, String deviceSerialNo, Integer cfTerminalId, String xRequestId, UUID xIdempotencyKey, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'xApiVersion' is set
        if (xApiVersion == null) {
    ...
    public ApiResponse<List<SoundboxVpaEntity>> SposFetchTerminalSoundboxVpa(String deviceSerialNo, Integer cfTerminalId, String xRequestId, UUID xIdempotencyKey, OkHttpClient httpClient) throws ApiException {
        String xApiVersion = this.XApiVersion;
        if(httpClient != null) {
            localVarApiClient.httpClient = httpClient;
        }
     ...
     */
    public okhttp3.Call sposFetchTerminalTransactionCall(String xApiVersion, String utr, Integer cfTerminalId, String xRequestId, UUID xIdempotencyKey, final ApiCallback _callback) throws ApiException {
        String basePath = "https://sandbox.cashfree.com/pg";
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call sposFetchTerminalTransactionValidateBeforeCall(String xApiVersion, String utr, Integer cfTerminalId, String xRequestId, UUID xIdempotencyKey, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'xApiVersion' is set
        if (xApiVersion == null) {
    ...
    public ApiResponse<TerminalPaymentEntity> SposFetchTerminalTransaction(String utr, Integer cfTerminalId, String xRequestId, UUID xIdempotencyKey, OkHttpClient httpClient) throws ApiException {
        String xApiVersion = this.XApiVersion;
        if(httpClient != null) {
            localVarApiClient.httpClient = httpClient;
        }
    ...
    /**
     * Build call for sposFetchTerminalTransactions
     * @param xApiVersion API version to be used. Format is in YYYY-MM-DD. (required)
     * @param xRequestId Request ID for the API call. Can be used to resolve tech issues. Communicate this in your tech related queries to Cashfree. (optional)
     * @param xIdempotencyKey An idempotency key is a unique identifier you include with your API call. If the request fails or times out, you can safely retry it using the same key to avoid duplicate actions.  (optional)
     * @param getAllTerminalTransactionRequest Request body for retrieving terminal payment transactions. Include filtering and pagination options to customise the results. (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 200 </td><td> Success response for retrieving terminal payment transactions. </td><td>  * x-api-version -  <br>  * x-ratelimit-limit -  <br>  * x-ratelimit-remaining -  <br>  * x-ratelimit-retry -  <br>  * x-ratelimit-type -  <br>  * x-request-id -  <br>  * x-idempotency-key -  <br>  * x-idempotency-replayed -  <br>  </td></tr>
        <tr><td> 400 </td><td> Bad request error. </td><td>  * x-api-version -  <br>  * x-ratelimit-limit -  <br>  * x-ratelimit-remaining -  <br>  * x-ratelimit-retry -  <br>  * x-ratelimit-type -  <br>  * x-request-id -  <br>  * x-idempotency-key -  <br>  * x-idempotency-replayed -  <br>  </td></tr>
        <tr><td> 401 </td><td> Authentication Error. </td><td>  * x-api-version -  <br>  * x-ratelimit-limit -  <br>  * x-ratelimit-remaining -  <br>  * x-ratelimit-retry -  <br>  * x-ratelimit-type -  <br>  * x-request-id -  <br>  * x-idempotency-key -  <br>  * x-idempotency-replayed -  <br>  </td></tr>
        <tr><td> 404 </td><td> Resource Not found. </td><td>  * x-api-version -  <br>  * x-ratelimit-limit -  <br>  * x-ratelimit-remaining -  <br>  * x-ratelimit-retry -  <br>  * x-ratelimit-type -  <br>  * x-request-id -  <br>  * x-idempotency-key -  <br>  * x-idempotency-replayed -  <br>  </td></tr>
        <tr><td> 409 </td><td> Resource already present. </td><td>  * x-api-version -  <br>  * x-ratelimit-limit -  <br>  * x-ratelimit-remaining -  <br>  * x-ratelimit-retry -  <br>  * x-ratelimit-type -  <br>  * x-request-id -  <br>  * x-idempotency-key -  <br>  * x-idempotency-replayed -  <br>  </td></tr>
     ...
     */
    public okhttp3.Call sposFetchTerminalTransactionsCall(String xApiVersion, String xRequestId, UUID xIdempotencyKey, GetAllTerminalTransactionRequest getAllTerminalTransactionRequest, final ApiCallback _callback) throws ApiException {
        String basePath = "https://sandbox.cashfree.com/pg";
        ...
        Object localVarPostBody = getAllTerminalTransactionRequest;

        // create path and map variables
        String localVarPath = "/terminal/payments";
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call sposFetchTerminalTransactionsValidateBeforeCall(String xApiVersion, String xRequestId, UUID xIdempotencyKey, GetAllTerminalTransactionRequest getAllTerminalTransactionRequest, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'xApiVersion' is set
        if (xApiVersion == null) {
            throw new ApiException("Missing the required parameter 'xApiVersion' when calling SposFetchTerminalTransactions(Async)");
        }

        return sposFetchTerminalTransactionsCall(xApiVersion, xRequestId, xIdempotencyKey, getAllTerminalTransactionRequest, _callback);

    }

    public ApiResponse<List<GetAllTerminalPaymentEntity>> SposFetchTerminalTransactions(String xRequestId, UUID xIdempotencyKey, GetAllTerminalTransactionRequest getAllTerminalTransactionRequest, OkHttpClient httpClient) throws ApiException {
        String xApiVersion = this.XApiVersion;
        if(httpClient != null) {
            localVarApiClient.httpClient = httpClient;
        }
        okhttp3.Call localVarCall = sposFetchTerminalTransactionsValidateBeforeCall(xApiVersion, xRequestId, xIdempotencyKey, getAllTerminalTransactionRequest, null);
        Type localVarReturnType = new TypeToken<List<GetAllTerminalPaymentEntity>>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
    ...
    public ApiResponse<SoundboxVpaEntity> SposOnboardSoundboxVpa(OnboardSoundboxVpaRequest onboardSoundboxVpaRequest, String xRequestId, UUID xIdempotencyKey, OkHttpClient httpClient) throws ApiException {
        String xApiVersion = this.XApiVersion;
        if(httpClient != null) {
            localVarApiClient.httpClient = httpClient;
        }
     ...
     */
    public okhttp3.Call sposUpdateSoundboxVpaCall(String xApiVersion, Integer cfTerminalId, UpdateSoundboxVpaRequest updateSoundboxVpaRequest, String xRequestId, UUID xIdempotencyKey, final ApiCallback _callback) throws ApiException {
        String basePath = "https://sandbox.cashfree.com/pg";
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call sposUpdateSoundboxVpaValidateBeforeCall(String xApiVersion, Integer cfTerminalId, UpdateSoundboxVpaRequest updateSoundboxVpaRequest, String xRequestId, UUID xIdempotencyKey, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'xApiVersion' is set
        if (xApiVersion == null) {
    ...
    public ApiResponse<SoundboxVpaEntity> SposUpdateSoundboxVpa(Integer cfTerminalId, UpdateSoundboxVpaRequest updateSoundboxVpaRequest, String xRequestId, UUID xIdempotencyKey, OkHttpClient httpClient) throws ApiException {
        String xApiVersion = this.XApiVersion;
        if(httpClient != null) {
            localVarApiClient.httpClient = httpClient;
        }
     ...
     */
    public okhttp3.Call sposUpdateTerminalCall(String xApiVersion, Integer cfTerminalId, UpdateTerminalRequest updateTerminalRequest, String xRequestId, UUID xIdempotencyKey, final ApiCallback _callback) throws ApiException {
        String basePath = "https://sandbox.cashfree.com/pg";
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call sposUpdateTerminalValidateBeforeCall(String xApiVersion, Integer cfTerminalId, UpdateTerminalRequest updateTerminalRequest, String xRequestId, UUID xIdempotencyKey, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'xApiVersion' is set
        if (xApiVersion == null) {
    ...
    public ApiResponse<List<UpdateTerminalEntity>> SposUpdateTerminal(Integer cfTerminalId, UpdateTerminalRequest updateTerminalRequest, String xRequestId, UUID xIdempotencyKey, OkHttpClient httpClient) throws ApiException {
        String xApiVersion = this.XApiVersion;
        if(httpClient != null) {
            localVarApiClient.httpClient = httpClient;
        }
     ...
     */
    public okhttp3.Call sposUpdateTerminalStatusCall(String xApiVersion, Integer cfTerminalId, UpdateTerminalStatusRequest updateTerminalStatusRequest, String xRequestId, UUID xIdempotencyKey, final ApiCallback _callback) throws ApiException {
        String basePath = "https://sandbox.cashfree.com/pg";
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call sposUpdateTerminalStatusValidateBeforeCall(String xApiVersion, Integer cfTerminalId, UpdateTerminalStatusRequest updateTerminalStatusRequest, String xRequestId, UUID xIdempotencyKey, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'xApiVersion' is set
        if (xApiVersion == null) {
    ...
    public ApiResponse<List<UpdateTerminalEntity>> SposUpdateTerminalStatus(Integer cfTerminalId, UpdateTerminalStatusRequest updateTerminalStatusRequest, String xRequestId, UUID xIdempotencyKey, OkHttpClient httpClient) throws ApiException {
        String xApiVersion = this.XApiVersion;
        if(httpClient != null) {
            localVarApiClient.httpClient = httpClient;
        }
     ...
     */
    public okhttp3.Call sposUploadTerminalDocsCall(String xApiVersion, Integer cfTerminalId, UploadTerminalDocs uploadTerminalDocs, String xRequestId, UUID xIdempotencyKey, final ApiCallback _callback) throws ApiException {
        String basePath = "https://sandbox.cashfree.com/pg";
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call sposUploadTerminalDocsValidateBeforeCall(String xApiVersion, Integer cfTerminalId, UploadTerminalDocs uploadTerminalDocs, String xRequestId, UUID xIdempotencyKey, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'xApiVersion' is set
        if (xApiVersion == null) {
    ...
    public ApiResponse<List<UploadTerminalDocsEntity>> SposUploadTerminalDocs(Integer cfTerminalId, UploadTerminalDocs uploadTerminalDocs, String xRequestId, UUID xIdempotencyKey, OkHttpClient httpClient) throws ApiException {
        String xApiVersion = this.XApiVersion;
        if(httpClient != null) {
            localVarApiClient.httpClient = httpClient;
        }
    ...
    public ApiResponse<CreateSubscriptionPaymentResponse> SubsCreatePayment(CreateSubscriptionPaymentRequest createSubscriptionPaymentRequest, String xRequestId, UUID xIdempotencyKey, OkHttpClient httpClient) throws ApiException {
        String xApiVersion = this.XApiVersion;
        if(httpClient != null) {
            localVarApiClient.httpClient = httpClient;
        }
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 200 </td><td> Success response for creating a plan. </td><td>  * x-api-version -  <br>  * x-ratelimit-limit -  <br>  * x-ratelimit-remaining -  <br>  * x-ratelimit-retry -  <br>  * x-ratelimit-type -  <br>  * x-request-id -  <br>  * x-idempotency-key -  <br>  * x-idempotency-replayed -  <br>  </td></tr>
        <tr><td> 400 </td><td> Bad request error. </td><td>  * x-api-version -  <br>  * x-ratelimit-limit -  <br>  * x-ratelimit-remaining -  <br>  * x-ratelimit-retry -  <br>  * x-ratelimit-type -  <br>  * x-request-id -  <br>  * x-idempotency-key -  <br>  * x-idempotency-replayed -  <br>  </td></tr>
        <tr><td> 401 </td><td> Authentication Error. </td><td>  * x-api-version -  <br>  * x-ratelimit-limit -  <br>  * x-ratelimit-remaining -  <br>  * x-ratelimit-retry -  <br>  * x-ratelimit-type -  <br>  * x-request-id -  <br>  * x-idempotency-key -  <br>  * x-idempotency-replayed -  <br>  </td></tr>
        <tr><td> 404 </td><td> Resource Not found. </td><td>  * x-api-version -  <br>  * x-ratelimit-limit -  <br>  * x-ratelimit-remaining -  <br>  * x-ratelimit-retry -  <br>  * x-ratelimit-type -  <br>  * x-request-id -  <br>  * x-idempotency-key -  <br>  * x-idempotency-replayed -  <br>  </td></tr>
        <tr><td> 422 </td><td> Idempotency error. </td><td>  * x-api-version -  <br>  * x-ratelimit-limit -  <br>  * x-ratelimit-remaining -  <br>  * x-ratelimit-retry -  <br>  * x-ratelimit-type -  <br>  * x-request-id -  <br>  * x-idempotency-key -  <br>  * x-idempotency-replayed -  <br>  </td></tr>
    ...
    public ApiResponse<PlanEntity> SubsCreatePlan(CreatePlanRequest createPlanRequest, String xRequestId, UUID xIdempotencyKey, OkHttpClient httpClient) throws ApiException {
        String xApiVersion = this.XApiVersion;
        if(httpClient != null) {
            localVarApiClient.httpClient = httpClient;
        }
     ...
     * @param createSubscriptionRefundRequest  (required)
     * @param xRequestId Request ID for the API call. Can be used to resolve tech issues. Communicate this in your tech related queries to Cashfree. (optional)
     * @param xIdempotencyKey An idempotency key is a unique identifier you include with your API call. If the request fails or times out, you can safely retry it using the same key to avoid duplicate actions.  (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 200 </td><td> Success response for creating a refund. </td><td>  * x-api-version -  <br>  * x-ratelimit-limit -  <br>  * x-ratelimit-remaining -  <br>  * x-ratelimit-retry -  <br>  * x-ratelimit-type -  <br>  * x-request-id -  <br>  * x-idempotency-key -  <br>  * x-idempotency-replayed -  <br>  </td></tr>
        <tr><td> 400 </td><td> Bad request error. </td><td>  * x-api-version -  <br>  * x-ratelimit-limit -  <br>  * x-ratelimit-remaining -  <br>  * x-ratelimit-retry -  <br>  * x-ratelimit-type -  <br>  * x-request-id -  <br>  * x-idempotency-key -  <br>  * x-idempotency-replayed -  <br>  </td></tr>
        <tr><td> 401 </td><td> Authentication Error. </td><td>  * x-api-version -  <br>  * x-ratelimit-limit -  <br>  * x-ratelimit-remaining -  <br>  * x-ratelimit-retry -  <br>  * x-ratelimit-type -  <br>  * x-request-id -  <br>  * x-idempotency-key -  <br>  * x-idempotency-replayed -  <br>  </td></tr>
        <tr><td> 404 </td><td> Resource Not found. </td><td>  * x-api-version -  <br>  * x-ratelimit-limit -  <br>  * x-ratelimit-remaining -  <br>  * x-ratelimit-retry -  <br>  * x-ratelimit-type -  <br>  * x-request-id -  <br>  * x-idempotency-key -  <br>  * x-idempotency-replayed -  <br>  </td></tr>
        <tr><td> 422 </td><td> Idempotency error. </td><td>  * x-api-version -  <br>  * x-ratelimit-limit -  <br>  * x-ratelimit-remaining -  <br>  * x-ratelimit-retry -  <br>  * x-ratelimit-type -  <br>  * x-request-id -  <br>  * x-idempotency-key -  <br>  * x-idempotency-replayed -  <br>  </td></tr>
    ...
    public ApiResponse<SubscriptionPaymentRefundEntity> SubsCreateRefund(String subscriptionId, CreateSubscriptionRefundRequest createSubscriptionRefundRequest, String xRequestId, UUID xIdempotencyKey, OkHttpClient httpClient) throws ApiException {
        String xApiVersion = this.XApiVersion;
        if(httpClient != null) {
            localVarApiClient.httpClient = httpClient;
        }
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 200 </td><td> Success response for creating a subscription. </td><td>  * x-api-version -  <br>  * x-ratelimit-limit -  <br>  * x-ratelimit-remaining -  <br>  * x-ratelimit-retry -  <br>  * x-ratelimit-type -  <br>  * x-request-id -  <br>  * x-idempotency-key -  <br>  * x-idempotency-replayed -  <br>  </td></tr>
        <tr><td> 400 </td><td> Bad request error. </td><td>  * x-api-version -  <br>  * x-ratelimit-limit -  <br>  * x-ratelimit-remaining -  <br>  * x-ratelimit-retry -  <br>  * x-ratelimit-type -  <br>  * x-request-id -  <br>  * x-idempotency-key -  <br>  * x-idempotency-replayed -  <br>  </td></tr>
        <tr><td> 401 </td><td> Authentication Error. </td><td>  * x-api-version -  <br>  * x-ratelimit-limit -  <br>  * x-ratelimit-remaining -  <br>  * x-ratelimit-retry -  <br>  * x-ratelimit-type -  <br>  * x-request-id -  <br>  * x-idempotency-key -  <br>  * x-idempotency-replayed -  <br>  </td></tr>
        <tr><td> 404 </td><td> Resource Not found. </td><td>  * x-api-version -  <br>  * x-ratelimit-limit -  <br>  * x-ratelimit-remaining -  <br>  * x-ratelimit-retry -  <br>  * x-ratelimit-type -  <br>  * x-request-id -  <br>  * x-idempotency-key -  <br>  * x-idempotency-replayed -  <br>  </td></tr>
        <tr><td> 422 </td><td> Idempotency error. </td><td>  * x-api-version -  <br>  * x-ratelimit-limit -  <br>  * x-ratelimit-remaining -  <br>  * x-ratelimit-retry -  <br>  * x-ratelimit-type -  <br>  * x-request-id -  <br>  * x-idempotency-key -  <br>  * x-idempotency-replayed -  <br>  </td></tr>
    ...
    public ApiResponse<SubscriptionEntity> SubsCreateSubscription(CreateSubscriptionRequest createSubscriptionRequest, String xRequestId, UUID xIdempotencyKey, OkHttpClient httpClient) throws ApiException {
        String xApiVersion = this.XApiVersion;
        if(httpClient != null) {
            localVarApiClient.httpClient = httpClient;
        }
     ...
     * @param xApiVersion API version to be used. Format is in YYYY-MM-DD. (required)
     * @param planId Provide the plan ID for which the details have to be fetched. (required)
     * @param xRequestId Request ID for the API call. Can be used to resolve tech issues. Communicate this in your tech related queries to Cashfree. (optional)
     * @param xIdempotencyKey An idempotency key is a unique identifier you include with your API call. If the request fails or times out, you can safely retry it using the same key to avoid duplicate actions.  (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 200 </td><td> Success response for fetching a plan. </td><td>  * x-api-version -  <br>  * x-ratelimit-limit -  <br>  * x-ratelimit-remaining -  <br>  * x-ratelimit-retry -  <br>  * x-ratelimit-type -  <br>  * x-request-id -  <br>  </td></tr>
        <tr><td> 400 </td><td> Bad request error. </td><td>  * x-api-version -  <br>  * x-ratelimit-limit -  <br>  * x-ratelimit-remaining -  <br>  * x-ratelimit-retry -  <br>  * x-ratelimit-type -  <br>  * x-request-id -  <br>  * x-idempotency-key -  <br>  * x-idempotency-replayed -  <br>  </td></tr>
        <tr><td> 401 </td><td> Authentication Error. </td><td>  * x-api-version -  <br>  * x-ratelimit-limit -  <br>  * x-ratelimit-remaining -  <br>  * x-ratelimit-retry -  <br>  * x-ratelimit-type -  <br>  * x-request-id -  <br>  * x-idempotency-key -  <br>  * x-idempotency-replayed -  <br>  </td></tr>
        <tr><td> 404 </td><td> Resource Not found. </td><td>  * x-api-version -  <br>  * x-ratelimit-limit -  <br>  * x-ratelimit-remaining -  <br>  * x-ratelimit-retry -  <br>  * x-ratelimit-type -  <br>  * x-request-id -  <br>  * x-idempotency-key -  <br>  * x-idempotency-replayed -  <br>  </td></tr>
        <tr><td> 429 </td><td> Rate Limit Error. </td><td>  * x-api-version -  <br>  * x-ratelimit-limit -  <br>  * x-ratelimit-remaining -  <br>  * x-ratelimit-retry -  <br>  * x-ratelimit-type -  <br>  * x-request-id -  <br>  * x-idempotency-key -  <br>  * x-idempotency-replayed -  <br>  </td></tr>
    ...
    public ApiResponse<PlanEntity> SubsFetchPlan(String planId, String xRequestId, UUID xIdempotencyKey, OkHttpClient httpClient) throws ApiException {
        String xApiVersion = this.XApiVersion;
        if(httpClient != null) {
            localVarApiClient.httpClient = httpClient;
        }
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 200 </td><td> Success response for fetching a subscription. </td><td>  * x-api-version -  <br>  * x-ratelimit-limit -  <br>  * x-ratelimit-remaining -  <br>  * x-ratelimit-retry -  <br>  * x-ratelimit-type -  <br>  * x-request-id -  <br>  </td></tr>
        <tr><td> 400 </td><td> Bad request error. </td><td>  * x-api-version -  <br>  * x-ratelimit-limit -  <br>  * x-ratelimit-remaining -  <br>  * x-ratelimit-retry -  <br>  * x-ratelimit-type -  <br>  * x-request-id -  <br>  * x-idempotency-key -  <br>  * x-idempotency-replayed -  <br>  </td></tr>
        <tr><td> 401 </td><td> Authentication Error. </td><td>  * x-api-version -  <br>  * x-ratelimit-limit -  <br>  * x-ratelimit-remaining -  <br>  * x-ratelimit-retry -  <br>  * x-ratelimit-type -  <br>  * x-request-id -  <br>  * x-idempotency-key -  <br>  * x-idempotency-replayed -  <br>  </td></tr>
        <tr><td> 404 </td><td> Resource Not found. </td><td>  * x-api-version -  <br>  * x-ratelimit-limit -  <br>  * x-ratelimit-remaining -  <br>  * x-ratelimit-retry -  <br>  * x-ratelimit-type -  <br>  * x-request-id -  <br>  * x-idempotency-key -  <br>  * x-idempotency-replayed -  <br>  </td></tr>
        <tr><td> 429 </td><td> Rate Limit Error. </td><td>  * x-api-version -  <br>  * x-ratelimit-limit -  <br>  * x-ratelimit-remaining -  <br>  * x-ratelimit-retry -  <br>  * x-ratelimit-type -  <br>  * x-request-id -  <br>  * x-idempotency-key -  <br>  * x-idempotency-replayed -  <br>  </td></tr>
    ...
    public ApiResponse<SubscriptionEntity> SubsFetchSubscription(String subscriptionId, String xRequestId, UUID xIdempotencyKey, OkHttpClient httpClient) throws ApiException {
        String xApiVersion = this.XApiVersion;
        if(httpClient != null) {
            localVarApiClient.httpClient = httpClient;
        }
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 200 </td><td> Success response for fetching details of a single payment. </td><td>  * x-api-version -  <br>  * x-ratelimit-limit -  <br>  * x-ratelimit-remaining -  <br>  * x-ratelimit-retry -  <br>  * x-ratelimit-type -  <br>  * x-request-id -  <br>  </td></tr>
        <tr><td> 400 </td><td> Bad request error. </td><td>  * x-api-version -  <br>  * x-ratelimit-limit -  <br>  * x-ratelimit-remaining -  <br>  * x-ratelimit-retry -  <br>  * x-ratelimit-type -  <br>  * x-request-id -  <br>  * x-idempotency-key -  <br>  * x-idempotency-replayed -  <br>  </td></tr>
        <tr><td> 401 </td><td> Authentication Error. </td><td>  * x-api-version -  <br>  * x-ratelimit-limit -  <br>  * x-ratelimit-remaining -  <br>  * x-ratelimit-retry -  <br>  * x-ratelimit-type -  <br>  * x-request-id -  <br>  * x-idempotency-key -  <br>  * x-idempotency-replayed -  <br>  </td></tr>
        <tr><td> 404 </td><td> Resource Not found. </td><td>  * x-api-version -  <br>  * x-ratelimit-limit -  <br>  * x-ratelimit-remaining -  <br>  * x-ratelimit-retry -  <br>  * x-ratelimit-type -  <br>  * x-request-id -  <br>  * x-idempotency-key -  <br>  * x-idempotency-replayed -  <br>  </td></tr>
        <tr><td> 429 </td><td> Rate Limit Error. </td><td>  * x-api-version -  <br>  * x-ratelimit-limit -  <br>  * x-ratelimit-remaining -  <br>  * x-ratelimit-retry -  <br>  * x-ratelimit-type -  <br>  * x-request-id -  <br>  * x-idempotency-key -  <br>  * x-idempotency-replayed -  <br>  </td></tr>
    ...
    public ApiResponse<SubscriptionPaymentEntity> SubsFetchSubscriptionPayment(String subscriptionId, String paymentId, String xRequestId, UUID xIdempotencyKey, OkHttpClient httpClient) throws ApiException {
        String xApiVersion = this.XApiVersion;
        if(httpClient != null) {
            localVarApiClient.httpClient = httpClient;
        }
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 200 </td><td> Success response for fetching details of all payments of a subscription. </td><td>  * x-api-version -  <br>  * x-ratelimit-limit -  <br>  * x-ratelimit-remaining -  <br>  * x-ratelimit-retry -  <br>  * x-ratelimit-type -  <br>  * x-request-id -  <br>  * x-idempotency-key -  <br>  * x-idempotency-replayed -  <br>  </td></tr>
        <tr><td> 400 </td><td> Bad request error. </td><td>  * x-api-version -  <br>  * x-ratelimit-limit -  <br>  * x-ratelimit-remaining -  <br>  * x-ratelimit-retry -  <br>  * x-ratelimit-type -  <br>  * x-request-id -  <br>  * x-idempotency-key -  <br>  * x-idempotency-replayed -  <br>  </td></tr>
        <tr><td> 401 </td><td> Authentication Error. </td><td>  * x-api-version -  <br>  * x-ratelimit-limit -  <br>  * x-ratelimit-remaining -  <br>  * x-ratelimit-retry -  <br>  * x-ratelimit-type -  <br>  * x-request-id -  <br>  * x-idempotency-key -  <br>  * x-idempotency-replayed -  <br>  </td></tr>
        <tr><td> 404 </td><td> Resource Not found. </td><td>  * x-api-version -  <br>  * x-ratelimit-limit -  <br>  * x-ratelimit-remaining -  <br>  * x-ratelimit-retry -  <br>  * x-ratelimit-type -  <br>  * x-request-id -  <br>  * x-idempotency-key -  <br>  * x-idempotency-replayed -  <br>  </td></tr>
        <tr><td> 422 </td><td> Idempotency error. </td><td>  * x-api-version -  <br>  * x-ratelimit-limit -  <br>  * x-ratelimit-remaining -  <br>  * x-ratelimit-retry -  <br>  * x-ratelimit-type -  <br>  * x-request-id -  <br>  * x-idempotency-key -  <br>  * x-idempotency-replayed -  <br>  </td></tr>
    ...
    public ApiResponse<List<SubscriptionPaymentEntity>> SubsFetchSubscriptionPayments(String subscriptionId, String xRequestId, UUID xIdempotencyKey, OkHttpClient httpClient) throws ApiException {
        String xApiVersion = this.XApiVersion;
        if(httpClient != null) {
            localVarApiClient.httpClient = httpClient;
        }
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 200 </td><td> Success response for fetching details of a refund. </td><td>  * x-api-version -  <br>  * x-ratelimit-limit -  <br>  * x-ratelimit-remaining -  <br>  * x-ratelimit-retry -  <br>  * x-ratelimit-type -  <br>  * x-request-id -  <br>  </td></tr>
        <tr><td> 400 </td><td> Bad request error. </td><td>  * x-api-version -  <br>  * x-ratelimit-limit -  <br>  * x-ratelimit-remaining -  <br>  * x-ratelimit-retry -  <br>  * x-ratelimit-type -  <br>  * x-request-id -  <br>  * x-idempotency-key -  <br>  * x-idempotency-replayed -  <br>  </td></tr>
        <tr><td> 401 </td><td> Authentication Error. </td><td>  * x-api-version -  <br>  * x-ratelimit-limit -  <br>  * x-ratelimit-remaining -  <br>  * x-ratelimit-retry -  <br>  * x-ratelimit-type -  <br>  * x-request-id -  <br>  * x-idempotency-key -  <br>  * x-idempotency-replayed -  <br>  </td></tr>
        <tr><td> 404 </td><td> Resource Not found. </td><td>  * x-api-version -  <br>  * x-ratelimit-limit -  <br>  * x-ratelimit-remaining -  <br>  * x-ratelimit-retry -  <br>  * x-ratelimit-type -  <br>  * x-request-id -  <br>  * x-idempotency-key -  <br>  * x-idempotency-replayed -  <br>  </td></tr>
        <tr><td> 429 </td><td> Rate Limit Error. </td><td>  * x-api-version -  <br>  * x-ratelimit-limit -  <br>  * x-ratelimit-remaining -  <br>  * x-ratelimit-retry -  <br>  * x-ratelimit-type -  <br>  * x-request-id -  <br>  * x-idempotency-key -  <br>  * x-idempotency-replayed -  <br>  </td></tr>
    ...
    public ApiResponse<SubscriptionPaymentRefundEntity> SubsFetchSubscriptionRefund(String subscriptionId, String refundId, String xRequestId, UUID xIdempotencyKey, OkHttpClient httpClient) throws ApiException {
        String xApiVersion = this.XApiVersion;
        if(httpClient != null) {
            localVarApiClient.httpClient = httpClient;
        }
    ...
    /**
     * Build call for subsFetchSubscription_0
     * @param xApiVersion API version to be used. Format is in YYYY-MM-DD. (required)
     * @param paymentId Provide the PaymentId using which the payment was created. (required)
     * @param xRequestId Request ID for the API call. Can be used to resolve tech issues. Communicate this in your tech related queries to Cashfree. (optional)
     * @param xIdempotencyKey An idempotency key is a unique identifier you include with your API call. If the request fails or times out, you can safely retry it using the same key to avoid duplicate actions.  (optional)
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        ...
        <tr><td> 400 </td><td> Transaction return summary Failure Response. </td><td>  -  </td></tr>
        <tr><td> 401 </td><td> Authentication Error. </td><td>  * x-api-version -  <br>  * x-ratelimit-limit -  <br>  * x-ratelimit-remaining -  <br>  * x-ratelimit-retry -  <br>  * x-ratelimit-type -  <br>  * x-request-id -  <br>  * x-idempotency-key -  <br>  * x-idempotency-replayed -  <br>  </td></tr>
        <tr><td> 404 </td><td> Resource Not found. </td><td>  * x-api-version -  <br>  * x-ratelimit-limit -  <br>  * x-ratelimit-remaining -  <br>  * x-ratelimit-retry -  <br>  * x-ratelimit-type -  <br>  * x-request-id -  <br>  * x-idempotency-key -  <br>  * x-idempotency-replayed -  <br>  </td></tr>
        <tr><td> 429 </td><td> Rate Limit Error. </td><td>  * x-api-version -  <br>  * x-ratelimit-limit -  <br>  * x-ratelimit-remaining -  <br>  * x-ratelimit-retry -  <br>  * x-ratelimit-type -  <br>  * x-request-id -  <br>  * x-idempotency-key -  <br>  * x-idempotency-replayed -  <br>  </td></tr>
        <tr><td> 500 </td><td> API related Error. </td><td>  * x-api-version -  <br>  * x-ratelimit-limit -  <br>  * x-ratelimit-remaining -  <br>  * x-ratelimit-retry -  <br>  * x-ratelimit-type -  <br>  * x-request-id -  <br>  * x-idempotency-key -  <br>  * x-idempotency-replayed -  <br>  </td></tr>
     ...
     */
    public okhttp3.Call subsFetchSubscription_0Call(String xApiVersion, String paymentId, String xRequestId, UUID xIdempotencyKey, final ApiCallback _callback) throws ApiException {
        String basePath = "https://sandbox.cashfree.com/pg";
        ...
        // create path and map variables
        String localVarPath = "/subscriptions/charge/{payment_id}/transaction-return-summary/generate"
            .replace("{" + "payment_id" + "}", localVarApiClient.escapeString(paymentId.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call subsFetchSubscription_0ValidateBeforeCall(String xApiVersion, String paymentId, String xRequestId, UUID xIdempotencyKey, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'xApiVersion' is set
        if (xApiVersion == null) {
            throw new ApiException("Missing the required parameter 'xApiVersion' when calling SubsFetchSubscription0(Async)");
        }

        // verify the required parameter 'paymentId' is set
        if (paymentId == null) {
            throw new ApiException("Missing the required parameter 'paymentId' when calling SubsFetchSubscription0(Async)");
        }

        return subsFetchSubscription_0Call(xApiVersion, paymentId, xRequestId, xIdempotencyKey, _callback);

    }

    public ApiResponse<TransactionReturnSummary200Response> SubsFetchSubscription0(String paymentId, String xRequestId, UUID xIdempotencyKey, OkHttpClient httpClient) throws ApiException {
        String xApiVersion = this.XApiVersion;
        if(httpClient != null) {
            localVarApiClient.httpClient = httpClient;
        }
        okhttp3.Call localVarCall = subsFetchSubscription_0ValidateBeforeCall(xApiVersion, paymentId, xRequestId, xIdempotencyKey, null);
        Type localVarReturnType = new TypeToken<TransactionReturnSummary200Response>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     * @param xApiVersion API version to be used. Format is in YYYY-MM-DD. (required)
     * @param subscriptionId Provide the SubscriptionId using which the subscription was created. (required)
     * @param manageSubscriptionRequest  (required)
     * @param xRequestId Request ID for the API call. Can be used to resolve tech issues. Communicate this in your tech related queries to Cashfree. (optional)
     * @param xIdempotencyKey An idempotency key is a unique identifier you include with your API call. If the request fails or times out, you can safely retry it using the same key to avoid duplicate actions.  (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 200 </td><td> Success response for managing a subscription. </td><td>  * x-api-version -  <br>  * x-ratelimit-limit -  <br>  * x-ratelimit-remaining -  <br>  * x-ratelimit-retry -  <br>  * x-ratelimit-type -  <br>  * x-request-id -  <br>  * x-idempotency-key -  <br>  * x-idempotency-replayed -  <br>  </td></tr>
        <tr><td> 400 </td><td> Bad request error. </td><td>  * x-api-version -  <br>  * x-ratelimit-limit -  <br>  * x-ratelimit-remaining -  <br>  * x-ratelimit-retry -  <br>  * x-ratelimit-type -  <br>  * x-request-id -  <br>  * x-idempotency-key -  <br>  * x-idempotency-replayed -  <br>  </td></tr>
        <tr><td> 401 </td><td> Authentication Error. </td><td>  * x-api-version -  <br>  * x-ratelimit-limit -  <br>  * x-ratelimit-remaining -  <br>  * x-ratelimit-retry -  <br>  * x-ratelimit-type -  <br>  * x-request-id -  <br>  * x-idempotency-key -  <br>  * x-idempotency-replayed -  <br>  </td></tr>
        <tr><td> 404 </td><td> Resource Not found. </td><td>  * x-api-version -  <br>  * x-ratelimit-limit -  <br>  * x-ratelimit-remaining -  <br>  * x-ratelimit-retry -  <br>  * x-ratelimit-type -  <br>  * x-request-id -  <br>  * x-idempotency-key -  <br>  * x-idempotency-replayed -  <br>  </td></tr>
        <tr><td> 422 </td><td> Idempotency error. </td><td>  * x-api-version -  <br>  * x-ratelimit-limit -  <br>  * x-ratelimit-remaining -  <br>  * x-ratelimit-retry -  <br>  * x-ratelimit-type -  <br>  * x-request-id -  <br>  * x-idempotency-key -  <br>  * x-idempotency-replayed -  <br>  </td></tr>
    ...
    public ApiResponse<SubscriptionEntity> SubsManageSubscription(String subscriptionId, ManageSubscriptionRequest manageSubscriptionRequest, String xRequestId, UUID xIdempotencyKey, OkHttpClient httpClient) throws ApiException {
        String xApiVersion = this.XApiVersion;
        if(httpClient != null) {
            localVarApiClient.httpClient = httpClient;
        }
     ...
     * @param subscriptionId Provide the SubscriptionId using which the subscription was created. (required)
     * @param paymentId Provide the PaymentId using which the payment was created. (required)
     * @param manageSubscriptionPaymentRequest  (required)
     * @param xRequestId Request ID for the API call. Can be used to resolve tech issues. Communicate this in your tech related queries to Cashfree. (optional)
     * @param xIdempotencyKey An idempotency key is a unique identifier you include with your API call. If the request fails or times out, you can safely retry it using the same key to avoid duplicate actions.  (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 200 </td><td> Success response for managing a single payment. </td><td>  * x-api-version -  <br>  * x-ratelimit-limit -  <br>  * x-ratelimit-remaining -  <br>  * x-ratelimit-retry -  <br>  * x-ratelimit-type -  <br>  * x-request-id -  <br>  </td></tr>
        <tr><td> 400 </td><td> Bad request error. </td><td>  * x-api-version -  <br>  * x-ratelimit-limit -  <br>  * x-ratelimit-remaining -  <br>  * x-ratelimit-retry -  <br>  * x-ratelimit-type -  <br>  * x-request-id -  <br>  * x-idempotency-key -  <br>  * x-idempotency-replayed -  <br>  </td></tr>
        <tr><td> 401 </td><td> Authentication Error. </td><td>  * x-api-version -  <br>  * x-ratelimit-limit -  <br>  * x-ratelimit-remaining -  <br>  * x-ratelimit-retry -  <br>  * x-ratelimit-type -  <br>  * x-request-id -  <br>  * x-idempotency-key -  <br>  * x-idempotency-replayed -  <br>  </td></tr>
        <tr><td> 404 </td><td> Resource Not found. </td><td>  * x-api-version -  <br>  * x-ratelimit-limit -  <br>  * x-ratelimit-remaining -  <br>  * x-ratelimit-retry -  <br>  * x-ratelimit-type -  <br>  * x-request-id -  <br>  * x-idempotency-key -  <br>  * x-idempotency-replayed -  <br>  </td></tr>
        <tr><td> 429 </td><td> Rate Limit Error. </td><td>  * x-api-version -  <br>  * x-ratelimit-limit -  <br>  * x-ratelimit-remaining -  <br>  * x-ratelimit-retry -  <br>  * x-ratelimit-type -  <br>  * x-request-id -  <br>  * x-idempotency-key -  <br>  * x-idempotency-replayed -  <br>  </td></tr>
    ...
    public ApiResponse<SubscriptionPaymentEntity> SubsManageSubscriptionPayment(String subscriptionId, String paymentId, ManageSubscriptionPaymentRequest manageSubscriptionPaymentRequest, String xRequestId, UUID xIdempotencyKey, OkHttpClient httpClient) throws ApiException {
        String xApiVersion = this.XApiVersion;
        if(httpClient != null) {
            localVarApiClient.httpClient = httpClient;
        }
    ...
    public ApiResponse<UploadPnachImageResponse> SubscriptionDocumentUpload(String paymentId, File _file, String paymentId2, String action, String xRequestId, UUID xIdempotencyKey, OkHttpClient httpClient) throws ApiException {
        String xApiVersion = this.XApiVersion;
        if(httpClient != null) {
            localVarApiClient.httpClient = httpClient;
        }
    ...
    public ApiResponse<SubscriptionEligibilityResponse> SubscriptionEligibility(SubscriptionEligibilityRequest subscriptionEligibilityRequest, String xRequestId, UUID xIdempotencyKey, OkHttpClient httpClient) throws ApiException {
        String xApiVersion = this.XApiVersion;
        if(httpClient != null) {
            localVarApiClient.httpClient = httpClient;
        }
     ...
     * @param xApiVersion API version to be used. Format is in YYYY-MM-DD. (required)
     * @param customerId The customer ID provided by the merchant during the [Create Order API](https://www.cashfree.com/docs/api-reference/payments/latest/orders/create) call, used to save cards for the customer. (required)
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 200 </td><td> Delete saved card instrument object. </td><td>  * x-api-version -  <br>  * x-ratelimit-limit -  <br>  * x-ratelimit-remaining -  <br>  * x-ratelimit-retry -  <br>  * x-ratelimit-type -  <br>  * x-request-id -  <br>  * x-idempotency-key -  <br>  * x-idempotency-replayed -  <br>  </td></tr>
        <tr><td> 400 </td><td> Bad request error. </td><td>  * x-api-version -  <br>  * x-ratelimit-limit -  <br>  * x-ratelimit-remaining -  <br>  * x-ratelimit-retry -  <br>  * x-ratelimit-type -  <br>  * x-request-id -  <br>  * x-idempotency-key -  <br>  * x-idempotency-replayed -  <br>  </td></tr>
        <tr><td> 401 </td><td> Authentication Error. </td><td>  * x-api-version -  <br>  * x-ratelimit-limit -  <br>  * x-ratelimit-remaining -  <br>  * x-ratelimit-retry -  <br>  * x-ratelimit-type -  <br>  * x-request-id -  <br>  * x-idempotency-key -  <br>  * x-idempotency-replayed -  <br>  </td></tr>
        <tr><td> 404 </td><td> Resource Not found. </td><td>  * x-api-version -  <br>  * x-ratelimit-limit -  <br>  * x-ratelimit-remaining -  <br>  * x-ratelimit-retry -  <br>  * x-ratelimit-type -  <br>  * x-request-id -  <br>  * x-idempotency-key -  <br>  * x-idempotency-replayed -  <br>  </td></tr>
        <tr><td> 409 </td><td> Resource already present. </td><td>  * x-api-version -  <br>  * x-ratelimit-limit -  <br>  * x-ratelimit-remaining -  <br>  * x-ratelimit-retry -  <br>  * x-ratelimit-type -  <br>  * x-request-id -  <br>  * x-idempotency-key -  <br>  * x-idempotency-replayed -  <br>  </td></tr>
    ...
    public ApiResponse<DeletedInstrumentEntity> PGCustomerDeleteInstrument(String customerId, String instrumentId, String xRequestId, UUID xIdempotencyKey, OkHttpClient httpClient) throws ApiException {
        String xApiVersion = this.XApiVersion;
        if(httpClient != null) {
            localVarApiClient.httpClient = httpClient;
        }
        ...
        Type localVarReturnType = new TypeToken<DeletedInstrumentEntity>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 200 </td><td> Saved card instrument object. </td><td>  * x-api-version -  <br>  * x-ratelimit-limit -  <br>  * x-ratelimit-remaining -  <br>  * x-ratelimit-retry -  <br>  * x-ratelimit-type -  <br>  * x-request-id -  <br>  * x-idempotency-key -  <br>  * x-idempotency-replayed -  <br>  </td></tr>
        <tr><td> 400 </td><td> Bad request error. </td><td>  * x-api-version -  <br>  * x-ratelimit-limit -  <br>  * x-ratelimit-remaining -  <br>  * x-ratelimit-retry -  <br>  * x-ratelimit-type -  <br>  * x-request-id -  <br>  * x-idempotency-key -  <br>  * x-idempotency-replayed -  <br>  </td></tr>
        <tr><td> 401 </td><td> Authentication Error. </td><td>  * x-api-version -  <br>  * x-ratelimit-limit -  <br>  * x-ratelimit-remaining -  <br>  * x-ratelimit-retry -  <br>  * x-ratelimit-type -  <br>  * x-request-id -  <br>  * x-idempotency-key -  <br>  * x-idempotency-replayed -  <br>  </td></tr>
        <tr><td> 404 </td><td> Resource Not found. </td><td>  * x-api-version -  <br>  * x-ratelimit-limit -  <br>  * x-ratelimit-remaining -  <br>  * x-ratelimit-retry -  <br>  * x-ratelimit-type -  <br>  * x-request-id -  <br>  * x-idempotency-key -  <br>  * x-idempotency-replayed -  <br>  </td></tr>
        <tr><td> 409 </td><td> Resource already present. </td><td>  * x-api-version -  <br>  * x-ratelimit-limit -  <br>  * x-ratelimit-remaining -  <br>  * x-ratelimit-retry -  <br>  * x-ratelimit-type -  <br>  * x-request-id -  <br>  * x-idempotency-key -  <br>  * x-idempotency-replayed -  <br>  </td></tr>
    ...
    public ApiResponse<InstrumentEntity> PGCustomerFetchInstrument(String customerId, String instrumentId, String xRequestId, UUID xIdempotencyKey, OkHttpClient httpClient) throws ApiException {
        String xApiVersion = this.XApiVersion;
        if(httpClient != null) {
            localVarApiClient.httpClient = httpClient;
        }
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 200 </td><td> Contains list of all saved cards for the customer. Merchants are advised to filter out saved cards basis token expiry sent in API response, to only show active saved cards/tokens on their checkout. </td><td>  * x-api-version -  <br>  * x-ratelimit-limit -  <br>  * x-ratelimit-remaining -  <br>  * x-ratelimit-retry -  <br>  * x-ratelimit-type -  <br>  * x-request-id -  <br>  * x-idempotency-key -  <br>  * x-idempotency-replayed -  <br>  </td></tr>
        <tr><td> 400 </td><td> Bad request error. </td><td>  * x-api-version -  <br>  * x-ratelimit-limit -  <br>  * x-ratelimit-remaining -  <br>  * x-ratelimit-retry -  <br>  * x-ratelimit-type -  <br>  * x-request-id -  <br>  * x-idempotency-key -  <br>  * x-idempotency-replayed -  <br>  </td></tr>
        <tr><td> 401 </td><td> Authentication Error. </td><td>  * x-api-version -  <br>  * x-ratelimit-limit -  <br>  * x-ratelimit-remaining -  <br>  * x-ratelimit-retry -  <br>  * x-ratelimit-type -  <br>  * x-request-id -  <br>  * x-idempotency-key -  <br>  * x-idempotency-replayed -  <br>  </td></tr>
        <tr><td> 404 </td><td> Resource Not found. </td><td>  * x-api-version -  <br>  * x-ratelimit-limit -  <br>  * x-ratelimit-remaining -  <br>  * x-ratelimit-retry -  <br>  * x-ratelimit-type -  <br>  * x-request-id -  <br>  * x-idempotency-key -  <br>  * x-idempotency-replayed -  <br>  </td></tr>
        <tr><td> 409 </td><td> Resource already present. </td><td>  * x-api-version -  <br>  * x-ratelimit-limit -  <br>  * x-ratelimit-remaining -  <br>  * x-ratelimit-retry -  <br>  * x-ratelimit-type -  <br>  * x-request-id -  <br>  * x-idempotency-key -  <br>  * x-idempotency-replayed -  <br>  </td></tr>
    ...
    public okhttp3.Call pGCustomerFetchInstrumentsCall(String xApiVersion, String customerId, String instrumentType, String xRequestId, UUID xIdempotencyKey, final ApiCallback _callback) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/customers/{customer_id}/instruments?instrument_type=card"
            .replace("{" + "customer_id" + "}", localVarApiClient.escapeString(customerId.toString()));
    ...
    public ApiResponse<List<InstrumentEntityForAllSavedCard>> PGCustomerFetchInstruments(String customerId, String instrumentType, String xRequestId, UUID xIdempotencyKey, OkHttpClient httpClient) throws ApiException {
        String xApiVersion = this.XApiVersion;
        if(httpClient != null) {
            localVarApiClient.httpClient = httpClient;
        }
        ...
        Type localVarReturnType = new TypeToken<List<InstrumentEntityForAllSavedCard>>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     * @param xApiVersion API version to be used. Format is in YYYY-MM-DD. (required)
     * @param customerId The customer ID provided by the merchant during the [Create Order API](https://www.cashfree.com/docs/api-reference/payments/latest/orders/create) call, used to save cards for the customer. (required)
     * @param instrumentId Identifier for the specific card to fetch its details. (required)
     * @param xRequestId Request ID for the API call. Can be used to resolve tech issues. Communicate this in your tech related queries to Cashfree. (optional)
     * @param xIdempotencyKey An idempotency key is a unique identifier you include with your API call. If the request fails or times out, you can safely retry it using the same key to avoid duplicate actions.  (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 200 </td><td> Cryptogram object for a saved card. </td><td>  * x-api-version -  <br>  * x-ratelimit-limit -  <br>  * x-ratelimit-remaining -  <br>  * x-ratelimit-retry -  <br>  * x-ratelimit-type -  <br>  * x-request-id -  <br>  * x-idempotency-key -  <br>  * x-idempotency-replayed -  <br>  </td></tr>
        <tr><td> 400 </td><td> Bad request error. </td><td>  * x-api-version -  <br>  * x-ratelimit-limit -  <br>  * x-ratelimit-remaining -  <br>  * x-ratelimit-retry -  <br>  * x-ratelimit-type -  <br>  * x-request-id -  <br>  * x-idempotency-key -  <br>  * x-idempotency-replayed -  <br>  </td></tr>
        <tr><td> 401 </td><td> Authentication Error. </td><td>  * x-api-version -  <br>  * x-ratelimit-limit -  <br>  * x-ratelimit-remaining -  <br>  * x-ratelimit-retry -  <br>  * x-ratelimit-type -  <br>  * x-request-id -  <br>  * x-idempotency-key -  <br>  * x-idempotency-replayed -  <br>  </td></tr>
        <tr><td> 404 </td><td> Resource Not found. </td><td>  * x-api-version -  <br>  * x-ratelimit-limit -  <br>  * x-ratelimit-remaining -  <br>  * x-ratelimit-retry -  <br>  * x-ratelimit-type -  <br>  * x-request-id -  <br>  * x-idempotency-key -  <br>  * x-idempotency-replayed -  <br>  </td></tr>
        <tr><td> 409 </td><td> Resource already present. </td><td>  * x-api-version -  <br>  * x-ratelimit-limit -  <br>  * x-ratelimit-remaining -  <br>  * x-ratelimit-retry -  <br>  * x-ratelimit-type -  <br>  * x-request-id -  <br>  * x-idempotency-key -  <br>  * x-idempotency-replayed -  <br>  </td></tr>
    ...
    public ApiResponse<CryptogramEntity> PGCustomerInstrumentsFetchCryptogram(String customerId, String instrumentId, String xRequestId, UUID xIdempotencyKey, OkHttpClient httpClient) throws ApiException {
        String xApiVersion = this.XApiVersion;
        if(httpClient != null) {
            localVarApiClient.httpClient = httpClient;
        }
    ...
    /**
     * Build call for pGCreatePAR
     * @param xApiVersion API version to be used. Format is in YYYY-MM-DD. (required)
     * @param paRRequest Request parameters for creating PAR. (required)
     * @param xRequestId Request ID for the API call. Can be used to resolve tech issues. Communicate this in your tech related queries to Cashfree. (optional)
     * @param xIdempotencyKey An idempotency key is a unique identifier you include with your API call. If the request fails or times out, you can safely retry it using the same key to avoid duplicate actions.  (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 200 </td><td> Success response for PAR by providing plain card details. </td><td>  * x-api-version -  <br>  * x-ratelimit-limit -  <br>  * x-ratelimit-remaining -  <br>  * x-ratelimit-retry -  <br>  * x-ratelimit-type -  <br>  * x-request-id -  <br>  </td></tr>
        <tr><td> 400 </td><td> Bad request error. </td><td>  * x-api-version -  <br>  * x-ratelimit-limit -  <br>  * x-ratelimit-remaining -  <br>  * x-ratelimit-retry -  <br>  * x-ratelimit-type -  <br>  * x-request-id -  <br>  * x-idempotency-key -  <br>  * x-idempotency-replayed -  <br>  </td></tr>
        <tr><td> 401 </td><td> Authentication Error. </td><td>  * x-api-version -  <br>  * x-ratelimit-limit -  <br>  * x-ratelimit-remaining -  <br>  * x-ratelimit-retry -  <br>  * x-ratelimit-type -  <br>  * x-request-id -  <br>  * x-idempotency-key -  <br>  * x-idempotency-replayed -  <br>  </td></tr>
        <tr><td> 404 </td><td> Resource Not found. </td><td>  * x-api-version -  <br>  * x-ratelimit-limit -  <br>  * x-ratelimit-remaining -  <br>  * x-ratelimit-retry -  <br>  * x-ratelimit-type -  <br>  * x-request-id -  <br>  * x-idempotency-key -  <br>  * x-idempotency-replayed -  <br>  </td></tr>
        <tr><td> 409 </td><td> Resource already present. </td><td>  * x-api-version -  <br>  * x-ratelimit-limit -  <br>  * x-ratelimit-remaining -  <br>  * x-ratelimit-retry -  <br>  * x-ratelimit-type -  <br>  * x-request-id -  <br>  * x-idempotency-key -  <br>  * x-idempotency-replayed -  <br>  </td></tr>
     ...
     */
    public okhttp3.Call pGCreatePARCall(String xApiVersion, PARRequest paRRequest, String xRequestId, UUID xIdempotencyKey, final ApiCallback _callback) throws ApiException {
        String basePath = "https://sandbox.cashfree.com/pg";
        ...
        // create path and map variables
        String localVarPath = "/utilities/pars";
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call pGCreatePARValidateBeforeCall(String xApiVersion, PARRequest paRRequest, String xRequestId, UUID xIdempotencyKey, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'xApiVersion' is set
        if (xApiVersion == null) {
            throw new ApiException("Missing the required parameter 'xApiVersion' when calling PGCreatePAR(Async)");
        }

        // verify the required parameter 'paRRequest' is set
        if (paRRequest == null) {
            throw new ApiException("Missing the required parameter 'paRRequest' when calling PGCreatePAR(Async)");
        }

        return pGCreatePARCall(xApiVersion, paRRequest, xRequestId, xIdempotencyKey, _callback);

    }

    public ApiResponse<PGCreatePAR200Response> PGCreatePAR(PARRequest paRRequest, String xRequestId, UUID xIdempotencyKey, OkHttpClient httpClient) throws ApiException {
        String xApiVersion = this.XApiVersion;
        if(httpClient != null) {
            localVarApiClient.httpClient = httpClient;
        }
        okhttp3.Call localVarCall = pGCreatePARValidateBeforeCall(xApiVersion, paRRequest, xRequestId, xIdempotencyKey, null);
        Type localVarReturnType = new TypeToken<PGCreatePAR200Response>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }


    /**
     * Build call for pGGetCardBin
     * @param xApiVersion API version to be used. Format is in YYYY-MM-DD. (required)
     * @param getCardBinRequest Request parameters to get card BIN details. (required)
     * @param xRequestId Request ID for the API call. Can be used to resolve tech issues. Communicate this in your tech related queries to Cashfree. (optional)
     * @param xIdempotencyKey An idempotency key is a unique identifier you include with your API call. If the request fails or times out, you can safely retry it using the same key to avoid duplicate actions.  (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 200 </td><td> Success response for Card BIN details. </td><td>  -  </td></tr>
        <tr><td> 400 </td><td> Bad request error. </td><td>  * x-api-version -  <br>  * x-ratelimit-limit -  <br>  * x-ratelimit-remaining -  <br>  * x-ratelimit-retry -  <br>  * x-ratelimit-type -  <br>  * x-request-id -  <br>  * x-idempotency-key -  <br>  * x-idempotency-replayed -  <br>  </td></tr>
        <tr><td> 401 </td><td> Authentication Error. </td><td>  * x-api-version -  <br>  * x-ratelimit-limit -  <br>  * x-ratelimit-remaining -  <br>  * x-ratelimit-retry -  <br>  * x-ratelimit-type -  <br>  * x-request-id -  <br>  * x-idempotency-key -  <br>  * x-idempotency-replayed -  <br>  </td></tr>
        <tr><td> 404 </td><td> Resource Not found. </td><td>  * x-api-version -  <br>  * x-ratelimit-limit -  <br>  * x-ratelimit-remaining -  <br>  * x-ratelimit-retry -  <br>  * x-ratelimit-type -  <br>  * x-request-id -  <br>  * x-idempotency-key -  <br>  * x-idempotency-replayed -  <br>  </td></tr>
        <tr><td> 409 </td><td> Resource already present. </td><td>  * x-api-version -  <br>  * x-ratelimit-limit -  <br>  * x-ratelimit-remaining -  <br>  * x-ratelimit-retry -  <br>  * x-ratelimit-type -  <br>  * x-request-id -  <br>  * x-idempotency-key -  <br>  * x-idempotency-replayed -  <br>  </td></tr>
     ...
     */
    public okhttp3.Call pGGetCardBinCall(String xApiVersion, GetCardBinRequest getCardBinRequest, String xRequestId, UUID xIdempotencyKey, final ApiCallback _callback) throws ApiException {
        String basePath = "https://sandbox.cashfree.com/pg";
        ...
        Object localVarPostBody = getCardBinRequest;

        // create path and map variables
        String localVarPath = "/utilities/cardbin";
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call pGGetCardBinValidateBeforeCall(String xApiVersion, GetCardBinRequest getCardBinRequest, String xRequestId, UUID xIdempotencyKey, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'xApiVersion' is set
        if (xApiVersion == null) {
            throw new ApiException("Missing the required parameter 'xApiVersion' when calling PGGetCardBin(Async)");
        }

        // verify the required parameter 'getCardBinRequest' is set
        if (getCardBinRequest == null) {
            throw new ApiException("Missing the required parameter 'getCardBinRequest' when calling PGGetCardBin(Async)");
        }

        return pGGetCardBinCall(xApiVersion, getCardBinRequest, xRequestId, xIdempotencyKey, _callback);

    }

    public ApiResponse<GetCardBinResponseSchema> PGGetCardBin(GetCardBinRequest getCardBinRequest, String xRequestId, UUID xIdempotencyKey, OkHttpClient httpClient) throws ApiException {
        String xApiVersion = this.XApiVersion;
        if(httpClient != null) {
            localVarApiClient.httpClient = httpClient;
        }
        okhttp3.Call localVarCall = pGGetCardBinValidateBeforeCall(xApiVersion, getCardBinRequest, xRequestId, xIdempotencyKey, null);
        Type localVarReturnType = new TypeToken<GetCardBinResponseSchema>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
...
static class ApiClient {
     ...
     * @throws com.cashfree.pg.ApiException If fail to deserialize response body, i.e. cannot read response body
     ...
     * @throws com.cashfree.pg.ApiException If fail to serialize the given object
     */
     ...
     * @throws com.cashfree.pg.ApiException If fail to read file content from response and write to disk
     ...
     * @throws com.cashfree.pg.ApiException If fail to execute the call
     */
     ...
     * @param returnType Return type
     * @return Type
     * @throws com.cashfree.pg.ApiException If the response has an unsuccessful status code or
     ...
     * @throws com.cashfree.pg.ApiException If fail to serialize the request body object
     */
     ...
     * @param uri URI
     * @throws com.cashfree.pg.ApiException If fails to update the parameters
     */
     ...
     * @throws com.cashfree.pg.ApiException If fail to serialize the request body object into a string
     */
