...
public class CreateSubscriptionPaymentAuthResponse {
  ...
  public CreateSubscriptionPaymentAuthResponse() {
  }

  public CreateSubscriptionPaymentAuthResponse cfPaymentId(String cfPaymentId) {
  ...
  **/
  ...
  public CreateSubscriptionPaymentAuthResponse cfSubscriptionId(String cfSubscriptionId) {
  ...
  **/
  ...
  public CreateSubscriptionPaymentAuthResponse failureDetails(CreateSubscriptionPaymentAuthResponseFailureDetails failureDetails) {
  ...
  **/
  ...
  public CreateSubscriptionPaymentAuthResponse paymentAmount(BigDecimal paymentAmount) {
  ...
  **/
  ...
  public CreateSubscriptionPaymentAuthResponse paymentId(String paymentId) {
  ...
  **/
  ...
  public CreateSubscriptionPaymentAuthResponse paymentInitiatedDate(String paymentInitiatedDate) {
  ...
  **/
  ...
  public CreateSubscriptionPaymentAuthResponse paymentStatus(String paymentStatus) {
  ...
  **/
  ...
  public CreateSubscriptionPaymentAuthResponse paymentType(String paymentType) {
  ...
  **/
  ...
  public CreateSubscriptionPaymentAuthResponse subscriptionId(String subscriptionId) {
  ...
  **/
  ...
  public CreateSubscriptionPaymentAuthResponse paymentMethod(String paymentMethod) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    CreateSubscriptionPaymentAuthResponse createSubscriptionPaymentAuthResponse = (CreateSubscriptionPaymentAuthResponse) o;
    return Objects.equals(this.cfPaymentId, createSubscriptionPaymentAuthResponse.cfPaymentId) &&
        Objects.equals(this.cfSubscriptionId, createSubscriptionPaymentAuthResponse.cfSubscriptionId) &&
        Objects.equals(this.failureDetails, createSubscriptionPaymentAuthResponse.failureDetails) &&
        Objects.equals(this.paymentAmount, createSubscriptionPaymentAuthResponse.paymentAmount) &&
        Objects.equals(this.paymentId, createSubscriptionPaymentAuthResponse.paymentId) &&
        Objects.equals(this.paymentInitiatedDate, createSubscriptionPaymentAuthResponse.paymentInitiatedDate) &&
        Objects.equals(this.paymentStatus, createSubscriptionPaymentAuthResponse.paymentStatus) &&
        Objects.equals(this.paymentType, createSubscriptionPaymentAuthResponse.paymentType) &&
        Objects.equals(this.subscriptionId, createSubscriptionPaymentAuthResponse.subscriptionId) &&
        Objects.equals(this.paymentMethod, createSubscriptionPaymentAuthResponse.paymentMethod);
  }

  @Override
  public int hashCode() {
    return Objects.hash(cfPaymentId, cfSubscriptionId, failureDetails, paymentAmount, paymentId, paymentInitiatedDate, paymentStatus, paymentType, subscriptionId, paymentMethod);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class CreateSubscriptionPaymentAuthResponse {\n");
  ...
  * @throws IOException if the JSON Element is invalid with respect to CreateSubscriptionPaymentAuthResponse
  */
  ...
  */
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateSubscriptionPaymentAuthResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateSubscriptionPaymentAuthResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateSubscriptionPaymentAuthResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateSubscriptionPaymentAuthResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateSubscriptionPaymentAuthResponse>() {
           @Override
           public void write(JsonWriter out, CreateSubscriptionPaymentAuthResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateSubscriptionPaymentAuthResponse read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of CreateSubscriptionPaymentAuthResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of CreateSubscriptionPaymentAuthResponse
  * @throws IOException if the JSON string is invalid with respect to CreateSubscriptionPaymentAuthResponse
  */
  public static CreateSubscriptionPaymentAuthResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateSubscriptionPaymentAuthResponse.class);
  }

 /**
  * Convert an instance of CreateSubscriptionPaymentAuthResponse to an JSON string
  *
  * @return JSON string
  */
