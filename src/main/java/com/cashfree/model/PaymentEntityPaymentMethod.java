            ...
            return (TypeAdapter<T>) new TypeAdapter<PaymentEntityPaymentMethod>() {
                ...
                public PaymentEntityPaymentMethod read(JsonReader in) throws IOException {
                    ...
                    try {
                      ...
                      if(PaymentMethodCardInPaymentsEntity.validateJsonElement(jsonElement)) {
                    ...
                    try {
                      // validate the JSON object to see if any exception is thrown
                      if(PaymentMethodNetBankingInPaymentsEntity.validateJsonElement(jsonElement)) {
                    ...
                    try {
                      // validate the JSON object to see if any exception is thrown
                      if(PaymentMethodUPIInPaymentsEntity.validateJsonElement(jsonElement)) {
                    ...
                    try {
                      // validate the JSON object to see if any exception is thrown
                      if(PaymentMethodAppInPaymentsEntity.validateJsonElement(jsonElement)) {
                    ...
                    try {
                      // validate the JSON object to see if any exception is thrown
                      if(PaymentMethodCardlessEMIInPaymentsEntity.validateJsonElement(jsonElement)) {
                    ...
                    try {
                      // validate the JSON object to see if any exception is thrown
                      if(PaymentMethodPaylaterInPaymentsEntity.validateJsonElement(jsonElement)) {
                    ...
                    try {
                      // validate the JSON object to see if any exception is thrown
                      if(PaymentMethodCardEMIInPaymentsEntity.validateJsonElement(jsonElement)) {
