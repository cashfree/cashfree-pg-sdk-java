...
public class PaymentEntity {
  ...
  **/
  @javax.annotation.Nullable
  @Schema(example = "{\"$ref\":\"#/components/schemas/PaymentMethodCardInPaymentsEntity/example\"}", requiredMode = Schema.RequiredMode.NOT_REQUIRED, description = "payment methods all")
