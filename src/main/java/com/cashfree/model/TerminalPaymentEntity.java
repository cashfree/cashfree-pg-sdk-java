...
import com.cashfree.model.TerminalPaymentEntityPaymentMethod;
...
public class TerminalPaymentEntity {
  ...
  private TerminalPaymentEntityPaymentMethod paymentMethod;
  ...
  **/
  ...
  public TerminalPaymentEntity paymentMethod(TerminalPaymentEntityPaymentMethod paymentMethod) {
  ...
  **/
  @javax.annotation.Nullable
  @Schema(requiredMode = Schema.RequiredMode.NOT_REQUIRED, description = "")
  public TerminalPaymentEntityPaymentMethod getPaymentMethod() {
    return paymentMethod;
  }


  public void setPaymentMethod(TerminalPaymentEntityPaymentMethod paymentMethod) {
    this.paymentMethod = paymentMethod;
  }
  ...
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("payment_method") != null && !jsonObj.get("payment_method").isJsonNull()) {
        TerminalPaymentEntityPaymentMethod.validateJsonElement(jsonObj.get("payment_method"));
      }
  }
