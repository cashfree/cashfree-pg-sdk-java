...
public class FetchSettlementsRequestFilters {
  ...
  public FetchSettlementsRequestFilters cfSettlementIds(List<Integer> cfSettlementIds) {
    
    this.cfSettlementIds = cfSettlementIds;
    return this;
  }

  public FetchSettlementsRequestFilters addCfSettlementIdsItem(Integer cfSettlementIdsItem) {
