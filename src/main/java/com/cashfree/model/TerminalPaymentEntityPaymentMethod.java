...
public class TerminalPaymentEntityPaymentMethod extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(TerminalPaymentEntityPaymentMethod.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!TerminalPaymentEntityPaymentMethod.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'TerminalPaymentEntityPaymentMethod' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<TerminalPaymentEntityPaymentMethod>() {
                @Override
                public void write(JsonWriter out, TerminalPaymentEntityPaymentMethod value) throws IOException {
                ...
                @Override
                public TerminalPaymentEntityPaymentMethod read(JsonReader in) throws IOException {
                    ...
                    // if (match == 1) {
                        TerminalPaymentEntityPaymentMethod ret = new TerminalPaymentEntityPaymentMethod();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonElement));
                        return ret;
                    // }

                    // throw new IOException(String.format("Failed deserialization for TerminalPaymentEntityPaymentMethod: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonElement.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public TerminalPaymentEntityPaymentMethod() {
        super("oneOf", Boolean.FALSE);
    }

    public TerminalPaymentEntityPaymentMethod(PaymentMethodAppInPaymentsEntity o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public TerminalPaymentEntityPaymentMethod(PaymentMethodBankTransferInPaymentsEntity o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public TerminalPaymentEntityPaymentMethod(PaymentMethodCardEMIInPaymentsEntity o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public TerminalPaymentEntityPaymentMethod(PaymentMethodCardInPaymentsEntity o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public TerminalPaymentEntityPaymentMethod(PaymentMethodCardlessEMIInPaymentsEntity o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public TerminalPaymentEntityPaymentMethod(PaymentMethodNetBankingInPaymentsEntity o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public TerminalPaymentEntityPaymentMethod(PaymentMethodPaylaterInPaymentsEntity o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public TerminalPaymentEntityPaymentMethod(PaymentMethodUPIInPaymentsEntity o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, Class<?>> getSchemas() {
        return TerminalPaymentEntityPaymentMethod.schemas;
    }
  ...
  * @throws IOException if the JSON Element is invalid with respect to TerminalPaymentEntityPaymentMethod
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    ...
    // if (validCount != 1) {
    //  throw new IOException(String.format("The JSON string is invalid for TerminalPaymentEntityPaymentMethod with oneOf schemas: PaymentMethodAppInPaymentsEntity, PaymentMethodBankTransferInPaymentsEntity, PaymentMethodCardEMIInPaymentsEntity, PaymentMethodCardInPaymentsEntity, PaymentMethodCardlessEMIInPaymentsEntity, PaymentMethodNetBankingInPaymentsEntity, PaymentMethodPaylaterInPaymentsEntity, PaymentMethodUPIInPaymentsEntity. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonElement.toString()));
    // }
  }

 /**
  * Create an instance of TerminalPaymentEntityPaymentMethod given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of TerminalPaymentEntityPaymentMethod
  * @throws IOException if the JSON string is invalid with respect to TerminalPaymentEntityPaymentMethod
  */
  public static TerminalPaymentEntityPaymentMethod fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TerminalPaymentEntityPaymentMethod.class);
  }

 /**
  * Convert an instance of TerminalPaymentEntityPaymentMethod to an JSON string
  *
  * @return JSON string
  */
